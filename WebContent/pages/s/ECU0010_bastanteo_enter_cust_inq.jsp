...
<H3 align="center">Consulta de Vencimientos - Sistema de Bastanteo<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="bastanteo_enter_cust_inq,ECU0010"></H3>
<hr size="4">
<p>&nbsp;</p>
