...
function showDetailApproval(radio,row,sts) {
    ...
    if (sts =="Devolucion"){
	 page = webapp + "/servlet/datapro.eibs.approval.JSEDL0828?SCREEN=5&Loan="+loan+"&ID="+id+"&Doc="+doc+"&Type="+type;
...
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="doc_ap_list.jsp,EDL0828">
</h3>
<hr size="4">
