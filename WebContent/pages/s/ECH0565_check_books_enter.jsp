...
<h3 align="center">Consulta de Chequeras<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="check_books_enter.jsp, ECH0565"></h3>
<hr size="4">
...
<table  class="tableinfo">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap align=left>
              ...
              <!--<INPUT type="text" name="E01ACMDCB" size="30" maxlength="35" value=<%= datapro.eibs.platform.CBUtil.traduceCNOFC("36", rtBasic.getE01ACMTCB().trim())%>>
              <A href="javascript:GetTypCHKBook('E01ACMTCB','','<%= rtBasic.getE01ACMATY().trim()%>','<%= rtBasic.getE01ACMCCY().trim()%>')">
