...
<h3 align="center">Detalle del Producto<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="proposals_product_maint_loans.jsp,EDP0720"></h3>
		...
		<table cellspacing="0" cellpadding="0" width="100%" border="0">
      		<tr id="trclear" > 
				...
				<td nowrap align="left" width="20%">
					Descripción de la Actividad/Proyecto:
				</td>
