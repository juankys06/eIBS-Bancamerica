...
<h3 align="center">Reverso de Cheques de Gerencia<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="of_chk_enter_rev, EOF0115"></h3>
<hr size="4">
<p>&nbsp;</p>
        ...
        <table class="tbenter" cellspacing=0 cellpadding=2 width="100%" border="0">
          ...
          <tr> 
            ...
            <td nowrap width="50%"> 
              ...
              <a href="javascript:GetCheck('E01OFMCKN', '', '')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="help" align="absbottom" border="0"></a> 
            </td>
          </tr>
        </table>
      </td>
