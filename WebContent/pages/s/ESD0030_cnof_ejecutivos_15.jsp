        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <tr id="trclear"> 
			...
			<TR>
				...
				<TD nowrap height="19">
					<INPUT type="text" name="E02CNOFRP" size="4" maxlength="3" value="<%= refCodes.getE02CNOFRP().trim()%>" onKeyPress="enterInteger()">
					<A href="javascript:GetBranch('E02CNOFRP','')"><IMG	src="<%=request.getContextPath()%>/images/1b.gif" alt="ayuda" border="0"></A>
				</TD>
			</TR>
		</table>
      </td>
