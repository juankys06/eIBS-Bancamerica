...
<h3 align="center">Compraventa Moneda Extranjera<BR>Rechazo de Liquidacion de Operaciones<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="foreign_currency_exchange_reject, EPR0350"></H3>
<hr size="4">
