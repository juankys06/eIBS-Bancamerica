      ...
      <TD nowrap> 
        <TABLE cellspacing="2" cellpadding="2" width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <TD nowrap align="center"> 
              <INPUT id="txtright" type="text" readonly name="AFTERINT" size="15" maxlength="13" value="<%= Util.formatCCY(lnTransac.getE01DEATOT())%>" onkeypress="enterDecimal()">
            </TD>
          </TR>
...
<%--
          ...
          <TD nowrap> 
			  ...
			  <INPUT type="text" readonly name="E01DEALC1" size="2" maxlength="2" value="<%= lnTransac.getE01DEALC1().trim()%>" onkeypress="enterInteger()">
              <INPUT type="text" readonly name="E01DEALC2" size="2" maxlength="2" value="<%= lnTransac.getE01DEALC2().trim()%>" onkeypress="enterInteger()">
              <INPUT type="text" readonly name="E01DEALC3" size="2" maxlength="2" value="<%= lnTransac.getE01DEALC3().trim()%>" onkeypress="enterInteger()">
              </DIV>
            </TD>
           </TR>
--%>
      ...
      <td> 
        <table cellspacing=0 cellpadding=2 width="100%" border="0">
          <tr id="trclear"> 
            ...
            <td width="60%"> 
              <input type="text" readonly name="E01TRNVD1" size="2" maxlength="2" value="<%= lnTransac.getE01TRNVD1().trim()%>">
              <input type="text" readonly name="E01TRNVD2" size="2" maxlength="2" value="<%= lnTransac.getE01TRNVD2().trim()%>">
              <input type="text" readonly name="E01TRNVD3" size="2" maxlength="2" value="<%= lnTransac.getE01TRNVD3().trim()%>">
            </td>
          </tr>
          <tr id="trdark"> 
            <td width="40%"> 
            ...
            <td width="60%"> 
              <input type="text" readonly name="E01DEANR1" size="30" maxlength="30" value="<%= lnTransac.getE01DEANR1().trim()%>">
            </td>
          </tr>
          <tr id="trclear"> 
            <td width="40%"> 
            ...
            <td width="60%"> 
              <input type="text" readonly name="E01DEANR2" size="30" maxlength="30" value="<%= lnTransac.getE01DEANR2().trim()%>">
            </td>
          </tr>
        </table>
        <table cellspacing=0 cellpadding=2 width="100%" border="0">
        ...
        <table class="tableinfo" style="filter:''">
          ...
          <tr id="trclear"> 
            ...
            <td width="5%"> 
              <div align="center"> 
                <input type="text" readonly name="E01TRNBRN" size="3" maxlength="3" value="<%= lnTransac.getE01TRNBRN().trim()%>">
              </div>
            </td>
            <td width="5%" > 
              <div align="center">
