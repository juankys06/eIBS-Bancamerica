...
<H3 align="center">C&oacute;digos de Referencia del Sistema - Parroquias <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="cnof_collat_types_codes_details.jsp, EDD0000"></H3>
<hr size="4">
