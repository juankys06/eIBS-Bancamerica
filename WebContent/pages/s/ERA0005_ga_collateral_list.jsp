...
%>
  <h3 align="center">Asignación de Garantias a Operaciones<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="ga_collateral_list_fp,ERA005"></h3>
  <hr size="4">
  <BR>
