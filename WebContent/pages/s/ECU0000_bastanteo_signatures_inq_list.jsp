...
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="bastanteo_signatures_inq_list.jsp,ECU0000">
</h3>
<hr size="4">
    ...
    <TD NOWRAP valign=top>
     ...
     %>               
        <TR>
			...
			<TD NOWRAP ALIGN="CENTER"><%=Util.formatDate(msgMT.getE08CUFAC1(),msgMT.getE08CUFAC2(),msgMT.getE08CUFAC3())  + " - " + Util.formatTime(msgMT.getE08CUFACT())%></TD>
