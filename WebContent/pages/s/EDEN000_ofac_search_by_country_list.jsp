      ...
      <TD WIDTH="40%" ALIGN=LEFT height="25"> <%
        if ( shrList.getShowPrev() ) {
      			int pos =shrList.getFirstRec() - 21;
      			   out.print("<A HREF=\""+request.getContextPath()+"/servlet/datapro.eibs.tools.JSEDEN000?SCREEN=400&RWDNAM=" + RWDNAM + "&FromRecord=" + pos  + "\" > <img src=\""+request.getContextPath()+"/images/s/previous_records.gif\" border=0></A>");
        }
%> </TD>
	<TD WIDTH="20%" ALIGN=CENTER height="25">
 	  ...
 	  <TD WIDTH="40%" ALIGN=RIGHT height="25"> <%       
        if ( shrList.getShowNext() ) {
      			...
      			out.print("<A HREF=\""+request.getContextPath()+"/servlet/datapro.eibs.tools.JSEDEN000?SCREEN=400&RWDNAM=" + RWDNAM + "&FromRecord=" + pos +   "\" ><img src=\""+request.getContextPath()+"/images/s/next_records.gif\" border=0></A>");
