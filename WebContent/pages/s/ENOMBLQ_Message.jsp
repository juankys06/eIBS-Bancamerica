...
<html>
<head>
<title>Mantenimiento BLoqueo de Cuenta</title>
...
%> 
<h3 align="center">Mantenimiento BLoqueo de Cuenta<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="ENOMBLQ_Message.jsp,JSENOMBLQ"></h3> 
<hr size="4">
    ...
    <tr > 
      <td> 
        ...
        <table width="100%">
          ...
          <tr>
            <td width="8%">&nbsp;</td>
            <td width="92%">El Registro ha sido procesado satisfactoriamente.</td>
          </tr>
          <tr>
            <td width="8%"></td>
            <td width="92%"> 
