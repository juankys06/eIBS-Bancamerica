...
<h3 align="center">Tablas de Comisiones y Gastos de Cobranzas por Cliente<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="sc_cust_list.jsp, EDC0600"></h3>
<hr size="4">
...
%>
  ...
  <TABLE class="tbenter">
    <TR>
      ...
      <TD ALIGN=CENTER class="TDBKG" width="33%"><a href="javascript:goAction('M')">Mantenimiento</a>
      </TD>   
  ...
  <TABLE class="tableinfo" id="dataTable">
    <TR id="trdark">
      ...
      <TH ALIGN=CENTER  nowrap >Moneda<BR>Contable
		</TH>      
