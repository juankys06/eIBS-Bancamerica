      ...
      <TD nowrap> 
        <TABLE cellspacing="2" cellpadding="2" width="100%" border="0">
          ...
          <tr > 
            ...
            <td nowrap align="center"> 
              <input type="text" id="txtright" name="E03DEAREA" size="15" maxlength="15" value="<%= Util.formatCCY(cdTransac.getE03DEAREA().trim())%>" readonly>
            </td>
            <TD nowrap align="center"> 
      ...
      <td> 
        <table cellspacing=0 cellpadding=2 width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td width="60%"> 
              <input type="text" readonly name="E03TRNPRI" size="15" maxlength="15" value="<%= cdTransac.getE03TRNPRI().trim()%>">
          ...
          <tr id="<% if(cdTransac.getH03FLGWK3().equals("R")) out.print("trdark"); else out.print("trclear"); %>"> 
            ...
            <td width="60%"> 
              <input type="text" readonly name="E03TRNINT" size="15" maxlength="15" value="<%= cdTransac.getE03TRNINT().trim()%>">
          ...
          <tr id="<% if(cdTransac.getH03FLGWK3().equals("R")) out.print("trclear"); else out.print("trdark"); %>"> 
            ...
            <td width="60%" height="27"> 
              <input type="text" readonly name="E03TRNADJ" size="15" maxlength="15" value="<%= cdTransac.getE03TRNADJ().trim()%>">
          ...
          <tr id="<% if(cdTransac.getH03FLGWK3().equals("R")) out.print("trdark"); else out.print("trclear"); %>"> 
            ...
            <td width="60%"> 
              <input type="text" readonly name="E03TRNWHL" size="15" maxlength="15" value="<%= cdTransac.getE03TRNWHL().trim()%>">
            </td>
          </tr>
          <tr id="<% if(cdTransac.getH03FLGWK3().equals("R")) out.print("trclear"); else out.print("trdark"); %>"> 
            <td width="40%"> 
            ...
            <td width="60%"> 
              <input type="text" readonly name="E03TRNTAX" size="15" maxlength="15" value="<%= cdTransac.getE03TRNTAX().trim()%>">
            </td>
          </tr>
          <tr id="<% if(cdTransac.getH03FLGWK3().equals("R")) out.print("trdark"); else out.print("trclear"); %>"> 
            <td width="40%"> 
