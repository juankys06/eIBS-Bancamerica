      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="21%" > 
              <% if(deal.getE01DLSSBT().equals("SL")) out.print("Pasiva");
          ...
          <tr id="trclear"> 
            ...
            <td nowrap colspan="3" ><%= deal.getE01DLSROY().trim()%> - 
              <% if(deal.getE01DLSODA().equals("D")) out.print("Dias");
   if(deal.getE01DLSODA().equals("M")) out.print("Mes");
   if(deal.getE01DLSODA().equals("Y")) out.print("Años");%>
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap width="34%" > 
