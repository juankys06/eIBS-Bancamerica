...
<% 
 ...
 %>
<h3 align="center">Confirmación de Ordenes de pago <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="pr_confirm.jsp,EDD0600" width="32" height="32" ></h3>
<hr size="4">
