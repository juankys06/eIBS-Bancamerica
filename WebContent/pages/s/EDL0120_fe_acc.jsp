...
function Calculate(){
  ...
  document.forms[0].action = "<%=request.getContextPath()%>/servlet/datapro.eibs.forex.JSEDL0120?SCREEN=4000";
...
String sTitle = "Aceptaciones Bancarias";
try {
   sTitle = trOption.getHeader2();
} catch (Exception e) {
   sTitle = "Aceptaciones Bancarias";
}   
if (sTitle == null) sTitle = "Aceptaciones Bancarias";

%>
<h3 align="center"><%= sTitle%><img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="fe_acc.jsp, EDL0120"> 
</h3>
<hr size="4">
