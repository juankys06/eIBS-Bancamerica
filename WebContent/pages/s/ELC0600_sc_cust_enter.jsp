...
<H3 align="center">Comisiones y Gastos de Cartas de Cr&eacute;dito<IMG src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="sc_cust_enter, ELC0600"></H3>
