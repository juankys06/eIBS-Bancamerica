...
<H3 align="center">C&oacute;digos de Referencia del Sistema - Tipos de Garant&iacute;a<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="cnof_collat_types_codes_details.jsp, ESD0030"></H3>
<hr size="4">
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap height="19"> 
              <div align="left"> 
                <input type="text" name="E02CNOSCG" size="21" maxlength="21" value="<%= refCodes.getE02CNOSCG().trim()%>">
                <a href="javascript:GetLedger('E02CNOSCG',document.forms[0].E02CNOBNK.value,'','91')"> 
          ...
          <tr id="trdark"> 
            <td nowrap width="16%" height="19"> 
              <div align="right">&#37; M&aacute;ximo de Garant&iacute;a :</div>
            </td>
            <td nowrap height="19"> 
              <div align="left">
