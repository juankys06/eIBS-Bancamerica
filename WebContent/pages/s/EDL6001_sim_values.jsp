...
<h3 align="center">Cotizador de Préstamos<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="sim_values,EDL6001"></h3>
<hr size="4">
...
<%--              <img src="<%=request.getContextPath()%>/images/Check.gif" alt="campo obligatorio" align="absbottom" border="0"  > --%>
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="27%" > 
              <input type="text" name="E01TASAPR" size="12" maxlength="10" value="<%= lnBasic.getE01TASAPR().trim()%>" onKeypress="enterRate()" onKeypress="enterSignDecimal()">
            </td>
          </tr>
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="27%" > 
              <input type="text" name="E01EFERTE" size="12" maxlength="10" value="<%= lnBasic.getE01EFERTE().trim()%>" onKeypress="enterRate()" onKeypress="enterSignDecimal()">
            </td>
          </tr>
		...
		<tr id="<%=rowColor %>"> 
            ...
            <td nowrap width="23%"> 
              <input type="text" name="<%=fieldName %>" size="15" maxlength="15" value="<%= lnBasic.getFieldString(fieldName).trim()%>" onKeypress="enterDecimal()"> 
            </td>
            ...
            %>
            	...
            	<td nowrap align="left" width="27%"> 
             	 	<input type="text" name="<%=ivaName %>" size="15" maxlength="15" value="<%= lnBasic.getFieldString(ivaName).trim()%>" onKeypress="enterDecimal()">
            	</td>
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="27%" > 
              <input type="text" name="E01NCUOTA" size="4" maxlength="3" value="<%= lnBasic.getE01NCUOTA().trim()%>" onKeypress="enterRate()" onKeypress="enterInteger()">
            </td>
          </tr>
