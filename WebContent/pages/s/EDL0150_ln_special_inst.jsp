...
%> 
<h3 align="center">Instrucciones Especiales <%= userPO.getHeader4().trim()%><img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="ln_special_inst,EDL0150"></h3>
<hr size="4">
