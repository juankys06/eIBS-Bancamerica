...
%> <H3 align="center">Detalle de Pago Diferido (42P)<IMG src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="lc_42P_info.jsp, ELC0510"></H3>
<HR size="4">
...
<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/servlet/datapro.eibs.products.JSELC0510" >
  ...
  <INPUT TYPE=HIDDEN NAME="E03LCDFCD" VALUE="42P">
