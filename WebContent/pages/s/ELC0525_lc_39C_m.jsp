...
<H3 align="center">Montos Adiconales Cubiertos (39C)<IMG src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" 
alt="ELC0525_lc_39C_m.jsp"></H3>
<HR size="4">


<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/servlet/datapro.eibs.products.JSELC0510" >
  <INPUT NAME="SCREEN" TYPE=HIDDEN VALUE="29" readonly="readonly">
