...
<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/servlet/datapro.eibs.products.JSEATM010" >
  ...
  <table class="tableinfo">
    <tr > 
      ...
      <td width="51%" nowrap> 
        <input type="text" name="E02ATMCUN"  size=12 maxlength="9" 
					  >
        <a href="javascript:GetCustomer('E02ATMCUN')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Ayuda" align="absbottom" border="0" ></a> 
      </td>
    </tr>
  </table>
