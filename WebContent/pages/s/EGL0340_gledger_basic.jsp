...
%> 
<H3 align="center"><% if (userPO.getPurpose().equals("NEW")) out.print("Apertura al Maestro de Contabilidad");
   else out.print("Mantenimiento al Maestro de Contabilidad");
   %><img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="gledger_basic.jsp, EGL0340"></H3>
<hr size="4">
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="19%">
              ...
              <a href="javascript:GetCodeCNOFC('E01GLMATY','04')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Ayuda" align="absbottom" border="0" ></a> 
        	</td>
            <td nowrap width="26%"> 
            ...
            <td nowrap width="26%">
             ...
             <a href="javascript:GetCodeCNOFC('E01GLMCLS','01')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Ayuda" align="absbottom" border="0" ></a>               
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap width="29%"> 
		  ...
		  <tr id="trdark"> 
            ...
            <td nowrap colspan="3"> 
              ...
              <a href="javascript:GetCodeCNOFC('E01GLMCIC','21')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Ayuda" align="absbottom" border="0" ></a> 
        	  <input type="text" name="E01GLMFR1" size="5" maxlength="5" value="<%= gLedger.getE01GLMFR1().trim()%>">
              <input type="text" name="E01GLMFR2" size="5" maxlength="5" value="<%= gLedger.getE01GLMFR2().trim()%>">
              <input type="text" name="E01GLMFR3" size="5" maxlength="5" value="<%= gLedger.getE01GLMFR3().trim()%>">
              <input type="text" name="E01GLMFR4" size="5" maxlength="5" value="<%= gLedger.getE01GLMFR4().trim()%>">
              <input type="text" name="E01GLMFR5" size="5" maxlength="5" value="<%= gLedger.getE01GLMFR5().trim()%>">
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap> 
          ...
          <tr id="trclear"> 
            ...
            <td nowrap> 
              <input type="text" name="E01GLMXOF" size="17" maxlength="16" value="<%= gLedger.getE01GLMXOF()%>" onkeypress="enterInteger()">
              <a href="javascript:GetLedger('E01GLMXOF',document.forms[0].E01GLMBNK.value,document.forms[0].E01GLMCCY.value,'')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Ayuda" align="absbottom" border="0" ></a> 
        	</td>
          </tr>
          <tr id="trdark"> 
            <td nowrap> 
            ...
            <td nowrap>
              ...
              <a href="javascript:GetBudget('E01GLMBUN',document.forms[0].E01GLMBNK.value,document.forms[0].E01GLMCCY.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Ayuda" align="absbottom" border="0" ></a> 
            </td>
            <td nowrap> 
          ...
          <tr id="trclear"> 
            ...
            <td nowrap colspan="3"> 
              <input type="text" name="E01GLMHDS" size="60" maxlength="60" value="<%= gLedger.getE01GLMHDS().trim()%>">
            </td>
          </tr>
        </table>
      </td>
