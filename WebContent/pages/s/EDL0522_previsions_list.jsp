...
<BODY>
<h3 align="center">Tablas de Previsiones<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="monthly_account_activity.jsp, ESD059001"></h3>
<hr size="4">
