...
<%
  ...
  // NOMBRES DE CAMPOS
	...
	String noCasa_Apto = suffix + (basicData?"NA4":"MA4") ;
    ...
    <tr > 
     ...
     <% } %>
          <tr id="<%=color1%>">
            ...
            <td nowrap  > 
              <input type="text" name="<%=calle%>"  size="37" maxlength="35" 
              	value="<%=mr.getField(calle).getString()%>" <%=READ_ONLY_TAG%> 
           ...
           <tr id="<%=color2%>">
            ...
            <td nowrap > 
              <input type="text" name="<%=residencial_Edificio%>"   
              	size="37" maxlength="35" value="<%= mr.getField(residencial_Edificio).getString()%>" <%=READ_ONLY_TAG%> 
          ...
          <tr id="<%=color1%>"> 
            ...
            <td nowrap > 
              <input type="text" name="<%=noCasa_Apto%>"   size="37" maxlength="35" 
              	value="<%= mr.getField(noCasa_Apto).getString()%>" <%=READ_ONLY_TAG%> 
              	<%if(basicData){ out.print((mr.getField(noCasa_Apto).getString().equals("Y"))?"id=\"txtchanged\"":"");} %> >
   				<img src="<%=request.getContextPath()%>/images/Check.gif" alt="mandatory field" align="bottom" border="0"  >	
            </td>
           </tr>
           <tr id="<%=color2%>">
            ...
            <td nowrap > 
              ...
              <input type="text" name="<%=provinciaDsc%>"  size="37" maxlength="35" 
              	value="<%= mr.getField(provinciaDsc).getString()%>" <%=READ_ONLY_TAG %> 
          ...
          <tr id="<%=color1%>"> 
            ...
            <td nowrap > 
              ...
              <input type="text" name="<%=distritoDsc%>"  size="37" maxlength="35" 
              	value="<%= mr.getField(distritoDsc).getString()%>" <%=READ_ONLY_TAG %> 
           ...
           <tr id="<%=color2%>">
            ...
            <td nowrap > 
              ...
              <input type="text" name="<%=corregimientoDsc%>"  size="37" maxlength="35" 
              	value="<%= mr.getField(corregimientoDsc).getString()%>" <%=READ_ONLY_TAG %> 
          ...
          <tr id="<%=color1%>"> 
            ...
            <td nowrap > 
              <input type="text" name="<%=pais%>"  size="21" maxlength="20" 
              	value="<%= mr.getField(pais).getString()%>" <%=READ_ONLY_TAG %> 
           ...
           <tr id="<%=color2%>">
            ...
            <td nowrap > 
              <input type="text" name="<%=apartadoPostal%>"  size="11" maxlength="10" 
              	value="<%= mr.getField(apartadoPostal).getString()%>" <%=READ_ONLY_TAG %> 
          ...
          <tr id="<%=color1%>"> 
            ...
            <td nowrap > 
              ...
              <input type="hidden" name="<%=codigoPostal%>"  size="12" maxlength="11" 
              	value='<%= (mr.getField(codigoPostal) != null && !mr.getField(codigoPostal).getString().equals("") && mr.getField(codigoPostal).getString().length() > 4 )
              	?mr.getField(codigoPostal).getString().substring(0,4):""%>' 
              	<%=READ_ONLY_TAG %> >
              <input type="text" name="<%=codigoPostalDsc%>"  size="12" maxlength="11" 
              	value='<%= (mr.getField(codigoPostal) != null && !mr.getField(codigoPostal).getString().equals("") && mr.getField(codigoPostal).getString().length() > 5 )
              	?mr.getField(codigoPostal).getString().substring(4):""%>' 
              	<%=READ_ONLY_TAG %> 
		  ...
		  <% if( basicData ){ //Este campo solo aplica para los datos basicos  %>
           <tr id="<%=color2%>">
            ...
            <td nowrap > 
              <input type="text" name="<%=tipoCorreo%>"  size="7" maxlength="4" 
              	value="<%= mr.getField(tipoCorreo).getString()%>" <%=READ_ONLY_TAG %> 
          ...
          <tr id="<%=color1%>"> 
            ...
            <td nowrap > 
              <input type="text" name="<%=eMail%>"  size="42" maxlength="40" 
              	value="<%= mr.getField(eMail).getString()%>" <%=READ_ONLY_TAG %> 
