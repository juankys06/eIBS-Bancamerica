...
%> 
<h3 align="center"> Consulta - Dep&oacute;sitos a Plazo Fijo<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="fe_deposits.jsp, EDL0120I"> 
</h3>
<hr size="4">
