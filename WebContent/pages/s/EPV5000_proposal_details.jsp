...
%> 
<h3 align="center">Propuesta de Cr&eacute;dito<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="proposal_details.jsp,EPV5000"></h3>
<hr size="4">
  ...
  <div id="OtherOpt"> 
    <table class="tableinfo">
      ...
      <tr id="trdark"> 
        ...
        <td nowrap  width="39%"> 
          <p> 
            <input type="text" name="E01PVMOPM" size="3" maxlength="2" value="<%= proposal.getE01PVMOPM().trim()%>">
            <input type="text" name="E01PVMOPD" size="3" maxlength="2" value="<%= proposal.getE01PVMOPD().trim()%>">
            <input type="text" name="E01PVMOPY" size="3" maxlength="2" value="<%= proposal.getE01PVMOPY().trim()%>">
          </p>
        </td>
        <td nowrap width="19%" > 
      ...
      <tr id="trclear"> 
        ...
        <td nowrap  width="39%"> 
          <input type="text" name="E01PVMSA1" size="16" maxlength="15" value="<%= proposal.getE01PVMSA1().trim()%>" onkeypress="enterDecimal()">
        </td>
        <td nowrap width="19%" > 
      ...
      <tr id="trdark"> 
        ...
        <td nowrap width="39%"> 
          <div align="left"> 
            <input type="text" name="E01PVMST1" size="5" maxlength="4" value="<%= proposal.getE01PVMST1().trim()%>" onkeypress="enterInteger()">
          </div>
        </td>
        <td nowrap width="19%"> 
        ...
        <td nowrap width="17%"> 
          <div align="left"> 
            <input type="text" name="E01PVMSA2" size="16" maxlength="15" value="<%= proposal.getE01PVMSA2().trim()%>" onkeypress="enterDecimal()">
          </div>
        </td>
      </tr>
    </table>
                      ...
                      <div id="dataTab0"> 
                          <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr id="trdark"> 
                              ...
                              <td nowrap> 
                                <div align="left"> 
                                  <input type="text" name="E01PVMBDM" size="3" maxlength="2" value="<%= proposal.getE01PVMBDM().trim()%>">
                                  <input type="text" name="E01PVMBDD" size="3" maxlength="2" value="<%= proposal.getE01PVMBDD().trim()%>">
                                  <input type="text" name="E01PVMBDY" size="3" maxlength="2" value="<%= proposal.getE01PVMBDY().trim()%>">
                                </div>
                              </td>
                            </tr>
                            <tr id="trclear"> 
             ...
             <div id="dataTab3" style="display: none"> 
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  ...
                                  <tr id="trdark"> 
                                    ...
                                    <td nowrap > 
                                      <input type="text" name="E01PVMSWM" size="3" maxlength="2" value="<%= proposal.getE01PVMSWM().trim()%>" onKeyPress="enterInteger()">
                                      <input type="text" name="E01PVMSWD" size="3" maxlength="2" value="<%= proposal.getE01PVMSWD().trim()%>" onKeyPress="enterInteger()">
                                      <input type="text" name="E01PVMSWY" size="3" maxlength="2" value="<%= proposal.getE01PVMSWY().trim()%>" onKeyPress="enterInteger()">
                                    </td>
                                  </tr>
                                  <tr id="trclear"> 
                                    <td nowrap > 
                                  ...
                                  <tr id="trdark"> 
                                    ...
                                    <td nowrap > 
                                      <input type="text" name="E01PVMICD" size="4" maxlength="4" value="<%= proposal.getE01PVMICD().trim()%>" onKeyPress="enterInteger()">
                                    </td>
                                  </tr>
                                </table>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr id="trclear"> 
                                  ...
                                  <tr id="trdark"> 
                                    ...
                                    <td nowrap> 
                                      <input type="text" name="E01PVMICU" size="17" maxlength="15" value="<%= proposal.getE01PVMICU().trim()%>" onKeypress="enterDecimal()">
                                    </td>
                                    <td nowrap> 
                                      <div align="right">Otros Ingresos :</div>
                                    </td>
                                    <td nowrap> 
                                      <input type="text" name="E01PVMAM2" size="17" maxlength="15" value="<%= proposal.getE01PVMAM2().trim()%>" onKeyPress="enterDecimal()">
                                    </td>
                                  </tr>
                                  <tr id="trclear"> 
                                    <td nowrap colspan="4" > 
                                  ...
                                  <tr id="trdark"> 
                                    ...
                                    <td nowrap > 
                                      <INPUT type="text" name="E01PVMECU" size="17" maxlength="15" value="<%= proposal.getE01PVMECU().trim()%>" onkeypress="enterDecimal()">
                                    </td>
                                    <td nowrap > 
                                      <div align="right">Otros Egresos :</div>
                                    </td>
                                    <td nowrap > 
                                      <input type="text" name="E01PVMEWF" size="17" maxlength="15" value="<%= proposal.getE01PVMEWF().trim()%>" onKeyPress="enterDecimal()">
                                    </td>
                                  </tr>
                                  <tr id="trdark"> 
                                    <td nowrap > 
                                    ...
                                    <td nowrap > 
                                      <div align="left">
                                        <input type="text" name="E01PVMAM4" size="17" maxlength="15" value="<%= proposal.getE01PVMAM4().trim()%>" onKeyPress="enterDecimal()">
                                      </div>
                                    </td>
                                    <td nowrap > 
                                    ...
                                    <td nowrap > 
                                      <div align="left">
                                        <input type="text" name="E01PVMAM5" size="17" maxlength="15" value="<%= proposal.getE01PVMAM5().trim()%>" onKeyPress="enterDecimal()">
                                      </div>
                                    </td>
                                  </tr>
                                  <tr id="trdark"> 
                                    ...
                                    <td nowrap > 
                                      <div align="left">
                                        <input type="text" name="E01PVMAM7" size="17" maxlength="15" value="<%= proposal.getE01PVMAM7().trim()%>" onKeyPress="enterDecimal()">
                                      </div>
                                    </td>
                                    <td nowrap > 
                                    ...
                                    <td nowrap > 
                                      <div align="left">
                                        <input type="text" name="E01PVMAM6" size="17" maxlength="15" value="<%= proposal.getE01PVMAM6().trim()%>" onKeyPress="enterDecimal()">
                                      </div>
                                    </td>
                                  </tr>
					...
					<% for (int i=5 ; i<9; i++) {
                          ...
                          <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr id="trdark"> 
                              ...
                              <td nowrap > 
                                 <input type="text" name="E01PVRAMT<%=i%>" size="17" maxlength="15" value="<%= proposal.getField("E01PVRAMT" +i).getString().trim()%>" onKeyPress="enterDecimal()">
                              </td>
                            </tr>
                          </table>
					<% } %>
