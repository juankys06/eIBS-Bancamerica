...
<BODY>
 ...
 <h3 align="center">
  Firmantes - Consulta
 <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="rt_inq_signers_list.jsp,EDD0000"> 
    </h3>
   <hr size="4">
...
%>
 ...
 <INPUT TYPE=HIDDEN NAME="totalRow" VALUE="0">
  ...
  <table class="tbenter" width="100%">
    <tr>     
      <td class=TDBKG><a href="javascript:goAction(5)">Condic. Especiales Firmas</a></td>
    </tr>
  </table>
