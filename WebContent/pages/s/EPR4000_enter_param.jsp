...
<h3 align="center">Parametros Tablas de Comisiones Transferencias<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="enter_param.jsp, EPR4000"></h3>
<hr size="4">
  <br><br><br><br><br><br>
