...
%>
<div align="center"> 
  <h3>Forward Moneda Extranjera (Back Office)<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="fe_basic_forward.jsp,EFE0120B"> 
  </h3>
</div>
<hr size="4">
        ...
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          <tr id="trdark">            
            ...
            <td nowrap colspan="2" > 
              ...
              <a href="javascript:GetClassFex('E01FESCLS','FWR','<%= fex.getE01FESCCY()%>')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="help" align="middle" border="0" ></a> 
            </td>
            <td nowrap colspan="2" > 
