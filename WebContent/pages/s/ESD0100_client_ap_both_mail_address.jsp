...
<h3 align="center">Direcciones de Correo<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="client_ap_both_mail_address, ESD0100" ></h3>
<hr size="4">
