...
<body>
<h3 align="center">Comisiones de Tarjetas<BR>Nueva<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="plastic_commissions_maint.jsp, ECD0005"> 
</h3>
<hr size="4">
<% 
