...
//	parent.results.window.location.href="<%=request.getContextPath()%>/pages/s/MISC_search_wait.jsp?URL='<%=request.getContextPath()%>/pages/s/EWD0030_vendor_help_helpmessage.jsp?NameSearch=" + NameSearch + "@FromRecord=" + FromRecord + "'";
	parent.results.window.location.href="<%=request.getContextPath()%>/pages/s/MISC_search_wait.jsp?URL='<%=request.getContextPath()%>/servlet/datapro.eibs.helps.JSEWD0705?NameSearch=" + NameSearch + "@FromRecord=" + FromRecord + "@codeflag=<%=request.getParameter("codeflag")%>'";


	//}else{
	//alert("Entre un criterio valido")
	//}
}
</SCRIPT>
</HEAD>
