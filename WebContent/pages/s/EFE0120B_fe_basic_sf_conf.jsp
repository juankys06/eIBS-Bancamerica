...
function doPrint(){
  if (!window.print) {
    var msg =       "Estimado Usuario:\n";
        msg = msg + "Para poder imprimir esta pagina,\n";
        msg = msg + "favor actualizar su EXPLORADOR.";
    alert(msg);
   return;
  }
...
%>
<h3 align="center">Confirmaci&oacute;n - Spot Moneda Extranjera
(Back Office)<img
	src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left"
	name="EIBS_GIF" alt="fe_basic_sf_conf.jsp,EFE0120B"></h3>
<hr size="4">
<form method="post"
	...
	<TABLE  class="tbenter" WIDTH="98%" ALIGN=CENTER>
    	<TR>
			<TD WIDTH="100%" ALIGN=CENTER height="25">
  				<input id="EIBSBTN" type=button name="Print" value="Imprimir" onClick="javascript:doPrint()">
			</TD>
	 	</TR>
 	</TABLE>
<BR>
