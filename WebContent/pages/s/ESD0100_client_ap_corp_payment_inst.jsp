...
<h3 align="center">Instrucciones de Pago<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="client_ap_corp_payment_inst.jsp,ESD0100"></h3>
<hr size="4">
    ...
    <td> 
          <table cellspacing="0" cellpadding="2" class="tbhead" width="100%"  align="center">
            ...
            <tr>
              ...
              <td nowrap width="14%" align="left"><% if(pymInst.getE11TYP().equals("1")) out.print("Por Omisión");
