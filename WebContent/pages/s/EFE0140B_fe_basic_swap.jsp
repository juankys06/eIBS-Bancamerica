...
%>
<h3 align="center"> Swap - Moneda Extranjera (Back Office)<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="fe_basi_swap.jsp, EFE0140B"> 
</h3>
<hr size="4">
        ...
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <% if(fex.getH01FLGWK3().equals("N")){%> 
            ...
            <td nowrap colspan="2" > 
              ...
              <a href="javascript:GetClassFex('E01WKFCLS','SPT','<%= fex.getE01WKFCCY()%>')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="help" align="middle" border="0" ></a> 
            </td>
            <td nowrap colspan="2" > 
            ...
            <td nowrap > 
			  ...
			  >
                <a href="javascript:GetClassFex('E01WKFFLS','FWR','<%= fex.getE01WKFCCY()%>')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="help" align="middle" border="0" ></a></div>
            </td>
            <td nowrap >&nbsp;</td>
            <%} else {%> 
            <td nowrap > 
          ...
          <tr id="trclear"> 
            ...
            <td nowrap colspan="2" > 
			  ...
			  >
                <a href="javascript:GetCode('E01WKFRVF','STATIC_fe_bo_rev.jsp')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="help" align="middle" border="0" ></a></div>
            </td>
            <td nowrap colspan="2" > 
            ...
            <td nowrap > 
			  ...
			  >
                <a href="javascript:GetCode('E01WKFNTF','STATIC_fe_bo_not.jsp')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="help" align="middle" border="0" ></a></div>
            </td>
          ...
          <tr id="trdark"> 
            ...
            <td nowrap > 
			  ...
			  >
                <a href="javascript:GetCode('E01WKFBCT','STATIC_fe_bo_pay.jsp')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="help" align="middle" border="0" ></a></div>
            </td>
            <td nowrap width="17%" >&nbsp;</td>
          </tr>
          <tr id="trclear"> 
