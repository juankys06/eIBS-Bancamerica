...
<h3 align="center">Compraventa Moneda Extranjera<BR>Reversion de Operaciones Diarias<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="foreign_currency_exchange_list, EPR0390"></H3>
<hr size="4">
    ...
    <TD NOWRAP valign=top>
  	 <TABLE id="dataTable" width="100%">
        ...
        <TR>
			...
			<TD NOWRAP ALIGN="CENTER"><%=Util.formatCell(msgMT.getE01REQLIU()) + "<br>" +  Util.formatDate(msgMT.getE01REQLD1(),msgMT.getE01REQLD2(),msgMT.getE01REQLD3()) + "<br>" + Util.formatTime(msgMT.getE01REQLIT()) %></TD>
		</TR>    		
    	<%}%>    
     </TABLE>
    </TD>
