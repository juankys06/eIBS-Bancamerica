...
<h3 align="center">Devolución de Cheques<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="rejection_chk_unposted_list.jsp,EDD0924"></h3>
<hr size="4">
...
<input type="HIDDEN" name="E01SELOFC" 
    		value="<%=dataCR.getOfficer()!= null?dataCR.getOfficer():""%>">
<input type="HIDDEN" name="E01SELBRN"  
  value="<%=dataCR.getBranch() != null?dataCR.getBranch():""%>">
<input type="HIDDEN" name="E01SELCAU" 
  		value="<%=dataCR.getCause() != null?dataCR.getCause():""%>">
