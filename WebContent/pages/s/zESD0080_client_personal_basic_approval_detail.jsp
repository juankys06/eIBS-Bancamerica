...
<h3 align="center">Evaluaci&oacute;n de Cr&eacute;ditos<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF"  ></h3>
<hr size="4">
 <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/servlet/datapro.eibs.client.JSESD0080" >
  ...
  <table class="tableinfo">
    <tr id="trdark">
      <td nowrap width="25%">
        <div align="right">N&uacute;mero de Propuesta :</div>
      </td>
      <td nowrap colspan="3">
        <div align="left">
          <input type="hidden" name="E01CUN2" size="15" maxlength="10" value="<%= client.getE01CUN().trim()%>">
        </div>
      </td>
    </tr>
    <tr id="trdark"> 
    ...
    <div align="left"> 
      <table class="tableinfo">
        ...
        <tr id="trclear"> 
          ...
          <td nowrap width="9%" > 
            <div align="right">L&iacute;quido Aprobado :</div>
          </td>
          <td nowrap width="23%" > 
            <div align="left"> 
              <input type="text" name="E01UC92322" size="15" maxlength="15" value="<%= client.getE01UC9().trim()%>">
            </div>
          </td>
        </tr>
        <tr id="trclear"> 
          ...
          <td nowrap width="43%" > 
            <div align="left"> 
              <input type="text" name="E01UC92428" size="15" maxlength="15" value="<%= client.getE01UC9().trim()%>">
            </div>
          </td>
          <td nowrap width="9%" > 
            <div align="right"></div>
        ...
        <tr id="trclear"> 
          <td nowrap width="25%"> 
            <div align="right">Primer Vencimiento :</div>
          </td>
          <td nowrap width="43%" > 
            <div align="left"> 
              <input type="text" name="E01UC92334" size="3" maxlength="2" value="<%= client.getE01UC9().trim()%>">
              <input type="text" name="E01UC923322" size="3" maxlength="2" value="<%= client.getE01UC9().trim()%>">
              <input type="text" name="E01UC923332" size="3" maxlength="2" value="<%= client.getE01UC9().trim()%>">
            </div>
          </td>
          <td nowrap width="9%" > 
            <div align="right">Cuotas :</div>
          </td>
          <td nowrap width="23%" > 
            <div align="left"> 
              <input type="text" name="E01UC924232" size="5" maxlength="4" value="<%= client.getE01UC9().trim()%>">
            </div>
          </td>
        </tr>
        <tr id="trclear"> 
          ...
          <td nowrap width="43%" > 
            <div align="left"> 
              <input type="text" name="E01UC924242" size="15" maxlength="15" value="<%= client.getE01UC9().trim()%>">
            </div>
          </td>
          <td nowrap width="9%" > 
          ...
          <td nowrap width="23%" > 
            <div align="left"> 
              <input type="text" name="E01UC924252" size="5" maxlength="4" value="<%= client.getE01UC9().trim()%>">
            </div>
          </td>
        </tr>
        <tr id="trclear"> 
