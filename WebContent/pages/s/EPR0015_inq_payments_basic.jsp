...
%> 
<h3 align="center"> Detalles Interfase de Pagos - Consulta<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="inq_payments_basic.jsp,EPR0015"> 
</h3>
<hr size="4">
