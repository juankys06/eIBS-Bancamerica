...
Stand By Emitida <IMG
	...
	name="EIBS_GIF" alt="ELC0525_lc_opening_outgoing_sb.jsp"></H3>
<HR size="4">
...
<TABLE class="tableinfo"  cellspacing="0" cellpadding="2" border="0" width="100%" align="center">
  ...
  <TR id="">
    ...
    <TD align="left" nowrap><INPUT name="E01LCMCA5" type="text" value="<%=msg040001.getE01LCMCA5()%>" size="2" maxlength="2" readonly="readonly">
      ...
      Pa&iacute;s
      <INPUT name="E01LCMCA7" type="text" value="<%=msg040001.getE01LCMCA7()%>" size="3" maxlength="7" readonly="readonly">
      </TD>
  </TR>
</TABLE>
<BR>
...
<TABLE border="0" cellpadding="2"  cellspacing="0" class="tableinfo" width="100%" align="center">
  ...
  <TR id="">
    ...
    <TD align="left" nowrap><INPUT name="E01LCMAB5" type="text" value="<%=msg040001.getE01LCMAB5()%>" size="2" maxlength="2" readonly="readonly">
      C&oacute;digo Postal
      <INPUT name="E01LCMAB6" type="text" value="<%=msg040001.getE01LCMAB6()%>" size="11" maxlength="10" readonly="readonly">
      Pa&iacute;s
