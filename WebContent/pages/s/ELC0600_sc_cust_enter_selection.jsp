...
<H3 align="center">Comisiones y Gastos de Cartas de Credito<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="sc_enter_cust_selection, ELC0600"></H3>
