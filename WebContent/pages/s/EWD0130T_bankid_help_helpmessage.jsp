...
function enter(id,code,desc,city,ctry) {
	...
	form[top.opener.fieldName].value = id;
	form[top.opener.fieldDesc].value = code;
  	if(top.opener.fieldAux1 !== ""){form[top.opener.fieldAux1].value = desc;}
  	if(top.opener.fieldAux2 !== ""){form[top.opener.fieldAux2].value = city;}
  	if(top.opener.fieldAux3 !== ""){form[top.opener.fieldAux3].value = ctry;}
	top.close();
}
