...
<H3 align="center">Creacion de Solicitudes de Compraventa de Moneda Extranjera<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="foreign_currency_exchange_new, EPR0330"></H3>
<hr size="4">
    	...
    	<td>
    		<table cellspacing=0 cellpadding=2 width="100%" border="0">    
     			...
     			<tr id=trclear> 
	      			...
	      			<td nowrap>
	      				<input type="text" name="E02REQBRN" size="5" maxlength="3" value="<%= userPO.getBranch() %>" readonly >
		  			</td>
     			</tr>
     			<tr id=trdark> 
	      			<td nowrap> 
