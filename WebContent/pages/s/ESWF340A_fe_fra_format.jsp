...
%>
<h3 align="center">MT 340 Mensaje de Confirmaci&oacute;n<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="fe_fra_format.jsp, ESWF340A"> 
</h3>
<hr size="4">
              ...
              <td nowrap> 
                <table cellpadding=2 cellspacing=0 width="100%" border="0">
                  <tr id="trdark"> 
                    ...
                    <td nowrap width="28%" > 
                      <div align="left"><%= Util.formatDate(swift.getE02SWFTD1(),swift.getE02SWFTD2(),swift.getE02SWFTD3())%></div>
                    </td>
                  </tr>
                  <tr id="trclear"> 
                    <td nowrap width="22%" > 
                    ...
                    <td nowrap width="28%" > 
                      <div align="left"><%= Util.formatDate(swift.getE02SWFVD1(),swift.getE02SWFVD2(),swift.getE02SWFVD3())%></div>
                    </td>
                  </tr>
                  <tr id="trdark"> 
                    <td nowrap width="22%" > 
