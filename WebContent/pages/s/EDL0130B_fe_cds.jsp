...
<h3 align="center">Certificado de Dep&oacute;sito - Back Office<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="fe_cds.jsp,EDL0130B"></h3>
<hr size="4">
        ...
        <table cellspacing=0 cellpadding=2 width="100%" border="0">
          <tr id="trdark"> 
            <td nowrap width="25%" > 
			  ...
			  <%if(deal.getE11DEAF02().equals("E")) out.print("checked");%>> N&uacute;mero de Cuenta:
              </div>
            </td>
             <td nowrap width="25%" > 
              <input type="text" onKeyPress="enterInteger()" name="E11EEEACC" size="13" maxlength="12" value="<%= deal.getE11EEEACC().trim()%>">
              <a href="javascript:GetAccountT('E11EEEACC',document.forms[0].E11DEABNK.value,'RT',document.forms[0].E11DEACUN.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="help" align="absbottom" border="0" ></a> 
              o</td>
            <td nowrap width="25%" > 
              <div align="right"> 
                <input type="radio" name="CE11DEAF02" value="D" onClick="document.forms[0].E11DEAF02.value='D'"
			  <%if(deal.getE11DEAF02().equals("D")) out.print("checked");%>>N&uacute;mero de Cuenta Contable:
              </div>
            </td>
            <td nowrap width="25%" > 
      ...
      <td nowrap width="32%" > 
        <div align="center"> 
          ...
          <input type="text" name="E11OFFCO1" size="25" maxlength="25"  value="<%= deal.getE11OFFCO1().trim()%>"
                  oncontextmenu="showPopUp(conceptHelp,this.name,document.forms[0].E11DEABNK.value,'','E11OFFGL1','E11OFFOP1','12')">
        </div>
      </td>
      <td nowrap width="14%" > 
        <div align="center"> 
