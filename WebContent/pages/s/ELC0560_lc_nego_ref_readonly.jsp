...
alt="ELC0560_lc_nego_ref.jsp"></h3>
<hr size="4">
...
<table class="tableinfo" cellspacing="0" cellpadding="2" width="100%" border="0">
  ...
  <tr id="trclear">
    ...
    <td nowrap valign="top" height="24" align="center" width="61"><input name="E01CRPBRN" type="text" onKeyPress="enterInteger()" value="<%=msg01.getE01CRPBRN()%>" size="6" maxlength="3" readonly="readonly" ></td>
    ...
    <td nowrap align="center" valign="top" height="24" width="128"><input name="E01CRPGLN" type="text" onKeyPress="enterInteger()" value="<%=msg01.getE01CRPGLN()%>" size="20" maxlength="16" readonly="readonly"
			></td>
...
<table class="tableinfo" cellspacing="0" cellpadding="2" width="100%" border="0">
	...
	<tr id="<%out.print((i++ %2==0 ? "trdark" : "trclear"));%>">
		...
		<a href="javascript: GetProduct('E01NEWPRO','<%=(msg01.getE01OPCODE().equals("5") ? "10" : "14")%>','<%= msg01.getE01CUSBNK()%>')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Ayuda" align="bottom" border="0"></a>		</td>
	...
	<tr id="<%out.print((i++ %2==0 ? "trdark" : "trclear"));%>">
	  ...
	  <td height="24" align="left" valign="top" nowrap><input name="E01INTRTE" type="text" onKeyPress="enterDecimal()" value="<%=msg01.getE01INTRTE()%>" size="10" maxlength="9" readonly="readonly"></td>
    </tr>
	<tr id="<%out.print((i++ %2==0 ? "trdark" : "trclear"));%>">
	...
	<tr id="<%out.print((i++ %2==0 ? "trdark" : "trclear"));%>">
	  ...
	  <td nowrap><select name="E01PNCLTP" disabled>
          ...
          <option value="3" <% if(msg01.getE01PNCLTP().equals("3")) out.print("selected");%>>Sobre Capital Bigente</option>
          <option value="4" <% if(msg01.getE01PNCLTP().equals("4")) out.print("selected");%>>Sobre Capital Venicdo + Int. Vencido</option>
	...
	<tr id="<%out.print((i++ %2==0 ? "trdark" : "trclear"));%>">
	  ...
	  <input name="E01NXIPDM" type="text" onKeyPress="enterInteger()" value="<%=msg01.getE01NXIPDM()%>" size="2" maxlength="2" readonly="readonly">
          <input name="E01NXIPDD" type="text" onKeyPress="enterInteger()" value="<%=msg01.getE01NXIPDD()%>" size="2" maxlength="2" readonly="readonly">
          <input name="E01NXIPDY" type="text" onKeyPress="enterInteger()" value="<%=msg01.getE01NXIPDY()%>" size="2" maxlength="2" readonly="readonly">
	...
	<tr id="<%out.print((i++ %2==0 ? "trdark" : "trclear"));%>">
      ...
      <a href="javascript:GetCode('E01PRPDYS','STATIC_payment_cycle.jsp')"></a></td>
	  <td height="24" align="right" valign="top" nowrap>Fecha Proximo Pago Principal </td>
	  <td height="24" align="left" valign="top" nowrap>
	  <input name="E01NXPPDM" type="text" onKeyPress="enterInteger()" value="<%=msg01.getE01NXPPDM()%>" size="2" maxlength="2" readonly="readonly">
          <input name="E01NXPPDD" type="text" onKeyPress="enterInteger()" value="<%=msg01.getE01NXPPDD()%>" size="2" maxlength="2" readonly="readonly">
          <input name="E01NXPPDY" type="text" onKeyPress="enterInteger()" value="<%=msg01.getE01NXPPDY()%>" size="2" maxlength="2" readonly="readonly">
