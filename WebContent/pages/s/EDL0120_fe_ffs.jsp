...
function Calculate(){
  ...
  document.forms[0].action = "<%=request.getContextPath()%>/servlet/datapro.eibs.forex.JSEDL0120?SCREEN=4500";
...
String sTitle = "Inversi&oacute;n Nocturna";
try {
   sTitle = trOption.getHeader2();
} catch (Exception e) {
   sTitle = "Inversi&oacute;n Nocturna";
}   
if (sTitle == null) sTitle = "Inversi&oacute;n Nocturna";
        ...
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <% if(deal.getH01FLGWK3().equals("Y")){%>
            ...
            <td nowrap> 
              ...
              <a href="javascript:GetProduct('E01DLSPRO','15','')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="help" align="middle" border="0" ></a> 
