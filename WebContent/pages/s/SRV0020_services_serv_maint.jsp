...
<H3 align="center">Mantenimiento de Servicios - Pago y Cobro de Servicios<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="services_serv_maint,SRV0020"></H3>
<hr size="4">
    ...
    <table cellspacing=0 cellpadding=2 width="100%" border="0">    
     	...
     	<tr id=trclear> 
		  <td> 
      	  ...
      	  <td nowrap> 
      	    <input type="text" name="E01SERACC" size="15" maxlength="12" value="<%= msgMT.getE01SERACC() %>" onKeypress="enterInteger()">
		  ...
		  <td> 
      	  ...
      	  <td nowrap> 
      	    <input type="text" name="E01SERBTH" size="5" maxlength="4" value="<%= msgMT.getE01SERBTH() %>" onkeypress="enterInteger()">
      	  </td>     
      	</tr>
      	<tr id=trclear> 
		  <td> 
     	...
     	<tr id=trdark> 
	      ...
	      <td nowrap>
	      	<input type="text" name="E01SERUD1" size="2" maxlength="2" readonly value="<%= msgMT.getE01SERUD1() %>">
	      	<input type="text" name="E01SERUD2" size="2" maxlength="2" readonly value="<%= msgMT.getE01SERUD2() %>">
	      	<input type="text" name="E01SERUD3" size="2" maxlength="2" readonly value="<%= msgMT.getE01SERUD3() %>">
	      </td>
     	</tr>
     	<tr id=trclear> 
		  <td> 
