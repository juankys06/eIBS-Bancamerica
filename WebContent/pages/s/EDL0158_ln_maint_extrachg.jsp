      ...
      <td> 
        <table cellspacing=0 cellpadding=2 width="100%" border="0" id="INFOCHG">
          ...
          <tr id="trdark">  
            ...
            <td nowrap width="25%"> 
				<input type="text" name="E01DLSAMT" size="17" maxlength="17" value="<%= msgLN.getE01DLSAMT().trim()%>" onkeypress="enterDecimal()">
            </td>
          ...
          <tr id="trclear"> 
            ...
            <td> 
              <input type="text" name="E01DLSNAR" size="30" maxlength="30" value="<%= msgLN.getE01DLSNAR().trim()%>">
            </td>
          </tr>
          <tr id="trdark"> 
            <td width="30%"> 
          ...
          <tr id="trclear"> 
            ...
            <td > 
              <input type="text" name="E01DLSIVP" size="8" maxlength="8" value="<%= msgLN.getE01DLSIVP() %>" onKeypress="enterInteger()">
            </td>
          </tr>
          <tr id="trdark"> 
            <td width="30%"> 
            ...
            <td > 
              <input type="text" name="E01DLSIVB" size="17" maxlength="17" value="<%= msgLN.getE01DLSIVB()%>" onKeypress="enterDecimal()">
            </td>
          </tr>
        </table>                       
      </td>
