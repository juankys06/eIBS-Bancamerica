...
de Tarjetas de Débito<BR>Mantenimiento de Tarjeta Titular<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="assign_accounts_det.jsp,ECC0090"></h3>
<hr size="4">
<% 
