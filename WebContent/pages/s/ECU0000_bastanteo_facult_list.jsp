...
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="bastanteo_facult_list.jsp,ECU0000">
</h3>
<hr size="4">
    ...
    <TD NOWRAP valign=top>
  	 <TABLE id="dataTable" width="100%">
        ...
        <TR>
			...
			<TD NOWRAP ALIGN="CENTER"><%=Util.formatDate(msgMTFac.getE07CULAC1(),msgMTFac.getE07CULAC2(),msgMTFac.getE07CULAC3())  + " - " + Util.formatTime(msgMTFac.getE07CULACT())%></TD>
