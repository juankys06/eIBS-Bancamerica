...
%> 
<h3 align="center">Aceptaciones Bancarias - Back Office<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="fe_acc_mod.jsp,EDL0130B"> 
</h3>
<hr size="4">
    ...
    <tr > 
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trdark"> 
            <td nowrap width="21%" > 
              <div align="right">Valor Facial : </div>
            </td>
          ...
          <tr id="trdark"> 
            ...
            <td nowrap align="right" width="18%">Tasa Efectiva :</td>
