...
function goAction() {
	...
	page = webapp + "/servlet/datapro.eibs.forex.JSEPR0345?SCREEN=300&ROW=" + + row;
...
<h3 align="center">Compraventa Moneda Extranjera<BR>Aprobacion/Rechazo de Solicitudes de Compraventa<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="foreign_currency_exchange_list, EPR0345"></h3>
<hr size="4">
