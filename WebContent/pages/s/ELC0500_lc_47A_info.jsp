...
%> 
<h3 align="center">Condiciones Adicionales (47A)<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="lc_47A_info.jsp, ELC0500"></h3>
<hr size="4">

<FORM METHOD="post" target="newpage" ACTION="<%=request.getContextPath()%>/servlet/datapro.eibs.products.JSEWP0010" >
  <INPUT TYPE=HIDDEN NAME="TYPE" VALUE="47A">
...
<FORM method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.products.JSELC0500" >
  ...
  <INPUT TYPE=HIDDEN NAME="E03LCDFCD" VALUE="47A">
