...
<h3 align="center">Detalles del Documento<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="pay_inq_det.jsp,EDL0825"></h3>
<hr size="4">
...
<p>
  <div align="center"> 
    <input id="EIBSBTN" type=button name="Submit" OnClick="CheckDevol()" value="Enviar">
  </div>
</p>
<SCRIPT>
