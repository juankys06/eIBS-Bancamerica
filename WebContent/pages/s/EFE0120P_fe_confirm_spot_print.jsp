...
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="fe_confirm_spot_print.jsp,EFE0120P">
</h3>
<hr size="4">
...
if (confirm('Por favor, cierre esta ventana al finalizar la impresión.\nDesea continuar con la impresión?'))
	window.print();
</script>
</body>
</html>
