...
<h3 align="center">Instrucciones de Pago<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="client_corp_payment_inst.jsp,ESD0080"></h3>
<hr size="4">
          ...
          <table cellspacing="0" cellpadding="2" class="tbhead" width="100%"  align="center">
            <tr> 
              ...
              <td nowrap width="14%" align="left"> 
				<% if (pymInst.getE11LN3().indexOf("-")<0) {
						out.print(pymInst.getE11IDN().trim());
					} else { out.print(pymInst.getE11LN3().trim());
				    } %>
			  </td>
                          ...
                          <table width="94%" border="0">
                            <tr> 
                              <td width="53%"> 
                                ...
                                <a href="javascript:GetCustomerDescId('E11PYC','','')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt=". . ." align="absmiddle" border="0" ></a> 
                                </div>
                              </td>
                            </tr>
                            <tr> 
                          ...
                          <table width="94%" border="0">
                            <tr> 
                              <td width="53%"> 
                                ...
                                <a href="javascript:GetCustomerDescId('E11RCC','','')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt=". . ." align="absmiddle" border="0" ></a> 
                                </div>
                              </td>
                            </tr>
                            <tr> 
      ...
      <td nowrap> 
        <table cellspacing=0 cellpadding=2 width="100%" border="0">
          <tr id="trdark"> 
            <td nowrap width="25%" > 
             ...
             <td nowrap width="75%" colspan="3" > 
              <input type="text" name="E11CTA" size="12" maxlength="9" value="<% if (pymInst.getE11OFB().equals("")) {out.print(pymInst.getE11OFA().trim());}%>" onKeyPress="enterInteger()">
              <a href="javascript:GetAccount('E11CTA','','RT','')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="help" align="absbottom" border="0" ></a> 
              </td>
          </tr> 
          <tr id="trclear">  
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="25%" > 
              <input type="text"  name="E11GL" size="16" maxlength="16" value="<% if (!pymInst.getE11OFB().equals("")) {out.print(pymInst.getE11OFA().trim());}%>" onKeyPress="enterInteger()">
              <a href="javascript:GetLedger('E11GL',document.forms[0].E11OFB.value,'','')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="help" align="absbottom" border="0" ></a></td>
          </tr>
        </table>
      </td>
    </tr>
