...
%> 
<h3 align="center">Cargos (71B)<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="letter_of_credit_71B_info.jsp,ELC0525"></h3>
<hr size="4">
...
<table class="tableinfo">
    <tr > 
      <td nowrap align="center"> 
          ...
          <input type="text" name="E03LCDM05" size="45" maxlength="35" readonly value="<%= lcAdd.getE03LCDM05().trim()%>"><br>
          <input type="text" name="E03LCDM06" size="45" maxlength="35" readonly value="<%= lcAdd.getE03LCDM06().trim()%>"><br>
      </td>
    </tr>
  </table>
 </form>
