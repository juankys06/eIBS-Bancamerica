...
<h3 align="center">Mantenimiento <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="cd_enter_maint, EDL0130B"></h3>
<hr size="4">
  ...
  <table class="tbenter" height="75%" width="100%" border="0">
    <tr>
      ...
      <td nowrap align="center"> N&uacute;mero de Cuenta : 
        ...
        <a href="javascript:GetDealsAcc('E01DEAACC')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="help" align="absbottom" border="0" ></a> 
        <p align="center"> 
          <% 
