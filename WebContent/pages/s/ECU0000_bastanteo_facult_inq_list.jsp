...
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="bastanteo_facult_inq_list.jsp,ECU0000">
</h3>
<hr size="4">
    ...
    <TD NOWRAP valign=top>
     ...
     %>               
        <TR>
			...
			<TD NOWRAP ALIGN="CENTER"><%=Util.formatDate(msgMT.getE07CULAC1(),msgMT.getE07CULAC2(),msgMT.getE07CULAC3())  + " - " + Util.formatTime(msgMT.getE07CULACT())%></TD>
