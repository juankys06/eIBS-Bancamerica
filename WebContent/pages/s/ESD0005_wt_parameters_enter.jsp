...
%>
 ...
 <h3 align="center">Parametros de Transferencia<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="wt_parameters_enter.jsp,ESD0005"> 
 </h3>
 <hr size="4">
