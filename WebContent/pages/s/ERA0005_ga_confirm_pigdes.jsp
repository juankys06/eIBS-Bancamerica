...
<% 
 if ( !error.getERRNUM().equals("0")  ) {
  ...
  //setTimeout("document.forms[0].submit();", 7000); //neftali
%>
<h3 align="center">
...
%>
           de Garantias a Cuentas del Cliente<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="ga_confirm_pigdes_era0005"> 
</h3>
<hr size="4">
