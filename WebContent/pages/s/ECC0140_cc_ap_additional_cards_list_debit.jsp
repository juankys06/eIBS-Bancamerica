...
%> 
<h3 align="center">Tarjetas de Débito<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="cc_ap_additional_cards_list_debit.jsp , ECC0140"></h3>
<hr size="4">
