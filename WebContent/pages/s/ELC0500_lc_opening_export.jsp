...
<BODY>
<H3 align="center">Apertura de Carta de Credito de Exportacion
<IMG
	src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left"
	name="EIBS_GIF" alt="ELC0500_lc_opening_export"></H3>
<HR size="4">
...
<TABLE cellspacing="0" cellpadding="2" width="100%" border="0" class="tableinfo" id="trclear">
	<TR id="trdark">
	  <TD width="20%" align="right" nowrap="nowrap"><B>Banco :</B></TD>
		<TD width="26%" nowrap="nowrap"><INPUT type="text" name="E01LCMBNK" readonly size="4" maxlength="2" value="<%=msgLC.getE01LCMBNK().trim()%>">
		<b>Agencia :</b><input type="text" name="E01LCMBRN" size="4" maxlength="2" value="<%=msgLC.getE01LCMBRN().trim()%>" readonly >
					    <a href="javascript:GetBranch('E01LCMBRN','')" >
	...
	<TR id="trdark">
	  <TD align="right" nowrap="nowrap"><B>Referencia del Otro Banco :</B></TD>
		...
		<TD align="right" nowrap="nowrap"><B>Descripcion de Producto :</B></TD>
		<TD nowrap="nowrap"><B>
