...
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="ln_ap_special_inst.jsp,EDL0140"> 
<hr size="4">
    ...
    <tr > 
      <td nowrap> 
        <p align="center"> 
          ...
          <input type="text" readonly name="EE5DSC" size="80" maxlength="80" value="<%= lnInst.getEE5DSC().trim()%>"><br>
