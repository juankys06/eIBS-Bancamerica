...
function Calculate(){
  ...
  document.forms[0].action = "<%=request.getContextPath()%>/servlet/datapro.eibs.forex.JSEDL0120?SCREEN=4100";
...
String sTitle = "Financial Blocks";
try {
   sTitle = trOption.getHeader2();
} catch (Exception e) {
   sTitle = "Financial Blocks";
}   
if (sTitle == null) sTitle = "Financial Blocks";

%> 
<h3 align="center"><%= sTitle%><img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="fe_blk.jsp, EDL0120"> 
</h3>
<hr size="4">
        ...
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <% if(deal.getH01FLGWK3().equals("Y")){%>
            ...
            <td nowrap> 
              ...
              <a href="javascript:GetProduct('E01DLSPRO','95','')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="help" align="middle" border="0" ></a> 
