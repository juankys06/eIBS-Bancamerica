...
%> 
<h3 align="center">Aprobaci&oacute;n de Cobranza Simple<br>Instrucciones Especiales<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="sing_special_inst.jsp, EDC0040"></h3>
<hr size="4">
