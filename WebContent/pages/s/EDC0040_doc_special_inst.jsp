...
%> 
<h3 align="center">Aprobaci&oacute;n de Cobranza Documentaria<br>Instrucciones Especiales<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="doc_special_inst.jsp, EDC0040"></h3>
<hr size="4">
