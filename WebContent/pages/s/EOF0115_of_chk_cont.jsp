...
<% 
System.out.println( "Maint:" + userPO.getPurpose() );
System.out.println( "Header19:" + userPO.getHeader19() );
%>
...
%> 
<H3 align="center">Emisi&oacute;n de Cheques<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="of_chk_cont.jsp, EOF0115" width="35" height="35"> 
</H3>
<hr size="4">
