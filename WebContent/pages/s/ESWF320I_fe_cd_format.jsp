...
%>
<h3 align="center">MT 320 Mensaje de Confirmaci&oacute;n<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="fe_cd_format.jsp,ESWF320I"> 
</h3>
<hr size="4">
