...
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="cd_codes.jsp,EDL0130" width="35" ></h3> 
<hr size="4">
      ...
      <td nowrap > 
        <table cellspacing=0 cellpadding=2 width="100%" border="0">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="70%"> 
              <input type="text" name="E02SCH" size="5" maxlength="4" value="<%= cdCodes.getE02SCH().trim()%>">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="70%"> 
              <input type="text" name="E02SST" size="5" maxlength="4" value="<%= cdCodes.getE02SST().trim()%>">
              <input type="text" name="D02SST" size="40" maxlength="35" value="<%= cdCodes.getD02SST().trim()%>" readonly>
              <a href="javascript:GetCodeDescCNOFC('E02SST','D02SST','CF')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="ayuda" align="absbottom" border="0" ></a> 
              <IMG src="<%=request.getContextPath()%>/images/Check.gif"
					alt="campo obligatorio" align="absbottom" border="0"></td>
          </tr>
          <tr id="trdark"> 
            <td nowrap width="30%"> 
              <div align="right">Tipos de Instrumentos :</div>
            </td>
            <td nowrap width="70%"> 
              ...
              <a href="javascript:GetCodeDescCNOFC('E02UC3','D02UC3','1Z')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="ayuda" align="absbottom" border="0" ></a> 
			  <img src="<%=request.getContextPath()%>/images/Check.gif" alt="campo obligatorio" align="absbottom" border="0"  >
            </td>
          </tr>
          <tr id="trclear"> 
            ...
            <td nowrap width="70%"> 
              ...
              <a href="javascript:GetCodeDescCNOFC('E02UC4','D02UC4','2D')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="ayuda" align="absbottom" border="0" ></a> 
            </td>
          </tr>
          <tr id="trdark"> 
            <td nowrap width="30%"> 
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="70%"> 
              ...
              <a href="javascript:GetCodeDescCNOFC('E02UC6','D02UC6','7A')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="ayuda" align="absbottom" border="0" ></a> 
            </td>
          </tr>
          <tr id="trdark"> 
            <td style="white-space:nowrap;width:30%;text-align:right;"> 
            ...
            <td nowrap width="70%"> 
              ...
              <a href="javascript:GetCodeDescCNOFC('E02UC7','D02UC7','7A')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="ayuda" align="absbottom" border="0" ></a> 
            </td>
          </tr>          
<%--
          <tr id="trclear"> 
