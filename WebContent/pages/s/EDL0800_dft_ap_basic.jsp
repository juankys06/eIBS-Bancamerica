					...
					if (lstDocuments.getFlag().equals("") && lstDocuments.getRecord(8).equals(lstAcceptors.getRecord(0))) {
					    if (firstTime) {
							 ...
							 out.print("</TD>");
								...
								{
							 	out.print("<TD>");
							 	out.print("Cuenta Cheque");
							 	out.print("</TD>");

							 	out.print("<TD>");
							 	out.print("Numero Cheque");
							 	out.print("</TD>");
						...
						out.print("</TD>");
							...
							{
							out.print("<TD nowrap>");
							out.print("<div align=\"center\"><INPUT size=\"12\" type=\"text\" name=\"CTA\" value=\"" + lstDocuments.getRecord(20) + "\" readonly></div>");
							out.print("</TD>");
						
							out.print("<TD nowrap>");
							out.print("<div align=\"center\"><INPUT size=\"9\" type=\"text\" name=\"CHQ\" value=\"" + lstDocuments.getRecord(21) + "\" readonly></div>");
							out.print("</TD>");
