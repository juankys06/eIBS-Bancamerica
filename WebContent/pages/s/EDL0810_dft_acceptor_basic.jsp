...
%> 
<h3 align="center">Mantenimiento de Aceptantes<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="dft_acceptor_basic.jsp,EDL0810"> 
</h3>
<hr size="4">
      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td nowrap colspan="3"> 
              <INPUT type="text" name="E03DLDIDA" size="17" maxlength="15" value="<%= dftAcceptor.getE03DLDIDA() %>" <%=strReadonly %> readonly>
            </td>
	          <td nowrap width="25%">
