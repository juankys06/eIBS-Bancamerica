...
<h3 align="center">Consulta de Producto de Tarjetas de Credito<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="products_inq_creditcards.jsp, ESD0711"></h3>
<hr size="4">
      ...
      <td> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td > 
              <input type="text"  name="E01APCDS1" size="40" maxlength="40" value="<%= prd.getE01APCDS1()%>" readonly>
            </td>
            <td > 
              <div align="right">Nombre de Mercadeo :</div>
            </td>
            <td > 
              <input type="text"  name="E01APCDS2" size="30" maxlength="25" value="<%= prd.getE01APCDS2()%>" readonly>
            </td>
          </tr>
          <tr id="trclear"> 
            <td > 
          ...
          <tr id="trclear"> 
            ...
            <td > 
              	<input type="text"  name="E01APCFTF" size="4" maxlength="2" value="<%= prd.getE01APCFTF().trim()%>" readonly>
          ...
          <tr id="trdark">
            ...
            <td>
          	...
          	<a href="javascript:GetCode('E01APCMCI','STATIC_tc_form_use.jsp')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt=". . ." align="absbottom" border="0"></a>          
          	</td>
          </tr>
          <tr id="trclear">
          	<td>
          ...
          <tr id="trdark">
          	...
          	<td>
          		...
          		<a href="javascript:GetCode('E01APCUC2','')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt=". . ." align="absbottom" border="0"></a>   
          	</td>
            <td>
