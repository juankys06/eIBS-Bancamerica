...
<body>
<h3 align="center">Asignación de Tarjetas<br>Tarjeta Adicional<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="card_assign_new_add.jsp, ECC0090">
</h3>
<hr size="4">
<% 
