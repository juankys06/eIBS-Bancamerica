...
%> 
<h3 align="center"> <%= sTitle%><img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="fe_basic_nd_forward.jsp, EFE0120P"> 
</h3>
<hr size="4">
          ...
          <tr id="trdark"> 
          	<% if(fex.getH01FLGWK3().equals("Y")){%>
            	...
            	<td nowrap > 
              		...
              		<a href="javascript:GetClassFex('E01FESCLS','NFR',document.forms[0].E01FESCCY.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="help" align="middle" border="0" ></a> 
            	</td> 
             <%}%>
            <td nowrap  colspan="5" > 
              <div align="right"></div>
