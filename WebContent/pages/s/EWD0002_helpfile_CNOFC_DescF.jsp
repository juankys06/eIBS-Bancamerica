...
function goSearch() {
  window.location.href="<%=request.getContextPath()%>/pages/s/EWD0002_helpfile_CNOFC_DescF.jsp?" + "codeflag=" + document.forms[0].codFlag.value + "&FromRecord=0&SelNew=" + document.forms[0].SelNew.value + "&SelOld=" + document.forms[0].SelOld.value + document.forms[0].filters.value; 
}
//-->
</script>
</HEAD>
...
<%
               		...
               		try
               		{
               	 	...
               	 	try
               	 	{
	               	 	...
	               	 	for (int i=0; i < filters.length ; i++){
	               	 	  ...
	               	 	  msgHelp.getField(filters[i]).setString(paramValue);
	 ...
	 <TABLE  class="tbenter" WIDTH="88%" ALIGN=CENTER>
      ...
      <TD WIDTH="50%" ALIGN=LEFT height="25"> <%
        if ( posIni > 30 ) {
      			int pos = posIni - 31;
      			   out.print("<A HREF=\""+request.getContextPath()+"/pages/s/EWD0002_helpfile_CNOFC_DescF.jsp?"+filterString+"codeflag=" + codeflag + "&FromRecord=" + pos + "&SelNew=" + selNew + "&SelOld=" + selOld + "\" > <img src=\""+request.getContextPath()+"/images/s/previous_records.gif\" border=0></A>");
        } %>
      </TD>
 	  <TD WIDTH="50%" ALIGN=RIGHT height="25"> <%       
        if (marker.equals("+")) {
      			int pos = posEnd;
      			out.print("<A HREF=\""+request.getContextPath()+"/pages/s/EWD0002_helpfile_CNOFC_DescF.jsp?"+filterString+"codeflag=" + codeflag + "&FromRecord=" + pos + "&SelNew=" + selNew + "&SelOld=" + selOld + "\" ><img src=\""+request.getContextPath()+"/images/s/next_records.gif\" border=0></A>");
