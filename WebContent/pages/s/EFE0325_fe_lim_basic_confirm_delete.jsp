...
%> 
<h3 align="center"> Confirmaci&oacute;n - L&iacute;mites Establecidos<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="fe_lim_basic_confirm_delete.jsp,EFE0325"> 
</h3>
<hr size="4">
