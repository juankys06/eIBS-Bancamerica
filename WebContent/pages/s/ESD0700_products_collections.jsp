...
<h3 align="center">Producto para Cobranzas<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="products_inq_ln.jsp, ESD0711"></h3>
<hr size="4">
          ...
          <tr id="trdark"> 
            ...
            <td>
          	...
          	<td>
            	...
            	<a href="javascript:GetLoanTable('E01APCTLN',document.forms[0].E01APCTYP.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" alt=". . ." align="absbottom" border="0" ></a>
            </td>
          </tr>
          <tr>
          	<td>
          	...
          	<td>
          		<div align="right">Tipo de Cobransa:</div>
          	</td>
            <td > 
              	<select name="E01APCAMO">
                	<OPTION value="I" <%if (prd.getE01APCAMO().equals("I")) { out.print("selected"); }%>="">Recibidas</OPTION>
                    <OPTION value="O" <%if (prd.getE01APCAMO().equals("P")) { out.print("selected"); }%>="" selected>Enviadas</OPTION>
            	</select>
            </td>
          </tr>    
          <tr id="trdark">
          	...
          	<td > 
            	<select name="E01APCITP">
              		<OPTION value="D" <%if (prd.getE01APCITP().equals("D")) { out.print("selected"); }%>="">Documentarias</OPTION>
                	<OPTION value="C" <%if (prd.getE01APCITP().equals("C")) { out.print("selected"); }%>="">Simple</OPTION>
            	</select>
            </td>
		  </tr>
          <tr id="trclear"> 
            ...
            <td > 
              	<select name="E01APCCDT">
                  	<OPTION value="P" <%if (prd.getE01APCCDT().equals("P")) { out.print("selected"); }%>="">Pago</OPTION>
                  	<OPTION value="A" <%if (prd.getE01APCCDT().equals("A")) { out.print("selected"); }%>="">Aceptacion</OPTION>
              	</select>
            </td>
          </tr>                 
        </table>
