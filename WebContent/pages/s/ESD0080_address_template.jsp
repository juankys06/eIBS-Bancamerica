          ...
          <table cellspacing="0" cellpadding="2" width="100%" border="0" align="left">
           ...
           <%if(currUser.getE01INT().equals("18")){%> 
            <tr id="teclear"> 
              ...
              <a href="javascript:GetCodeCNOFC('<%= suffix %>UC7','84')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="ayuda" align="absbottom" border="0"></a> 
              <img src="<%=request.getContextPath()%>/images/Check.gif" alt="mandatory field" align="absbottom" ></td>
            </tr>
            <tr id="trdark"> 
              <td nowrap width="39%"> 
              ...
              <a href="javascript:GetCodeCNOFC('<%= suffix %>UC8','80')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="ayuda" align="absbottom" border="0"></a> 
              <img src="<%=request.getContextPath()%>/images/Check.gif" alt="mandatory field" align="absbottom" ></td>
            </tr>
            <%} else {%>           
            <tr id="teclear"> 
            ...
            <tr id="trdark"> 
              ...
              <td nowrap width="61%">  
                ...
                <a href="javascript:GetCodeCNOFC('<%= suffix %>STE','27')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="ayuda" align="absbottom" border="0"></a> 
                <img src="<%=request.getContextPath()%>/images/Check.gif" alt="mandatory field" align="absbottom" ></td>
            </tr>
            <%}%>
            <tr id="teclear"> 
