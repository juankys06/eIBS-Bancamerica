...
<H3 align="center">Sistema de Bastanteo - Creacion de Integrantes de la Administraci&oacute;n<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="bastanteo_members_new,ECU0000"></H3>
<hr size="4">
