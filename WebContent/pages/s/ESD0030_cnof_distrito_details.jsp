...
<H3 align="center">C&oacute;digos de Referencia del Sistema  - Distritos<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="cnof_distrito_details.jsp, ESD0030"></H3>
<hr size="4">
