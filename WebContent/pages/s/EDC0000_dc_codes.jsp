...
<h3 align="center">Cobranza Documentaria C&oacute;digos Especiales
	<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="dc_codes.jsp, EDC0000" width="35" height="35"></h3> 
<hr size="4">
        ...
        <table cellspacing=0 cellpadding=2 width="100%" border="0" height="118">
          <tr id="trdark"> 
            ...
            <td nowrap width="70%"> 
              ...
              <a href="javascript:GetCodeDescCNOFC('E02OFC','D02OFC','15')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="ayuda" border="0" align="middle"></a> 
              <img src="<%=request.getContextPath()%>/images/Check.gif" alt="campo obligatorio" border="0" align="middle"> 
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap width="30%"> 
            ...
            <td nowrap width="70%"> 
              ...
              <a href="javascript:GetCodeDescCNOFC('E02OF2','D02OF2','10')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="ayuda" border="0" align="middle"></a> 
              <img src="<%=request.getContextPath()%>/images/Check.gif" alt="campo obligatorio" border="0" align="middle"> 
            </td>
          </tr>
          <tr id="trdark"> 
            ...
            <td nowrap width="70%"> 
              ...
              <a href="javascript:GetCodeDescCNOFC('E02INC','D02INC','09')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="ayuda" border="0" align="middle"></a> 
              <img src="<%=request.getContextPath()%>/images/Check.gif" alt="campo obligatorio" border="0" align="middle"> 
            </td>
          </tr>
          <tr id="trclear"> 
            ...
            <td nowrap width="70%"> 
              ...
              <a href="javascript:GetCodeDescCNOFC('E02BUC','D02BUC','12')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="ayuda" border="0" align="middle"></a> 
            </td>
          </tr>
          <tr id="trdark"> 
            <td nowrap width="30%"> 
            ...
            <td nowrap width="70%"> 
              ...
              <a href="javascript:GetCodeDescCNOFC('E02GEC','D02GEC','03')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="ayuda" border="0" align="middle"></a> 
              <img src="<%=request.getContextPath()%>/images/Check.gif" alt="campo obligatorio" border="0" align="middle"> 
            </td>
          </tr>
          <tr id="trclear"> 
            ...
            <td nowrap width="70%"> 
              ...
              <a href="javascript:GetCodeDescCNOFC('E02GRC','D02GRC','03')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="ayuda" border="0" align="middle"></a> 
            </td>
          </tr>
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="70%"> 
              ...
              <a href="javascript:GetCodeDescCNOFC('E02ORG','D02ORG','18')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="ayuda" border="0" align="middle"></a> 
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="70%"> 
              ...
              <a href="javascript:GetCodeDescCNOFC('E02DST','D02DST','38')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="ayuda" border="0" align="middle"></a> 
			</td>
          </tr>
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="70%"> 
              ...
              <a href="javascript:GetCodeDescCNOFC('E02UC1','D02UC1','2A')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="ayuda" border="0" align="middle"></a> 
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap width="30%"> 
            ...
            <td nowrap width="70%"> 
              ...
              <a href="javascript:GetCodeDescCNOFC('E02UC2','D02UC2','2B')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="ayuda" border="0" align="middle"></a> 
            </td>
          </tr>
          <tr id="trdark"> 
            <td nowrap width="30%"> 
            ...
            <td nowrap width="70%"> 
              ...
              <a href="javascript:GetCodeDescCNOFC('E02UC3','D02UC3','2C')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="ayuda" border="0" align="middle"></a> 
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap width="30%"> 
            ...
            <td nowrap width="70%"> 
              ...
              <a href="javascript:GetCodeDescCNOFC('E02UC4','D02UC4','CA')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="ayuda" border="0" align="middle"></a> 
            </td>
          </tr>
        </table>
      </td>
