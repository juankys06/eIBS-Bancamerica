...
<IMG src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" alt="ELC0560_lc_negotiation_acp.jsp" name="EIBS_GIF"></H3>
<HR size="4">
...
<TABLE class="tableinfo" cellspacing="0" cellpadding="2" width="100%" border="0">
	...
	<TR>
		...
		<INPUT name="E01MATDTY" value="<%=msg01.getE01MATDTY()%>" size="2" maxlength="2" ></TD>
	</TR>
	<TR>
