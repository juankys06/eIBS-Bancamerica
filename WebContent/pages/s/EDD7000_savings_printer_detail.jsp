...
<H3 align="center">Impresion Datos del Titular en Libreta de Ahorros<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="savings_printer_detail,EDD7000"></H3>
<hr size="4">
