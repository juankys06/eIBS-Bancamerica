...
%> 
<H3 align="center"> Mantenimiento de Cuentas de Ahorro<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="sv_basic.jsp, EDD0000"></H3>
<hr size="4">
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          <tr id="trdark"> 
            ...
            <td nowrap width="20%" > 
              <div align="left">
                ...
                <a href="javascript:GetCustomer('E01ACMCUN')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Ayuda" align="bottom" border="0" ></a></div>
            </td>
            <td nowrap width="16%" > 
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="20%"> 
              <div align="left">
                <input type="text" name="E01ACMACC" size="12" maxlength="12" value="<%= svBasic.getE01ACMACC().trim()%>" readonly>
              </div>
            </td>
            <td nowrap width="16%"> 
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="26%"> 
              <input type="text" name="E01ACMSU1" size="2" maxlength="2" value="<%= svBasic.getE01ACMSU1().trim()%>" readonly>
              <input type="text" name="E01ACMSU2" size="2" maxlength="2" value="<%= svBasic.getE01ACMSU2().trim()%>" readonly>
              <input type="text" name="E01ACMSU3" size="2" maxlength="2" value="<%= svBasic.getE01ACMSU3().trim()%>" readonly>            
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap width="29%"> 
            ...
            <td nowrap width="19%"> 
              <input type="text" name="E01ACMWHF" size="2" maxlength="1" value="<%= svBasic.getE01ACMWHF().trim()%>" <%= blocked %>>
				<% if (blocked == "") { %>
              		<a href="javascript:GetCode('E01ACMWHF','STATIC_cd_taxes.jsp')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Ayuda" align="bottom" border="0" ></a><img src="<%=request.getContextPath()%>/images/Check.gif" alt="campo obligatorio" align="bottom" border="0" > 
				<% } %>
            </td>
            <td nowrap width="26%"> 
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="26%" height="23"> 
              ...
              No <img src="<%=request.getContextPath()%>/images/Check.gif" alt="campo obligatorio" align="bottom" border="0" ></td>
          </tr>
          <tr id="trclear"> 
            ...
            <td nowrap width="26%" height="19">
              ...
              <a href="javascript:GetCostCenter('E01ACMCCN','01')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="help" align="middle" border="0" ></a> 
              <img src="<%=request.getContextPath()%>/images/Check.gif" alt="campo obligatorio" align="bottom" border="0" > 
            </td>
          </tr>
          <tr id="trdark"> 
            ...
            <td nowrap width="19%" height="19"> 
              <input type="text" size="2" maxlength="1" value="<%= svBasic.getE01ACMWLF().trim()%>" name="E01ACMWLF" <%= blocked %>>
				<% if (blocked == "") { %>
              		<a href="javascript:GetCode('E01ACMWLF','STATIC_rt_delay.jsp')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Ayuda" align="bottom" border="0" ></a> 
				<% } %>
            </td>
            <td nowrap width="26%" height="19"> 
            ...
            <td nowrap width="26%" height="19"> 
              <input type="text" size="2" maxlength="1" value="<%= svBasic.getE01ACMWNF().trim()%>" name="E01ACMWNF" <%= blocked %>>
				<% if (blocked == "") { %>
              		<a href="javascript:GetCode('E01ACMWNF','STATIC_rt_delay.jsp')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Ayuda" align="bottom" border="0" ></a> 
				<% } %>
            </td>
          </tr>
          <tr id="trclear">
            ...
            <% if (!protect && svBasic.getH01FLGMAS().equals("N")) {%>
              ...
              <a href="javascript:GetBranch('E01ACMBRN','')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="ayuda" align="bottom" border="0"  ></a>
             <% } else {%>
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td nowrap width="18%"> 
			  ...
			  <%if(svBasic.getE01ACMSCF().equals("Y")) out.print("checked");%> <%= blocked %>>
              S&iacute; 
              <input type="radio" name="CE01ACMSCF" value="N" onClick="document.forms[0].E01ACMSCF.value='N'"
			  <%if(svBasic.getE01ACMSCF().equals("N")) out.print("checked");%> <%= blocked %>>
              No <img src="<%=request.getContextPath()%>/images/Check.gif" alt="campo obligatorio" align="bottom" border="0" ></td>
            <td nowrap width="28%"> 
              <div align="right">Frecuencia Cobro Cargos:</div>
            </td>
            <td nowrap width="24%">
              <select name="E01ACMSHF" <%= blocked %>>
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="18%"> 
              <input type="text" name="E01ACMACL" size="2" maxlength="2" value="<%= svBasic.getE01ACMACL().trim()%>" <%= blocked %>>
				<% if (blocked == "") { %>
              		<a href="javascript:GetRetCod('E01ACMACL',document.forms[0].E01ACMATY.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Ayuda" align="absmiddle" border="0" ></a> 
              		<img src="<%=request.getContextPath()%>/images/Check.gif" alt="campo obligatorio" align="bottom" border="0" > 
				<% } %>
            </td>
            <td nowrap width="28%"> 
            ...
            <td nowrap width="24%"> 
              <input type="text" name="E01ACMSHY" size="3" maxlength="2" value="<%= svBasic.getE01ACMSHY().trim()%>" <%= blocked %>>
				<% if (blocked == "") { %>
              		<a href="javascript:GetCode('E01ACMSHY','STATIC_rt_ciclo.jsp')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Ayuda" align="bottom" border="0" ></a> 
              		<img src="<%=request.getContextPath()%>/images/Check.gif" alt="campo obligatorio" align="bottom" border="0" > 
				<% } %>
            </td>
          </tr>
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="18%"> 
              ...
              <a href="javascript:GetCode('E01ACMSDY','STATIC_rt_ciclo.jsp')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Ayuda" align="bottom" border="0" ></a> 
              <img src="<%=request.getContextPath()%>/images/Check.gif" alt="campo obligatorio" align="bottom" border="0" > 
            </td>
            <td nowrap width="28%"> 
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="24%" height="23">
              <select name="E01ACMSTE" 
				<% if (svBasic.getH01FLGWK2().equals("Y")) {%>
					 disabled="disabled"
				<%}%>
			  >
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td nowrap width="70%"> 
              <input type="text" size="12" maxlength="12" name="E01ACMPBN" value="<%= svBasic.getE01ACMPBN().trim()%>" <%= blocked %>>
          ...
          <tr id="trclear"> 
            <td nowrap > 
              <div align="center" nowrap> 
                <input type="text" name="E01OFFOP<%= name %>" id="E01OFFOP<%= name %>" value="<%= svBasic.getField("E01OFFOP"+name).getString().trim()%>" size="3" maxlength="3">
            ...
            <td nowrap> 
              <div align="center"> 
                <input type="text" name="E01OFFAC<%= name %>" id="E01OFFAC<%= name %>" size="12" maxlength="12"  value="<%= svBasic.getField("E01OFFAC"+name).getString().trim()%>"
