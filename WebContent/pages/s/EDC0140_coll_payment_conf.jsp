...
<H3 align="center"> Liquidacion de Cobranza<IMG src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="coll_payment_conf.jsp, EDC0060"></H3>
<HR size="4">
<BR>
...
<TABLE class="tableinfo" cellspacing="0" cellpadding="2" width="100%" border="0">
  <TR id="trdark">
     <TD align="right" width="80%"><B>Totales</B></TD>
