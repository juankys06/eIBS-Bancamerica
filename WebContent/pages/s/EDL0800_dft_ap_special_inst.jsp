...
%> 
<h3 align="center">Instrucciones Especiales <%= userPO.getHeader4().trim()%><img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="dft_ap_special_inst.jsp, EDL0800"></h3>
<hr size="4">
