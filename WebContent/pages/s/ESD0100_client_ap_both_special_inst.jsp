...
%> 
<h3 align="center">Instrucciones Especiales <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="client_ap_both_special_inst.jsp, ESD0100"></h3>
<hr size="4">
<p>&nbsp;</p>
