...
%> 
          <tr id="trclear"> 
            <td nowrap align="center"> <% if(invAcc.getField("E01PCAAC" + name).getString().trim().equals("0") || invAcc.getField("E01ERRFL" + name).getString().trim().equals("Y")) { %> 
              <a href="javascript:showRetAccountInq(document.forms[0].E01PCAAC<%= name %>.value)"><img src="<%=request.getContextPath()%>/images/1aquire.gif" alt="click for account inquiry" align="absbottom" border="0" > 
...
<input readonly type="text" name="E01PCAAC<%= name %>" maxlength="12" size="12" value="<%= invAcc.getField("E01PCAAC" + name).getString().trim()%>">
              ...
              </a> <a href="javascript:showRetAccountHolders(document.forms[0].E01PCAAC<%= name %>.value)"><img src="<%=request.getContextPath()%>/images/accountholder.gif" alt="press for account holders" align="absbottom" border="0" ></a> 
