...
function goAction(op) {
 ...
 if (op == 1) {
     ...
     page = prefix +language + 'EDL1111_ln_inq_sch.jsp?ROW=' + document.forms[0].ROW.value;
 }
...
<h3 align="center">Abonos Masivos, Proceso Manual - Aprobación<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="ln_list_sch.jsp,EDL1111"> 
</h3>
<hr size="4">
