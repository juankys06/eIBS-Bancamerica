...
<h3 align="center">Maestro de Interfaces <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="interface_list.jsp, EIMP040"></h3>
<hr size="4">
	...
	<tr id="trdark"> 
      ...
      <td align=CENTER width="75%"> 
        <div align="left"> 
          ...
          <a href="javascript:GetCodeDescCNOFC('E01IMICDE','','BT')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="ayuda" align="absbottom" border="0"></a> 
        </div>
      </td>
    </tr>
   <tr id="trclear">
