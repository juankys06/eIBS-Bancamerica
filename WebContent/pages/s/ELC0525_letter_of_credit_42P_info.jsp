...
%> 
<h3 align="center">Detalle de Pago Diferido (42P)<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="letter_of_credit_42P_info.jsp,ELC0525"></h3>
<hr size="4">
