...
<H3 align="center">Mantenimiento de Retenciones e Impuestos <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="taxes_600_feci.jsp, ESD0009"></H3>
<hr size="4">
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap height="19"> 
              <div align="left"> 
                <input type="text" name="E01TAXGLA" size="17" maxlength="16" value="<%= taxes.getE01TAXGLA().trim()%>">
                <a href="javascript:GetLedger('E01TAXGLA',document.forms[0].E01TAXBNK.value,'','')"> 
                <img src="<%=request.getContextPath()%>/images/1b.gif" alt=". . ." align="absbottom" border="0" ></a></div>
            </td>
          </tr>
          <tr id="trdark"> 
            ...
            <td nowrap height="19"> 
              <div align="left"> 
                <input type="text" name="E01TAXGLB" size="17" maxlength="16" value="<%= taxes.getE01TAXGLB().trim()%>">
                <a href="javascript:GetLedger('E01TAXGLB',document.forms[0].E01TAXBNK.value,'','')"> 
                <img src="<%=request.getContextPath()%>/images/1b.gif" alt=". . ." align="absbottom" border="0" ></a></div>
            </td>
          </tr>
          <tr id="trclear"> 
            ...
            <td nowrap height="19"> 
              <div align="left"> 
                <input type="text" name="E01TAXGLC" size="17" maxlength="16" value="<%= taxes.getE01TAXGLC().trim()%>">
                <a href="javascript:GetLedger('E01TAXGLC',document.forms[0].E01TAXBNK.value,'','')"> 
                <img src="<%=request.getContextPath()%>/images/1b.gif" alt=". . ." align="absbottom" border="0" ></a></div>
            </td>
          </tr>
          <tr id="trdark"> 
            ...
            <td nowrap height="19"> 
              <div align="left"> 
                <input type="text" name="E01TAXGLD" size="17" maxlength="16" value="<%= taxes.getE01TAXGLD().trim()%>">
                <a href="javascript:GetLedger('E01TAXGLD',document.forms[0].E01TAXBNK.value,'','')"> 
                <img src="<%=request.getContextPath()%>/images/1b.gif" alt=". . ." align="absbottom" border="0" ></a></div>
            </td>
          </tr>
          <tr id="trclear"> 
            ...
            <td nowrap height="19"> 
              <div align="left"> 
                <input type="text" name="E01TAXGLE" size="17" maxlength="16" value="<%= taxes.getE01TAXGLE().trim()%>">
                <a href="javascript:GetLedger('E01TAXGLE',document.forms[0].E01TAXBNK.value,'','')"> 
                <img src="<%=request.getContextPath()%>/images/1b.gif" alt=". . ." align="absbottom" border="0" ></a></div>
            </td>
          </tr>
          <tr id="trdark"> 
            ...
            <td nowrap height="19"> 
              <div align="left"> 
                <input type="text" name="E01TAXGLH" size="17" maxlength="16" value="<%= taxes.getE01TAXGLH().trim()%>">
                <a href="javascript:GetLedger('E01TAXGLH',document.forms[0].E01TAXBNK.value,'','')"> 
                <img src="<%=request.getContextPath()%>/images/1b.gif" alt=". . ." align="absbottom" border="0" ></a></div>
            </td>
          </tr>
          <tr id="trclear"> 
