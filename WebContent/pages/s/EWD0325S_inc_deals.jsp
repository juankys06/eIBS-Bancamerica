...
<BODY onLoad="MM_preloadImages('<%=request.getContextPath()%>/images/s/new_over.gif','<%=request.getContextPath()%>/images/s/maintenance_over.gif','<%=request.getContextPath()%>/images/e/exit_over.gif','<%=request.getContextPath()%>/images/e/delete_over.gif')">
<% 
...
<h3 align="center"><%= sTitle%><img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="inc_deals.jsp,EWD0325S"></h3>
<hr size="4">
  <form>
<% 
