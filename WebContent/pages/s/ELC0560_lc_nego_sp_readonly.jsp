...
<table class="tableinfo" cellspacing="0" cellpadding="2" width="100%" border="0">
	...
	<tr id="trclear">
	  ...
	  <input name="E01CUSGLN" type="text" onKeyPress="enterInteger()" value="<%= msg01.getE01CUSGLN()%>" size="20" maxlength="16" readonly="readonly"
			></td>
...
<table class="tableinfo" cellspacing="0" cellpadding="2" width="100%" border="0">
	...
	<tr id="trclear">
		...
		<td nowrap align="left">
			<input type="text" name="E01LCMBAC" size="16" maxlength="12" readonly></td>
	</tr>
	<tr id="trdark">
