...
<H3 align="center">Otras Inscripciones<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="ga_new_detail.jsp , ERA0011"></H3> 
<hr size="4">
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td nowrap>
              ...
              <A href="javascript:GetCustomerDescId('E02RODCUN','E02RODDSC','')"><IMG src="<%=request.getContextPath()%>/images/1b.gif" alt=". . ." align="absbottom" border="0"></A>
            </td>
            <td nowrap > 
          ...
          <tr id="trclear"> 
            ...
            <td nowrap>
              ...
              <A href="javascript:GetCodeCNOFC('E02RODUC1','X0')"><IMG src="<%=request.getContextPath()%>/images/1b.gif" alt=". . ." align="absbottom" border="0"></A> </td>
          </tr>
          <tr id="trdark"> 
            <td nowrap> 
            ...
            <td nowrap >
              ...
              <a href="javascript:GetCodeCNOFC('E02RODUC2','2J')"><IMG src="<%=request.getContextPath()%>/images/1b.gif" alt=". . ." align="absbottom" border="0"></A>
            </td>
            <td nowrap > 
            ...
            <td nowrap > 
              <div align="left"> 
                ...
                <A href="javascript:GetCode('E02RODEST','STATIC_coll_help_benef.jsp')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt=". . ." align="absbottom" border="0"  ></a>            
              </div>
            </td>
          </tr>
          <tr id="trclear">
            ...
            <td nowrap colspan=3>
              ...
              <a href="javascript:GetBranch('E02RODOFN','')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt=". . ." align="absbottom" border="0"  ></a>                         
            </td>
          </tr>
        </table>
      </td>
      ...
      <td nowrap> 
        <table cellspacing=0 cellpadding=2 width="100%" border="0">          
            ...
            <td nowrap> 
              ...
              <a href="javascript:GetTypeBroker('E02RODRF4','N')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt=". . ." align="absbottom" border="0"  ></a>                        
            </td>
          </tr>
        <% if (!userPO.getType().equals("05")) { %>
          ...
          <tr id="trdark"> 
            ...
            <td nowrap> 
              ...
              <a href="javascript:GetCodeCNOFC('E02RODUC7','2K')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt=". . ." align="absbottom" border="0"  ></a> 
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap > 
          ...
          <tr id="trdark"> 
            ...
            <td nowrap >               
              ...
              <a href="javascript:GetCodeCNOFC('E02RODCPH','2K')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt=". . ." align="absbottom" border="0"  ></a> 
            </td>
          </tr>
		  <TR id="trclear">
