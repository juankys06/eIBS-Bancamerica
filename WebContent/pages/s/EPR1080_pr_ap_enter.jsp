...
<h3 align="center">Transacciones Financieras Aprobacion<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="pr_ap_enter.jsp, EPR1080A"></h3>
<hr size="4">
