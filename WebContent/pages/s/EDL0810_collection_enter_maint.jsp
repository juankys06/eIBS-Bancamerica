...
<h3 align="center">Carta Guia de Cobranzas<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="collection_enter_maint, EDL0810"></h3>
<hr size="4">
<p>&nbsp;</p>
