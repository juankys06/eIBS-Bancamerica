...
<h3 align="center">Tasas Lideres<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="rt_tables,EDL0110L" ></h3>
<hr size="4">
      ...
      <tr > 
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0" align="left" >
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="18%"> 
              <div align="left"> 
                <input type="text" name="E02PRRPRT" size="6" maxlength="5" value="<%= rates.getE02PRRPRT()%>">
              </div>
            </td>
            <td nowrap width="29%"> 
            ...
            <td nowrap width="31%" > 
                 <input type="text" name="E02PRRSRT" size="6" maxlength="5" value="<%= rates.getE02PRRSRT()%>">  
            </td>
          </tr>           
        </table>
      </td>
