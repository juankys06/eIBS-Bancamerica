<html>
<head>
<title>Consulta de Productos para Papel Commercial</title>
...
<h3 align="center">Producto para Papel Commercial<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="products_inq_ln.jsp, ESD0711"></h3>
<hr size="4">
      ...
      <td > 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <tr id="trdark"> 
            ...
            <td>
            	<div align="right">Calculo de Interes :</div>
          	</td>
          	<td width="25%"> 
            	<input type="text"  name="E01APCICT" size="4" maxlength="2" value="<%= prd.getE01APCICT().trim()%>">                
            	<a href="javascript:GetCode('E01APCICT','STATIC_pc_prod_calc_int.jsp')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt=". . ." align="absbottom" border="0"></a> 
            </td>
          </tr>                   
        </table>
      </td>
      ...
      <td > 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td> 
              <div align="right">Tipo de Inversion : </div>
            </td>
            <td>
          ...
          <tr id="trclear">
         	 <td>
            	<div align="right">Periodo de Pago Cupon</div>
          	 </td>
            <td>
          ...
          <tr id="trdark">
          	...
          	<td width="25%"> 
            	...
            	<a href="javascript:GetCode('E01APCITP','STATIC_pc_prod_typ_port.jsp')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt=". . ." align="absbottom" border="0" ></a>
            </td>
            <td>
          	...
          	<td width="25%"> 
            	...
            	<a href="javascript:GetCode('E01APCFRN','STATIC_pc_prod_typ_rev.jsp')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt=". . ." align="absbottom" border="0" ></a>
            </td>            
          </tr>
          <tr id="trclear">
          	<td>
          		<div align="right">Cobro de Impuestos :</div>
          	</td>
          	<td>
          		<input type="text"  name="E01APCTAX" size="4" maxlength="2" value="<%= prd.getE01APCTAX().trim()%>">                
          		<a href="javascript:GetCode('E01APCTAX','STATIC_pc_prod_taxinstructions.jsp')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt=". . ." align="absbottom" border="0" ></a>
          	</td>
          	<td>
