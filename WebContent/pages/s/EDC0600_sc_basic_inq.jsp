...
<h3 align="center">Tabla de Gastos y Comisiones de Cobranzas<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="sc_basic_inq.jsp,EDC0600"></h3>
<hr size="4">
...
<table class="tableinfo" cellspacing="0" cellpadding="2" width="100%" border="0" >
          ...
          <tr id="trclear"> 
            ...
            <td nowrap colspan="3" > 
              <div align="left"> 
                <input type="text" name="E01RCODSC" size="30" maxlength="25" value="<%= sc.getE01RCODSC().trim()%>" readonly>
              </div>
            </td>
           </tr>
  </table>
  ...
  <TABLE class="tableinfo"  cellspacing="0" cellpadding="2" width="100%" border="0">
    <tr id="trdark"> 
     ...
     <tr id="trclear"> 
      ...
      <td nowrap > 
        <div align="center"> 
          <input type="text" name="E01RCOCRT" size="12" maxlength="9" value="<%= sc.getE01RCOCRT().trim()%>" readonly>
        </div>
      </td>
      <td nowrap  > 
        <div align="center"> 
          <input type="text" name="E01RCOCCP" size="5" maxlength="4" value="<%= sc.getE01RCOCCP().trim()%>" onkeypress="enterInteger()" readonly>
        </div>
      </td>
      <td nowrap > 
      
        <div align="center"> 
          <input type="text" name="E01RCOCMF" size="12" maxlength="11" value="<%= sc.getE01RCOCMF().trim()%>" onkeypress="enterDecimal()" readonly>
        </div>
      </td>
      <td nowrap > 
        <div align="center"> 
          <input type="text" name="E01RCOCMX" size="12" maxlength="11" value="<%= sc.getE01RCOCMX().trim()%>" onkeypress="enterDecimal()" readonly>
        </div>
      </td>
      <td nowrap > 
        <div align="center"> 
          <select name="E01RCOI01" disabled>
     ...
     <tr id="trdark"> 
      ...
      <td nowrap > 
        <div align="center"> 
          <input type="text" name="E01RCODRT" size="12" maxlength="9" value="<%= sc.getE01RCODRT().trim()%>" readonly>
        </div>
      </td>
      <td nowrap  > 
        <div align="center"> 
          <input type="text" name="E01RCODCP" size="5" maxlength="4" value="<%= sc.getE01RCODCP().trim()%>" onkeypress="enterInteger()" readonly>
        </div>
      </td>
      <td nowrap > 
        <div align="center"> 
          <input type="text" name="E01RCODMF" size="12" maxlength="11" value="<%= sc.getE01RCODMF().trim()%>" onkeypress="enterDecimal()" readonly>
        </div>
      </td>
      <td nowrap > 
        <div align="center"> 
          <input type="text" name="E01RCODMX" size="12" maxlength="11" value="<%= sc.getE01RCODMX().trim()%>" onkeypress="enterDecimal()" readonly>
        </div>
      </td>
      <td nowrap > 
         <div align="center"> 
          <select name="E01RCOI02" disabled>
     ...
     <tr id="trclear"> 
      ...
      <td nowrap > 
        <div align="center"> 
          <input type="text" name="E01RCORRT" size="12" maxlength="9" value="<%= sc.getE01RCORRT().trim()%>" readonly>
        </div>
      </td>
      <td nowrap  > 
        <div align="center"> 
          <input type="text" name="E01RCORCP" size="5" maxlength="4" value="<%= sc.getE01RCORCP().trim()%>" onkeypress="enterInteger()" readonly>
        </div>
      </td>
      <td nowrap > 
        <div align="center"> 
          <input type="text" name="E01RCORMF" size="12" maxlength="11" value="<%= sc.getE01RCORMF().trim()%>" onkeypress="enterDecimal()" readonly>
        </div>
      </td>
      <td nowrap > 
        <div align="center"> 
          <input type="text" name="E01RCORMX" size="12" maxlength="11" value="<%= sc.getE01RCORMX().trim()%>" onkeypress="enterDecimal()" readonly>
        </div>
      </td>
      <td nowrap > 
         <div align="center"> 
          <select name="E01RCOI03" disabled>
     ...
     <tr id="trdark"> 
      ...
      <td nowrap > 
        <div align="center"> 
          <input type="text" name="E01RCOEBR" size="12" maxlength="9" value="<%= sc.getE01RCOEBR().trim()%>" readonly>
        </div>
      </td>
      <td nowrap  > 
        <div align="center"> 
          <input type="text" name="E01RCOEBP" size="5" maxlength="4" value="<%= sc.getE01RCOEBP().trim()%>" onkeypress="enterInteger()" readonly>
        </div>
      </td>
      <td nowrap > 
        <div align="center"> 
          <input type="text" name="E01RCOEMF" size="12" maxlength="11" value="<%= sc.getE01RCOEMF().trim()%>" onkeypress="enterDecimal()" readonly>
        </div>
      </td>
      <td nowrap > 
        <div align="center"> 
          <input type="text" name="E01RCOEMX" size="12" maxlength="11" value="<%= sc.getE01RCOEMX().trim()%>" onkeypress="enterDecimal()" readonly>
        </div>
      </td>
      <td nowrap > 
         <div align="center"> 
          <select name="E01RCOI04" disabled>
     ...
     <tr id="trclear"> 
      ...
      <td nowrap > 
        <div align="center"> 
          <input type="text" name="E01RCOPPM" size="12" maxlength="11" value="<%= sc.getE01RCOPPM().trim()%>" onkeypress="enterDecimal()" readonly>
        </div>
      </td>
      <td nowrap > 
      </td>
      ...
      <td nowrap > 
        <div align="center"> 
          <select name="E01RCOI05" disabled>
     ...
     <tr id="trdark"> 
      ...
      <td nowrap > 
        <div align="center"> 
          <input type="text" name="E01RCOPRT" size="12" maxlength="11" value="<%= sc.getE01RCOPRT().trim()%>" onkeypress="enterDecimal()" readonly>
        </div>
      </td>
      <td nowrap > 
      </td>
      ...
      <td nowrap > 
        <div align="center"> 
          <select name="E01RCOI06" disabled>
     ...
     <tr id="trclear"> 
      ...
      <td nowrap > 
        <div align="center"> 
          <input type="text" name="E01RCOTR1" size="12" maxlength="11" value="<%= sc.getE01RCOTR1().trim()%>" onkeypress="enterDecimal()" readonly>
        </div>
      </td>
      <td nowrap > 
      </td>
     ...
     <tr id="trdark"> 
      ...
      <td nowrap > 
        <div align="center"> 
          <input type="text" name="E01RCOTR2" size="12" maxlength="11" value="<%= sc.getE01RCOTR2().trim()%>" onkeypress="enterDecimal()" readonly>
        </div>
      </td>
      <td nowrap > 
      </td>
     ...
     <tr id="trclear"> 
      ...
      <td nowrap > 
        <div align="center"> 
          <input type="text" name="E01RCOUNP" size="12" maxlength="11" value="<%= sc.getE01RCOUNP().trim()%>" onkeypress="enterDecimal()" readonly>
        </div>
      </td>
      <td nowrap > 
      </td>
      ...
      <td nowrap > 
        <div align="center"> 
          <select name="E01RCOI08" disabled>
     ...
     <tr id="trdark"> 
      ...
      <td nowrap > 
        <div align="center"> 
          <input type="text" name="E01RCOAMF" size="12" maxlength="11" value="<%= sc.getE01RCOAMF().trim()%>" onkeypress="enterDecimal()" readonly>
        </div>
      </td>
      <td nowrap > 
      </td>
      ...
      <td nowrap > 
        <div align="center"> 
          <select name="E01RCOI09" disabled>
     ...
     <tr id="trclear"> 
      ...
      <td nowrap > 
        <div align="center"> 
          <input type="text" name="E01RCOADP" size="12" maxlength="11" value="<%= sc.getE01RCOADP().trim()%>" onkeypress="enterDecimal()" readonly>
        </div>
      </td>
      <td nowrap > 
      </td>
     ...
     <tr id="trdark"> 
      ...
      <td nowrap > 
        <div align="center"> 
          <input type="text" name="E01RCOESD" size="12" maxlength="11" value="<%= sc.getE01RCOESD().trim()%>" onkeypress="enterDecimal()" readonly>
        </div>
      </td>
      <td nowrap > 
      </td>
      ...
      <td nowrap > 
        <div align="center"> 
          <select name="E01RCOI11" disabled>
     ...
     <tr id="trclear"> 
      ...
      <td nowrap > 
        <div align="center"> 
          <input type="text" name="E01RCOLIF" size="12" maxlength="11" value="<%= sc.getE01RCOLIF().trim()%>" onkeypress="enterDecimal()" readonly>
        </div>
      </td>
      <td nowrap > 
      </td>
      <td nowrap  > 
      	<div align="center"> 
          <input type="text" name="E01RCOLIP" size="5" maxlength="4" value="<%= sc.getE01RCOLIP().trim()%>" onkeypress="enterInteger()" readonly>
        </div>
      </td>
      <td nowrap > 
      </td>
      ...
      <td nowrap > 
        <div align="center"> 
          <select name="E01RCOI12" disabled>
    ...
    <tr id="trdark"> 
      ...
      <td nowrap > 
        <div align="center"> 
          <input type="text" name="E01RCOPDA" size="12" maxlength="11" value="<%= sc.getE01RCOPDA().trim()%>" onkeypress="enterDecimal()" readonly>
        </div>
      </td>
      <td nowrap > 
      </td>
      <td nowrap  > 
      	<div align="center"> 
          <input type="text" name="E01RCOPDP" size="5" maxlength="4" value="<%= sc.getE01RCOPDP().trim()%>" onkeypress="enterInteger()" readonly>
        </div>
      </td>
      <td nowrap > 
      </td>
      ...
      <td nowrap > 
        <div align="center"> 
          <select name="E01RCOI13" disabled>
     ...
     <tr id="trclear"> 
      ...
      <td nowrap > 
        <div align="center"> 
          <input type="text" name="E01RCOWTF" size="12" maxlength="11" value="<%= sc.getE01RCOWTF().trim()%>" onkeypress="enterDecimal()" readonly>
        </div>
      </td>
      <td nowrap > 
      </td>
      ...
      <td nowrap > 
        <div align="center"> 
          <select name="E01RCOI14" disabled>
     ...
     <tr id="trdark"> 
      ...
      <td nowrap > 
        <div align="center"> 
          <input type="text" name="E01RCOPST" size="12" maxlength="11" value="<%= sc.getE01RCOPST().trim()%>" onkeypress="enterDecimal()" readonly>
        </div>
      </td>
      <td nowrap > 
      </td>
      ...
      <td nowrap > 
        <div align="center"> 
          <select name="E01RCOI15" disabled>
     ...
     <tr id="trclear"> 
      ...
      <td nowrap > 
        <div align="center"> 
          <input type="text" name="E01RCOPTC" size="12" maxlength="11" value="<%= sc.getE01RCOPTC().trim()%>" onkeypress="enterDecimal()" readonly>
        </div>
      </td>
      <td nowrap > 
      </td>
     ...
     <tr id="trdark"> 
      ...
      <td nowrap > 
        <div align="center"> 
          <input type="text" name="E01RCOCOD" size="12" maxlength="11" value="<%= sc.getE01RCOCOD().trim()%>" onkeypress="enterDecimal()" readonly>
        </div>
      </td>
      <td nowrap > 
      </td>
      ...
      <td nowrap > 
        <div align="center"> 
          <select name="E01RCOI16" disabled>
     ...
     <tr id="trclear"> 
      ...
      <td nowrap > 
        <div align="center"> 
          <input type="text" name="E01RCOCOF" size="12" maxlength="11" value="<%= sc.getE01RCOCOF().trim()%>" onkeypress="enterDecimal()" readonly>
        </div>
      </td>
      <td nowrap > 
      </td>
     ...
     <tr id="trdark"> 
      ...
      <td nowrap > 
        <div align="center"> 
          <input type="text" name="E01RCOFXD" size="12" maxlength="11" value="<%= sc.getE01RCOFXD().trim()%>" onkeypress="enterDecimal()" readonly>
        </div>
      </td>
      <td nowrap > 
      </td>
      ...
      <td nowrap > 
        <div align="center"> 
          <select name="E01RCOI17" disabled>
      ...
      <td nowrap > 
        <div align="center"> 
          <input type="text" name="E01RCOFXF" size="12" maxlength="11" value="<%= sc.getE01RCOFXF().trim()%>" onkeypress="enterDecimal()" readonly>
        </div>
      </td>
      <td nowrap > 
      </td>
      ...
      <td nowrap > 
        <div align="center"> 
          <input type="text" name="E01RCOLTX" size="12" maxlength="11" value="<%= sc.getE01RCOLTX().trim()%>" onkeypress="enterDecimal()" readonly>
        </div>
      </td>
      <td nowrap > 
      </td>
      ...
      <td nowrap > 
        <div align="center"> 
          <select name="E01RCOI18" disabled>
      ...
      <td nowrap > 
        <div align="center"> 
          <input type="text" name="E01RCOSTX" size="12" maxlength="11" value="<%= sc.getE01RCOSTX().trim()%>" onkeypress="enterDecimal()" readonly>
        </div>
      </td>
      <td nowrap > 
      </td>
      ...
      <td nowrap > 
        <div align="center"> 
          <input type="text" name="E01RCOSWF" size="12" maxlength="11" value="<%= sc.getE01RCOSWF().trim()%>" onkeypress="enterDecimal()" readonly>
        </div>
      </td>
      <td nowrap > 
      </td>
      ...
      <td nowrap > 
        <div align="center"> 
          <select name="E01RCOI19" disabled>
  ...
  <TABLE class="tableinfo" cellspacing="0" cellpadding="2" width="100%" border="0">
    <tr id="trdark"> 
     ...
     <tr id="trclear"> 
      ...
      <td nowrap > 
         <div align="center"> 
          <input type="text" name="E01RCOGCC" size="18" maxlength="16" value="<%= sc.getE01RCOGCC().trim()%>" onkeypress="enterInteger()" readonly>
        </div>
       </td>
      <td nowrap > 
        <div align="center"> 
     ...
     <tr id="trdark"> 
      ...
      <td nowrap > 
         <div align="center"> 
          <input type="text" name="E01RCOGDC" size="18" maxlength="16" value="<%= sc.getE01RCOGDC().trim()%>" onkeypress="enterInteger()" readonly>
        </div>
       </td>
      <td nowrap > 
        <div align="center"> 
      ...
      <td nowrap > 
         <div align="center"> 
          <input type="text" name="E01RCOGRD" size="18" maxlength="16" value="<%= sc.getE01RCOGRD().trim()%>" onkeypress="enterInteger()" readonly>
        </div>
       </td>
      <td nowrap > 
        <div align="center"> 
     ...
     <tr id="trdark"> 
      ...
      <td nowrap > 
         <div align="center"> 
          <input type="text" name="E01RCOGEV" size="18" maxlength="16" value="<%= sc.getE01RCOGEV().trim()%>" onkeypress="enterInteger()" readonly>
        </div>
       </td>
      <td nowrap > 
        <div align="center"> 
     ...
     <tr id="trclear"> 
      ...
      <td nowrap > 
         <div align="center"> 
          <input type="text" name="E01RCOGPP" size="18" maxlength="16" value="<%= sc.getE01RCOGPP().trim()%>" onkeypress="enterInteger()" readonly>
        </div>
       </td>
      <td nowrap > 
        <div align="center"> 
     ...
     <tr id="trdark"> 
      ...
      <td nowrap > 
         <div align="center"> 
          <input type="text" name="E01RCOGPR" size="18" maxlength="16" value="<%= sc.getE01RCOGPR().trim()%>" onkeypress="enterInteger()" readonly>
        </div>
       </td>
      <td nowrap > 
        <div align="center"> 
     ...
     <tr id="trclear"> 
      ...
      <td nowrap > 
         <div align="center"> 
          <input type="text" name="E01RCOGTR" size="18" maxlength="16" value="<%= sc.getE01RCOGTR().trim()%>" onkeypress="enterInteger()" readonly>
        </div>
       </td>
      <td nowrap > 
        <div align="center"> 
     ...
     <tr id="trdark"> 
      ...
      <td nowrap > 
         <div align="center"> 
          <input type="text" name="E01RCOGUI" size="18" maxlength="16" value="<%= sc.getE01RCOGUI().trim()%>" onkeypress="enterInteger()" readonly>
        </div>
       </td>
      <td nowrap > 
        <div align="center"> 
     ...
     <tr id="trclear"> 
      ...
      <td nowrap > 
         <div align="center"> 
          <input type="text" name="E01RCOGAM" size="18" maxlength="16" value="<%= sc.getE01RCOGAM().trim()%>" onkeypress="enterInteger()" readonly>
        </div>
       </td>
      <td nowrap > 
        <div align="center"> 
      ...
      <td nowrap > 
         <div align="center"> 
          <input type="text" name="E01RCOGAP" size="18" maxlength="16" value="<%= sc.getE01RCOGAP().trim()%>" onkeypress="enterInteger()" readonly>
        </div>
       </td>
      <td nowrap > 
        <div align="center"> 
      ...
      <td nowrap > 
         <div align="center"> 
          <input type="text" name="E01RCOGED" size="18" maxlength="16" value="<%= sc.getE01RCOGED().trim()%>" onkeypress="enterInteger()" readonly>
        </div>
       </td>
      <td nowrap > 
        <div align="center"> 
     ...
     <tr id="trdark"> 
      ...
      <td nowrap > 
         <div align="center"> 
          <input type="text" name="E01RCOGLI" size="18" maxlength="16" value="<%= sc.getE01RCOGLI().trim()%>" onkeypress="enterInteger()" readonly>
        </div>
       </td>
      <td nowrap > 
        <div align="center"> 
     ...
     <tr id="trclear"> 
      ...
      <td nowrap > 
         <div align="center"> 
          <input type="text" name="E01RCOGPD" size="18" maxlength="16" value="<%= sc.getE01RCOGPD().trim()%>" onkeypress="enterInteger()" readonly>
        </div>
       </td>
      <td nowrap > 
        <div align="center"> 
     ...
     <tr id="trdark"> 
      ...
      <td nowrap > 
         <div align="center"> 
          <input type="text" name="E01RCOGWT" size="18" maxlength="16" value="<%= sc.getE01RCOGWT().trim()%>" onkeypress="enterInteger()" readonly>
        </div>
       </td>
      <td nowrap > 
        <div align="center"> 
     ...
     <tr id="trclear"> 
      ...
      <td nowrap > 
         <div align="center"> 
          <input type="text" name="E01RCOGPO" size="18" maxlength="16" value="<%= sc.getE01RCOGPO().trim()%>" onkeypress="enterInteger()" readonly>
        </div>
       </td>
      <td nowrap > 
        <div align="center"> 
     ...
     <tr id="trdark"> 
      ...
      <td nowrap > 
         <div align="center"> 
          <input type="text" name="E01RCOGCR" size="18" maxlength="16" value="<%= sc.getE01RCOGCR().trim()%>" onkeypress="enterInteger()" readonly>
        </div>
       </td>
      <td nowrap > 
        <div align="center"> 
     ...
     <tr id="trclear"> 
      ...
      <td nowrap > 
         <div align="center"> 
          <input type="text" name="E01RCOGFX" size="18" maxlength="16" value="<%= sc.getE01RCOGFX().trim()%>" onkeypress="enterInteger()" readonly>
        </div>
       </td>
      <td nowrap > 
        <div align="center"> 
     ...
     <tr id="trdark"> 
      ...
      <td nowrap > 
         <div align="center"> 
          <input type="text" name="E01RCOGTX" size="18" maxlength="16" value="<%= sc.getE01RCOGTX().trim()%>" onkeypress="enterInteger()" readonly>
        </div>
       </td>
      <td nowrap > 
        <div align="center"> 
      ...
      <td nowrap > 
         <div align="center"> 
          <input type="text" name="E01RCOGSW" size="18" maxlength="16" value="<%= sc.getE01RCOGSW().trim()%>" onkeypress="enterInteger()" readonly>
        </div>
       </td>
      <td nowrap > 
        <div align="center"> 
