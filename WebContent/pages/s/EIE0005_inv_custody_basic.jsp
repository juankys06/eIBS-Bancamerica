...
%>
<div align="center"> 
  <h3>Agentes de Custodia <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="inv_brokers_basic.jsp,EIE0005"> 
  </h3>
</div>
<hr size="4">
        ...
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td nowrap width="34%" > 
              ...
              <a href="javascript:GetCode('E01FEBWTH','STATIC_inv_with.jsp')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt=". . ." align="absbottom" border="0"></a> 
            </td>
            <td nowrap width="34%" > 
            ...
            <td nowrap width="66%" > 
              ...
              <a href="javascript:GetCode('E01FEBPVI','STATIC_inv_payment_via.jsp')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt=". . ." align="absbottom" border="0"></a> 
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap width="34%" > 
