...
function Calculate(){
  ...
  document.forms[0].action = "<%=request.getContextPath()%>/servlet/datapro.eibs.forex.JSEDL0120?SCREEN=4200";
...
String sTitle = "Certificado de Dep&oacute;sito";
try {
   sTitle = trOption.getHeader2();
} catch (Exception e) {
   sTitle = "Certificado de Dep&oacute;sito";
}   
if (sTitle == null) sTitle = "Certificado de Dep&oacute;sito";

%> 
<h3 align="center"> <%= sTitle%><img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="fe_cds.jsp, EDL0120"> 
</h3>
<hr size="4">
      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap align="right" width="25%">Tipo de Calculo de Interes :</td>
