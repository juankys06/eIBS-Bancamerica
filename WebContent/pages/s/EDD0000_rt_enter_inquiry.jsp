...
<h3 align="center">Consulta de Cuentas Corrientes<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="rt_enter_inquiry, EDD0000"></h3>
<hr size="4">
<p>&nbsp;</p>
