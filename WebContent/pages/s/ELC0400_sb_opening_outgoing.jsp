...
Stand By Emitida <IMG
	src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left"
	name="EIBS_GIF" alt="ELC0400_sb_opening_outgoing.jsp"></H3>
<HR size="4">
...
<TABLE class="tableinfo" cellspacing="0" cellpadding="2" border="0" width="100%" align="center">
  ...
  <TR id="">
    ...
    <TD align="left"><INPUT type="text" name="E01LCMAP5" size="4" maxlength="4"
        ...
        <IMG src="<%=request.getContextPath()%>/images/1b.gif" alt="Ayuda" align="bottom" border="0" ></A> C&oacute;digo Postal
      <INPUT type="text"
...
<TABLE class="tableinfo"  cellspacing="0" cellpadding="2" border="0" width="100%" align="center">
  ...
  <TR id="">
    ...
    <TD  align="left" nowrap><INPUT type="text" name="E01LCMRBA" size="12" maxlength="12" value="<%=msg.getE01LCMRBA()%>">
		...
		<IMG src="<%=request.getContextPath()%>/images/1b.gif" alt="Ayuda" align="bottom" border="0"></A> Cliente o
