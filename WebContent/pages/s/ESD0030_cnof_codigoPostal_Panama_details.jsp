...
<H3 align="center">C&oacute;digos de Referencia del Sistema  - Código Postal<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="cnof_codigoPostal_Panama_details.jsp, ESD0030"></H3>
<hr size="4">
