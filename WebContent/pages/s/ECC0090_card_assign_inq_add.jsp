...
<body>
<h3 align="center">Asignación de Tarjetas<BR>Consulta de Tarjeta Adicional<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="card_assign_inq_add.jsp, ECC0090"></h3>
<hr size="4">
<% 
