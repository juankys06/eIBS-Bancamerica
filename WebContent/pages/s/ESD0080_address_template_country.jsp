          ...
          <tr id="<%=color1%>"> 
           ...
           <tr id="<%=color2%>">
            ...
            <td nowrap="nowrap" width="66%" > 
              ...
              <% if ( !readOnly ) {%>
              <A href="javascript:GetCodeDescCNOFC('<%="E"+index+state%>','<%="D"+index+state%>','27')" >
           ...
           <tr id="<%=color1%>">
            ...
            <td nowrap="nowrap" width="66%" > 
              ...
              <% if ( !readOnly ) {%>
              <a href="javascript:Get2FilterCodes('<%="E"+index+city%>','<%="D"+index+city%>','27', document.getElementById('<%="E"+index+state%>').value,'')" >
				<img src="<%=request.getContextPath()%>/images/1b.gif" alt="Ayuda" align="bottom" border="0" style="cursor:hand"/>
	          </a>
				<img src="<%=request.getContextPath()%>/images/Check.gif" alt="mandatory field" align="bottom" border="0"/> 
              <% } %>
