...
%> 
<h3 align="center">Narrativa para Banco Reembolsador (77A)<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="lc_79_info.jsp, ELC0500"></h3>
<hr size="4">
