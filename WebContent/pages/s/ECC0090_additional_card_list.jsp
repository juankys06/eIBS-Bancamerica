...
de Tarjetas de Débito<BR>Mantenimiento de Tarjeta Adicional<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="additional_card_list.jsp, ECC0090"></h3>
<hr size="4">
<% 
