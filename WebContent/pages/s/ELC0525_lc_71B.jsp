...
name="EIBS_GIF" alt="ELC0525_lc_71B.jsp"></H3>
<HR size="4">
  ...
  <table class="tableinfo" cellspacing="0" cellpadding="4" width="100%" border="0">
  	<TR id="trdark">
  		...
  		<TD nowrap align="left" width="20%">
  			<INPUT type="text" name="E03LCDPRO" size="5" maxlength="4" value="<%= userPO.getProdCode() %>" readonly></TD>
  		<TD nowrap align="right" width="10%"><B>Banco:</B></TD>
  		<TD nowrap align="left" width="20%">
  			<INPUT type="text" readonly name="E03LCDBNK" size="3" maxlength="2" value="<%= userPO.getBank() %>"></TD>
  		<TD nowrap width="25%" align="right"><B>Numero Carta de Credito:</B></TD>
  		<TD nowrap align="left" width="15%">
  			<INPUT type="text" readonly name="E03LCDACC" size="21" maxlength="20"value="<%=msg050003.getE03LCDACC().trim()%>"></TD>
  	</TR>
  </TABLE>
<BR>
<TABLE class="tableinfo">
    <TR > 
      <TD nowrap align="center"> 
          ...
          <INPUT name="E03LCDM05" type="text" value="<%= msg050003.getE03LCDM05().trim()%>" size="45" maxlength="35" readonly="readonly"><BR>
          <INPUT name="E03LCDM06" type="text" value="<%= msg050003.getE03LCDM06().trim()%>" size="45" maxlength="35" readonly="readonly"><BR>
      </TD>
    </TR>
  </TABLE>
</FORM>
