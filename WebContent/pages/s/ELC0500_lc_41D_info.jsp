...
%> 
<h3 align="center">Credito Disponible Con  (41D)<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="lc_39C_info.jsp, ELC0500"></h3>
<hr size="4">
...
<form METHOD="post" ACTION="<%=request.getContextPath()%>/servlet/datapro.eibs.products.JSELC0500" >
  ...
  <INPUT TYPE=HIDDEN NAME="E03LCDFCD" VALUE="41D">
