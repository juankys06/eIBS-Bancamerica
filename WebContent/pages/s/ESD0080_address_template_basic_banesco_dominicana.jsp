...
<%
  ...
  // NOMBRES DE CAMPOS
	...
	String adicional_1 = suffix + (basicData?"RF1":"RF1") ;
	String adicional_2 = suffix + (basicData?"RF2":"RF2") ;
	...
	String eMailF = suffixMod + "IAD" ;
  	String adicional_1F = suffix + (basicData?"RF1":"RF1") ;
	String adicional_2F = suffix + (basicData?"RF2":"RF2") ;
%>
...
<% } %>
          			...
          			<tr id="<%=color2%>">
            			<td nowrap ><div align="right">Sector :</div></td>
            			<td nowrap > 
          			...
          			<tr id="<%=color1%>"> 
           			...
           			<tr id="<%=color2%>"> 
            			<td nowrap ><div align="right">Informaci&oacute;n Adicional :</div></td>
            			<td nowrap > 
              				<input type="text" name="<%=adicional_1%>"   size="81" maxlength="80" value="<%= mr.getField(adicional_1).getString()%>" <%=READ_ONLY_TAG%> 
              				<% if(basicData){ out.print((mr.getField(adicional_1F).getString().equals("Y"))?"id=\"txtchanged\"":"");} %> >	
            			</td>
           			</tr>
           			<tr id="<%=color1%>"> 
            			<td nowrap ><div align="right"></div></td>
            			<td nowrap > 
              				<input type="text" name="<%=adicional_2%>"   size="81" maxlength="80" value="<%= mr.getField(adicional_2).getString()%>" <%=READ_ONLY_TAG%> 
              				<% if(basicData){ out.print((mr.getField(adicional_2F).getString().equals("Y"))?"id=\"txtchanged\"":"");} %> >	
            			</td>	
           			</tr>
	           			<tr id="<%=color2%>">
