...
<h3 align="center">Abonos Masivos, Proceso Automático - Aceptar<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="ln_enter_sch_acp,EDL1111"></h3>
<hr size="4">
