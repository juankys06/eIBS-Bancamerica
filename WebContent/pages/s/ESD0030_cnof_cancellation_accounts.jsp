...
<H3 align="center">C&oacute;digos de Referencia del Sistema - Causas de Cancelaci&oacute;n 
  de Cuentas<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="cnof_cancellation_accounts.jsp, ESD0030"></H3>
<hr size="4">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap height="19"> 
              <div align="left"> 
                ...
                <a href="javascript:GetCodeCNOFC('E02CNODCC','20')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="ayuda" align="absbottom" border="0"></a></div>
            </td>
          </tr>
        </table>
      </td>
