...
%> 
<h3 align="center">Confirmacion de asignacion de cuentas a tarjetas<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="cc_confirm.jsp,ECC0080"></h3> 
<hr size="4">
      ...
      <td> 
        ...
        <table width="100%">
          ...
          <tr>
            <td width="9%">&nbsp;</td>
            <td width="91%"> 
              <div align="left"> En favor de : <%= ccAsgn.getE01CUSNA1().trim()%> </div>
            </td>
          </tr>
          <tr>
