...
%> 
<h3 align="center">Details of Guarantee (77C)<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="lc_77C_info.jsp, ELC0500"></h3>
<hr size="4">
 ...
 <form METHOD="post" ACTION="<%=request.getContextPath()%>/servlet/datapro.eibs.products.JSELC0500" >
  ...
  <INPUT TYPE=HIDDEN NAME="E03LCDFCD" VALUE="77C">
...
<table class="tableinfo">
    <tr > 
	  ...
	  <div style="height:320px; overflow-y: scroll">
          ...
          <input type="text" name="E03LCDM00" size="66" maxlength="65" value="<%= lcAdd.getE03LCDM00().trim()%>">
		  </div>
      </td>
    </tr>
  </table>
