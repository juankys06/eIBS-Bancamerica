...
%>
<h3 align="center">MT 340 Mensaje de Confirmaci&oacute;n<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="fe_fra_format.jsp, ESWF340"> 
</h3>
<hr size="4">
