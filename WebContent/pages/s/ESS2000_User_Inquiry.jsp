      ...
      <tr > 
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0" align="left">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="60%" ><div align="left"> <input readonly type="text" ID="MANDATORY" name="E01EUSACC" size="35" maxlength="9" readonly value="<%= cusdata.getE01EUSACC().trim()%>" onkeypress="enterInteger()">
