...
<h3 align="center">Cuentas Corrientes Sin Intereses<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="ESD0205_rt_tables_dda_01, ESD0205" ></h3>
<hr size="4">
  ...
  <table class="tableinfo">
      <tr > 
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0" align="left" >
          <tr id="trdark"> 
            <td nowrap width="22%"> 
              <div align="right">Retenci&oacute;n y Env&iacute;o Estado de Cta. :</div>
            </td>
            <td nowrap width="18%"> 
              <div align="left"> 
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="29%"> 
              <div align="right">Cargo x Manejo de Cuenta :</div>
            </td>
            <td nowrap width="31%" > 
              <div align="left"> 
