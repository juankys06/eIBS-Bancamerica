...
<h3 align="center">Compraventa Moneda Extranjera<BR>Aprobacion de Liquidacion de Operaciones<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="foreign_currency_exchange_detail, EPR0350"></H3>
<%} else {%>
<h3 align="center">Compraventa Moneda Extranjera<BR>Liquidacion de Operaciones<%if (userPO.getHeader10().equals("D")) {%> Diarias <%} else {%> SPOT <%}%><img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="foreign_currency_exchange_detail, EPR0350"></H3>
<%}%>
<hr size="4">
   ...
   <td>
    <table cellspacing=0 cellpadding=2 width="100%" border="0">    
		...
		<tr>
			...
			<td nowrap width="60%">
                <input type="text" name="E01REQAD1" size="2" maxlength="2" value="<%= msgInst.getE01REQAD1() %>" readonly>
                <input type="text" name="E01REQAD2" size="2" maxlength="2" value="<%= msgInst.getE01REQAD2() %>" readonly>
                <input type="text" name="E01REQAD3" size="2" maxlength="2" value="<%= msgInst.getE01REQAD3() %>" readonly>
