...
<jsp:useBean id= "EDL0110LHelp" class= "datapro.eibs.beans.JBList"  scope="session" />
...
function getParams(tar,des1,tfr1,tto1,type1,rtPry1,rtSec1,pryMonth1,pryDay1,pryYear1)
{

	document.forms[0].TABLEN.value = tar;
	document.forms[0].DSC.value = des1;
	
    document.forms[0].TFR.value = tfr1;
  	document.forms[0].TTO.value = tto1;
...
<BODY>
<h3 align="center">Tasas Lideres</h3>
<hr size="4">
<FORM name="form1" METHOD="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.params.JSEDL0110L" >
  ...
  <input type=HIDDEN name="TFR" value="">
  <input type=HIDDEN name="TTO" value="">
...
<TABLE  id=cfTable class="tableinfo">
          ...
          <tr id="trdark"> 
            ...
            <td align=CENTER nowrap>Rango<br> Inicial
            </td> 
            <td align=CENTER nowrap>Rango<br> Final
            </td>                         
            <td align=CENTER nowrap>Tipo<br> Selecci&oacute;n
            </td>            
            <td align=CENTER nowrap> 
          ...
          <%
                ...
                while (EDL0110LHelp.getNextRow()) {
                  ...
                  out.println(EDL0110LHelp.getRecord());
                  k++;   
                }
              %>
