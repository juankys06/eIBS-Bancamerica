...
<title>Forma de Recepci&oacute;n</title>
...
<body>
<h4>Forma de Recepci&oacute;n</h4>
<table align=center class=tableinfo style="width:95%">
	...
	<%
		    ST_ReceptionType stReceptionType = new ST_ReceptionType("es");
		    Iterator it = stReceptionType.getMap().entrySet().iterator();
		    while (it.hasNext()) {
