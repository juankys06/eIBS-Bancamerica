...
%> 
<h3 align="center"> Portafolio - Orden de Compra / Venta<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="inv_basic_bonds.jsp, EIV0301"> 
</h3>
<hr size="4">
