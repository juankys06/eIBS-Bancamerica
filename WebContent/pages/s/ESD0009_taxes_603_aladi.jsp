...
<H3 align="center">Mantenimiento de Retenciones e Impuestos <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="taxes_603_aladi.jsp, ESD0009"></H3>
<hr size="4">
    ...
    <tr bordercolor="#FFFFFF"> 
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <tr id="trclear"> 
            <td nowrap width="16%" height="19"> 
              <div align="right">Moneda Impuestos Recibidos :</div>
            </td>
            <td nowrap height="19"> 
              <div align="left"> 
                <input type="text" name="E01TAXCCY" size="4" maxlength="3" >
                <a href="javascript:GetCurrency('E01TAXCCY','')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="help" align="absmiddle" border="0" ></a></div>
            </td>
          </tr>
        </table>
      </td>
