...
<BODY>
<h3 align="center">Solicitud de Pre-Cancelación<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="cd_precancel_list.jsp, ESO0000"></h3>
<hr size="4">
