...
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="lc_codes.jsp,ESD0000" width="35" height="35"> 
<hr size="4">
-->
<h3 align="center">C&oacute;digos de Clasificaci&oacute;n<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="lc_codes.jsp,ESD0000"></h3>
<hr size="4">
