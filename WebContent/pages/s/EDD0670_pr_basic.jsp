...
<h3 align="center">Ordenes de Pago <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="pr_basic.jsp,EDD0670" ></h3>
<hr size="4">
    ...
    <tr id="trclear"> 
      ...
      <td nowrap align="center" width="60%"> 
	   ...
	   <a href="javascript:GetCurrency('E01CCY','')"> 
          <img src="<%=request.getContextPath()%>/images/1b.gif" alt="help" align="absmiddle" border="0" width="18" height="22">
	   </a> 
        </div>
      </td>
    </tr>
