...
<frameset  rows="99,573*" cols="*"> 
  <frame name="query" src="<%=request.getContextPath()%>/pages/s/EWD0302_portfolio_help_search.jsp" marginwidth=0 marginheight=0 scrolling="no" frameborder="0" border = "0">
