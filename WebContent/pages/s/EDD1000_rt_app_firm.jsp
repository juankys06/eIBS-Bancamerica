...
<h3 align="center">Firmantes<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="rt_firm_pa.jsp, EDD0000"></h3>
<hr size="4">
      ...
      <td> 
        ...
        <tr id="trdark"> 
            ...
            <td nowrap> 
			  ...
			  <a href="javascript:GetSignerByCustomer('E<%= name %>4RCN','E<%= name %>4MA1','E<%= name %>4NME','E<%= name %>4TID','E<%= name %>4PID','E<%= name %>4MA2','E<%= name %>4MA3','E<%= name %>4MA4','E<%= name %>4CTY','E<%= name %>4STE','E<%= name %>4CTR','E<%= name %>4POB','E<%= name %>4ZPC','','','','','E<%= name %>4HPN','<%=name%>')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt=". . ." align="absbottom" border="0" ></a>
