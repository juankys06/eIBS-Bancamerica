...
<h3 align="center"> Calculadora de Intereses<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="cd_cal.jsp, EDL0290"></h3>
<hr size="4">
      ...
      <td nowrap> 
        <table cellspacing=0 cellpadding=2 width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td nowrap width="28%" > 
              <input type="text" name="E01DEAACC" size="14" maxlength="12" value="<%= inqLoans.getE01DEAACC().trim()%>" >
            ...
            <td nowrap colspan="2" >N&uacute;mero de Cliente : 
              <input type="text" name="E01DEACUN" size="10" maxlength="9" value="<%= inqLoans.getE01DEACUN().trim()%>" >
      ...
      <td nowrap > 
        <table cellspacing=0 cellpadding=2 width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td nowrap > 
              <input type="text" name="E01DEAPRI" size="15" maxlength="15" value="<%= inqLoans.getE01DEAPRI().trim()%>" >
            </td>
            <td nowrap > 
              <div align="right"></div>
            </td>
          ...
          <tr id="trclear"> 
            ...
            <td nowrap  bordercolor="#FFFFFF" > 
              <input type="text" name="E01DEAOD1" size="2" maxlength="2" value="<%= inqLoans.getE01DEAOD1().trim()%>" >
              <input type="text" name="E01DEAOD2" size="2" maxlength="2" value="<%= inqLoans.getE01DEAOD2().trim()%>" >
              <input type="text" name="E01DEAOD3" size="2" maxlength="2" value="<%= inqLoans.getE01DEAOD3().trim()%>" >
            </td>
            <td nowrap  bordercolor="#FFFFFF" > 
              <div align="right">Fecha Final :</div>
            </td>
            <td nowrap  bordercolor="#FFFFFF" > 
              <input type="text" name="E01DEAMD1" size="2" maxlength="2" value="<%= inqLoans.getE01DEAMD1().trim()%>" >
              <input type="text" name="E01DEAMD2" size="2" maxlength="2" value="<%= inqLoans.getE01DEAMD2().trim()%>" >
              <input type="text" name="E01DEAMD3" size="2" maxlength="2" value="<%= inqLoans.getE01DEAMD3().trim()%>" >
            </td>
          </tr>
          <tr id="trdark"> 
            <td nowrap > 
            ...
            <td nowrap  bordercolor="#FFFFFF" > 
              ...
              <select name="E01DEATRC">
                ...
                <option value="D" <% if(inqLoans.getE01DEATRC().equals("D")) out.print("selected");%>>D&iacute;a(s)</option>
                <option value="M" <% if(inqLoans.getE01DEATRC().equals("M")) out.print("selected");%>>Mes(es)</option>
                <option value="Y" <% if(inqLoans.getE01DEATRC().equals("Y")) out.print("selected");%>>A&ntilde;o(s)</option>
              </select>
            </td>
            <td nowrap  bordercolor="#FFFFFF" > 
            ...
            <td nowrap  bordercolor="#FFFFFF" > 
              <input type="text" name="E01DEARTE" size="10" maxlength="9" value="<%= inqLoans.getE01DEARTE().trim()%>" >
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap  > 
            ...
            <td nowrap  bordercolor="#000000" > 
              <input type="text" name="E01DEABAS" size="3" maxlength="3" value="<%= inqLoans.getE01DEABAS().trim()%>" >
            </td>
            <td nowrap  bordercolor="#000000" > 
          ...
          <tr id="trclear"> 
            ...
            <td nowrap  bordercolor="#000000">
              <input type="text" name="E01DSCRTE" size="10" maxlength="9" value="<%= inqLoans.getE01DSCRTE().trim()%>" >
            </td>
            <td nowrap  bordercolor="#000000"> 
              <div align="right">Vencimiento :</div>
            </td>
            <td nowrap  bordercolor="#000000"> 
              <input type="text" name="E01DYSNME" size="10" maxlength="9" value="<%= inqLoans.getE01DYSNME().trim()%>" >
            </td>
          </tr>
          <tr id="trdark"> 
            <td nowrap > 
            ...
            <td nowrap  bordercolor="#000000"> 
              <input type="text" name="E01VENCI1" size="2" maxlength="2" value="<%= inqLoans.getE01VENCI1().trim()%>" >
              <input type="text" name="E01VENCI2" size="2" maxlength="2" value="<%= inqLoans.getE01VENCI2().trim()%>" >
              <input type="text" name="E01VENCI3" size="2" maxlength="2" value="<%= inqLoans.getE01VENCI3().trim()%>" >
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap > 
            ...
            <td nowrap  bordercolor="#000000">
              <input type="text" name="E01DEAINT" size="15" maxlength="15" value="<%= inqLoans.getE01DEAINT().trim()%>" >
            </td>
          ...
          <tr id="trclear"> 
            ...
            <td nowrap  bordercolor="#000000"> 
              <input type="text" name="E01TOTDUE" size="15" maxlength="15" value="<%= inqLoans.getE01TOTDUE().trim()%>" >
            </td>
            <td nowrap  bordercolor="#000000">&nbsp;</td>
            <td nowrap  bordercolor="#000000">&nbsp;</td>
          </tr>
