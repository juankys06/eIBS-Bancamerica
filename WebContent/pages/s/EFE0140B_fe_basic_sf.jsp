...
%>
<h3 align="center"> Spot - Moneda Extranjera <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="fe_basic_sf.jsp,EFE0140B"> 
</h3>
<hr size="4">
        ...
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap > 
              ...
              <a href="javascript:GetCode('E01WKFBPV','STATIC_fe_bo_pay.jsp')">
              <img src="<%=request.getContextPath()%>/images/1b.gif" alt="help" align="middle" border="0" ></a> 
            </td>
            <td nowrap width="17%" >&nbsp;Forma de Recepcion :</td>
            <td nowrap > 
              <input type="text" name="E01WKFBPV" size="3" maxlength="1" value="<%= fex.getE01WKFARB()%>">
              <a href="javascript:GetCode('E01WKFARB','STATIC_fe_bo_rec.jsp')">
              <img src="<%=request.getContextPath()%>/images/1b.gif" alt="help" align="middle" border="0" ></a> 
            </td>
          </tr>
          <tr id="trdark"> 
