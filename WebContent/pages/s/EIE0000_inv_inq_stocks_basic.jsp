...
%>
<div align="center">
  <h3> Consulta de Comisiones de Acciones y Fondos Mutuales <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="inv_stocks_basic.jsp,EIE0000"> 
  </h3>
</div>
<hr size="4">
    ...
    <tr > 
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="66%" > 
              ...
              <%= invComm.getE01COMTYP()%> - <% if(invComm.getE01COMTYP().equals("BND")) out.print("BONOS");
							...
							else if(invComm.getE01COMTYP().equals("PFS")) out.print("ACCIONES PREFERENCIALES");
          ...
          <tr id="trclear"> 
            <td nowrap width="34%" > 
              <div align="right">Moneda de Comision :</div>
            </td>
