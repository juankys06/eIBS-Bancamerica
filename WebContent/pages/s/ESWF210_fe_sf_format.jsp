...
%>
<h3 align="center">MT 210 - Notificaci&oacute;n de Recibo<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="fe_sf_format.jsp, ESF210"> 
</h3>
<hr size="4">
