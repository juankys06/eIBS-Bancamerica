...
<h3 align="center">Confirmaci&oacute;n - Certificado de Dep&oacute;sito - Back 
  Office</h3>
<hr size="4">
      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="25%" > 
              <div align="left"><% if(deal.getE11DLSSBT().equals("SL")) out.print("Pasiva");
						else out.print("Activa");%></div>
            </td>
            <td nowrap width="20%" > 
              <div align="right"> </div>
            </td>
