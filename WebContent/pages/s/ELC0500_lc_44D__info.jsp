...
%> 
<h3 align="center">Shipment Period (44D)<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="lc_44D_info.jsp, ELC0500"></h3>
<hr size="4">


 <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/servlet/datapro.products.client.JSELC0500" >
