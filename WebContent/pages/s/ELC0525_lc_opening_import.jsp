...
<SCRIPT LANGUAGE="javascript">
 ...
 function goMsgSwift() {
   ...
   page = webapp + "/servlet/datapro.eibs.approval.JSEPR1080A?SCREEN=8&TRANSREFNUM="+document.forms[0].E01LCMACC.value;
...
<IMG
	...
	name="EIBS_GIF" alt="ELC0525_lc_opening_import.jsp"></H3>
<HR size="4">
<FORM>
<TABLE cellspacing="0" cellpadding="2" width="100%" border="0" class="tableinfo" id="trclear">
	<TR id="trdark">
		...
		<TD width="25%" align="right" nowrap="nowrap"><B>Número de Carta de Credito</B></TD>
