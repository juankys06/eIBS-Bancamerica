...
<h3 align="center">Consulta de Tarifas de Cobranzas<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="coll_inq_fee_tab,EDC0100"></h3>
<hr size="4">
