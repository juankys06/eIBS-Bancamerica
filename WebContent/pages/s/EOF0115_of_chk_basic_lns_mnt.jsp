...
<H3 align="center">Modificación de Emisi&oacute;n Cheques de Gerencia por Desembolso de Préstamos<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="of_chk_basic_lns_mnt.jsp, EOF0115"> 
</H3>
<hr size="4">
