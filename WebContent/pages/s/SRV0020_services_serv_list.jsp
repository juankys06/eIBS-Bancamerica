...
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="services_serv_list.jsp,SRV0020">
</h3>
<hr size="4">
    ...
    <TD NOWRAP valign=top>
     ...
     %>               
        <TR>
			...
			<TD NOWRAP ALIGN="CENTER"><%=Util.formatDate(msgMT.getE01SERUD1(),msgMT.getE01SERUD2(),msgMT.getE01SERUD3())  + " - " + Util.formatTime(msgMT.getE01SERUPT())%></TD>
