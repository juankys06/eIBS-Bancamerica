<html>
<head>
<title>Charges Claimed (73)</title>
...
%> 
<h3 align="center">Charges Claimed (73)<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="lc_73_info.jsp, ELC0500"></h3>
<hr size="4">
 ...
 <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/servlet/datapro.eibs.products.JSELC0500" >
  ...
  <INPUT TYPE=HIDDEN NAME="E03LCDFCD" VALUE="73">
