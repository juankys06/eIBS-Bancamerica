        ...
        <table cellspacing=0 cellpadding=2 width="100%" border="0">
            ...
            <td nowrap > 
              <input type="text" readonly name="E02DEAWHF" size="35" maxlength="35" 
				value="<% if (inqBasic.getE02DEAWHF().equals("1")) out.print("Retención sobre Intereses ISR");
							...
							else if (inqBasic.getE02DEAWHF().equals("G")) out.print("FECI e ITBMS(Panamá)");
							else out.print("");%>" >
            </td>
            <td nowrap > 
            ...
            <td nowrap >
              <input type="text" readonly name="E02DEADLC" size="35" maxlength="15" 
				value="<% if (inqBasic.getE02DEADLC().equals("1")) out.print("Vigente");
							else if (inqBasic.getE02DEADLC().equals("2")) out.print("Moroso");
							else if (inqBasic.getE02DEADLC().equals("3")) out.print("Vencido");
							else if (inqBasic.getE02DEADLC().equals("4")) out.print("Castigado");
							else out.print("");%>" >
            </td>
          </tr>
          <tr id="trdark">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap >
			   ...
			   <INPUT type="text" readonly name="E02DEAREA" size="12" maxlength="12" value="<%= inqBasic.getE02DEAREA().trim()%>">
			</td>
            <td nowrap >
          ...
          <tr id="trclear"> 
            ...
            <td nowrap >
              ...
              <input type="text" readonly name="D02DEACUI" size="40" maxlength="35" value="<%= inqBasic.getD02DEACUI().trim()%>">
            </td>
            <td nowrap >
            <div align="right">Fecha Reestruc/Refinanc :</div>
            </td>
            <td nowrap >
            <input type="text" name="E02DEAEX1" size="2" maxlength="2" value="<%= inqBasic.getE02DEAEX1().trim()%>" onchange="setRecalculate()"   >
              <input type="text" name="E02DEAEX2" size="2" maxlength="2" value="<%= inqBasic.getE02DEAEX2().trim()%>" onchange="setRecalculate()"   >
              <input type="text" name="E02DEAEX3" size="2" maxlength="2" value="<%= inqBasic.getE02DEAEX3().trim()%>" onchange="setRecalculate()"   >
            </td>
          </tr>
