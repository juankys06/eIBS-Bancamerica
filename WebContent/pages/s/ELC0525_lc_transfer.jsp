...
<h3 align="center">Transferencia de Carta De Credito <img
	...
	name="EIBS_GIF" alt="lc_transfer.jsp, ELC0525"></h3>
<hr size="4">
    ...
    <tr>
      <td><table cellspacing="0" cellpadding="2" width="100%" border="0">
          <tr id="trdark">
			...
			value='<%=(msg051005.getE05LCMID1().trim().equals("0") ? "" : msg051005.getE05LCMID1().trim())%>' onKeyPress="enterInteger()">
              <input type="text" name="E05LCMID22" size="2" maxlength="2" readonly
			value='<%=(msg051005.getE05LCMID2().trim().equals("0") ? "" : msg051005.getE05LCMID2().trim())%>' onKeyPress="enterInteger()">
              <input type="text" name="E05LCMID32" size="2" maxlength="2" readonly
			value='<%if (msg051005.getE05LCMID3().length() < 2 && !msg051005.getE05LCMID3().equals("0"))
	out.print("0");
out.print(
	(msg051005.getE05LCMID3().trim().equals("0")
		? ""
		: msg051005.getE05LCMID3().trim()));%>'
			...
			value='<%=(msg051005.getE05LCMEX1().trim().equals("0") ? "" : msg051005.getE05LCMEX1().trim())%>' onKeyPress="enterInteger()">
              <input type="text" name="E05LCMEX22" size="2" maxlength="2"
			value='<%=(msg051005.getE05LCMEX2().trim().equals("0") ? "" : msg051005.getE05LCMEX2().trim())%>' onKeyPress="enterInteger()">
              <input type="text" name="E05LCMEX32"
			size="2" maxlength="2"
			value='<%if (msg051005.getE05LCMEX3().length() < 2 && !msg051005.getE05LCMEX3().equals("0"))
	out.print("0");
out.print(
	(msg051005.getE05LCMEX3().trim().equals("0")
		? ""
		: msg051005.getE05LCMEX3().trim()));%>'
			onKeyPress="enterInteger()">
              <a
