...
<H3 align="center">Tablas de Comisiones y Gastos de Cartas de Credito<IMG src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="sc_cust_list.jsp, ELC0600"></H3>
<HR size="4">
...
%>
  ...
  <TABLE class="tbenter">
    <TR>
      ...
      <TD ALIGN=CENTER class="TDBKG" width="25%">
  		<A href="javascript:goMaint()">Mantenmiento</A>
      </TD>   
