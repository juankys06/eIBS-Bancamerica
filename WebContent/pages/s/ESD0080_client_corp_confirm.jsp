...
<SCRIPT LANGUAGE="javascript">
 function finish(){
	if (document.getElementById("E02SFR").value == 'A') {
...
<body>
  ...
  <h3 align="center">Confirmación  <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="client_corp_confirm, ESD0080" ></h3>
  <hr size="4">
