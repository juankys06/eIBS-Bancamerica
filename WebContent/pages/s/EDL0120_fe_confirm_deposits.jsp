...
String sTitle = "Dep&oacute;sitos a Plazo Fijo";
try {
   sTitle = trOption.getHeader2();
} catch (Exception e) {
   sTitle = "Dep&oacute;sitos a Plazo Fijo";
}   
if (sTitle == null) sTitle = "Dep&oacute;sitos a Plazo Fijo";

%> 
<h3 align="center"> Orden de Confirmaci&oacute;n - <%= sTitle%> 
</h3>
<hr size="4">
      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap align="right" width="32%">Tasa :</td>
          ...
          <tr id="trclear"> 
            ...
            <td nowrap ><%= Util.formatDate(deal.getE01DLSVD1(),deal.getE01DLSVD2(),deal.getE01DLSVD3())%></td>
            <td nowrap > 
              <div align="right">Fecha de Vencimiento :</div>
            </td>
            <td nowrap colspan="2" ><%= Util.formatDate(deal.getE01DLSMA1(),deal.getE01DLSMA2(),deal.getE01DLSMA3())%></td>
          </tr>
          <tr id="trclear"> 
            <td nowrap width="35%" > 
