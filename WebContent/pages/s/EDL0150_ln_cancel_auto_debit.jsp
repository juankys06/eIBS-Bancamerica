      ...
      <td> 
        <table cellspacing=0 cellpadding=2 width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td width="61%">
              <input type="text" name="E10DLASDM" size="2" maxlength="2" value="<%= lnAutoDebit.getE10DLASDM().trim()%>" onkeypress="enterInteger()">
              <input type="text" name="E10DLASDD" size="2" maxlength="2" value="<%= lnAutoDebit.getE10DLASDD().trim()%>" onkeypress="enterInteger()">
              <input type="text" name="E10DLASDY" size="2" maxlength="2" value="<%= lnAutoDebit.getE10DLASDY().trim()%>" onkeypress="enterInteger()">
            </td>
          </tr>
          <tr id="trclear"> 
            <td width="39%" > 
            ...
            <td width="61%">
              <input type="text" name="E10DLAMAM" size="2" maxlength="2" value="<%= lnAutoDebit.getE10DLAMAM().trim()%>" onkeypress="enterInteger()">
              <input type="text" name="E10DLAMAD" size="2" maxlength="2" value="<%= lnAutoDebit.getE10DLAMAD().trim()%>" onkeypress="enterInteger()">
              <input type="text" name="E10DLAMAY" size="2" maxlength="2" value="<%= lnAutoDebit.getE10DLAMAY().trim()%>" onkeypress="enterInteger()">
            </td>
          </tr>
          <tr id="trdark"> 
            <td width="39%" > 
