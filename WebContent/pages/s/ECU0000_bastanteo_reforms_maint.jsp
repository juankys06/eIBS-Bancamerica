...
<H3 align="center">Sistema de Bastanteo - Mantenimiento de Reformas Documento Constitutivo<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="bastanteo_reforms_maint,ECU0000"></H3>
<hr size="4">
    ...
    <TABLE cellspacing=0 cellpadding=2 width="100%" border="0">    
			...
			<TR> 
		  		<TD nowrap width="40%"> 
      	  		...
      	  		<TD nowrap width="60%"> 
      	   			<INPUT type="text" name="E04CURRD1" readonly size="2" maxlength="2" value="<%= msgMTRef.getE04CURRD1() %>">
	      			<INPUT type="text" name="E04CURRD2" readonly size="2" maxlength="2" value="<%= msgMTRef.getE04CURRD2() %>">
	      			<INPUT type="text" name="E04CURRD3" readonly size="2" maxlength="2" value="<%= msgMTRef.getE04CURRD3() %>">
	     		 </TD>     
      		</TD>
 		</TABLE>
 	  </td>
    	...
    	<tr id=trdark> 
     	...
     	<tr id=trclear> 
		  <td> 
      	  ...
      	  <td nowrap> 
      	    <input type="text" name="E04CURRE1" size="2" maxlength="2" value="<%= msgMTRef.getE04CURRE1() %>">
	      	<input type="text" name="E04CURRE2" size="2" maxlength="2" value="<%= msgMTRef.getE04CURRE2() %>">
	      	<input type="text" name="E04CURRE3" size="2" maxlength="2" value="<%= msgMTRef.getE04CURRE3() %>">
  ...
  <table class="tableinfo">
      <tr > 
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0" align="left">
          <tr id="trdark"> 
            <td nowrap width="100%"> 
              <input type="text" name="E04CUROB1" size="90" maxlength="80" value="<%= msgMTRef.getE04CUROB1().trim()%>">
            </td>
          </tr>
          <tr id="teclear"> 
            <td nowrap width="100%"> 
              <input type="text" name="E04CUROB2" size="90" maxlength="80" value="<%= msgMTRef.getE04CUROB2().trim()%>">
            </td>
          </tr>
          <tr id="trdark"> 
            <td nowrap width="100%"> 
              <input type="text" name="E04CUROB3" size="90" maxlength="80" value="<%= msgMTRef.getE04CUROB3().trim()%>">
            </td>
          </tr>
          <tr id="teclear"> 
            <td nowrap width="100%"> 
              <input type="text" name="E04CUROB4" size="90" maxlength="80" value="<%= msgMTRef.getE04CUROB4().trim()%>">
            </td>
          </tr>
          <tr id="trdark"> 
            <td nowrap width="100%"> 
              <input type="text" name="E04CUROB5" size="90" maxlength="80" value="<%= msgMTRef.getE04CUROB5().trim()%>">
            </td>
          </tr>
        </table>
      </tr>
