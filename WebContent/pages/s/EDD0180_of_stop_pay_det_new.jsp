...
<jsp:useBean id= "ofStop" class= "datapro.eibs.beans.EDD018001Message"  scope="session" />
...
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.products.JSEDD0180" >
  ...
  <input type=HIDDEN name="E01STPBRN" value="<%= userPO.getBranch().trim()%>">
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="54%"> 
              <div align="left"> 
                <input type="text" name="E01STPFCK" size="10" maxlength="9" value="<%= ofStop.getE01STPFCK().trim()%>" onKeypress="enterInteger()">
              </div>
            </td>
          </tr>
          <tr id="trclear"> 
            ...
            <td nowrap width="54%"> 
              <div align="left"> 
                <input type="text" name="E01STPCK1" size="3" maxlength="2" value="<%= ofStop.getE01STPCK1().trim()%>">
                <input type="text" name="E01STPCK2" size="3" maxlength="2" value="<%= ofStop.getE01STPCK2().trim()%>">
                <input type="text" name="E01STPCK3" size="3" maxlength="2" value="<%= ofStop.getE01STPCK3().trim()%>">
              </div>
            </td>
          </tr>
          <tr id="trdark"> 
            ...
            <td nowrap width="54%"> 
              <div align="left"> 
                <input type="text" name="E01STPAMT" size="15" maxlength="15" value="<%= ofStop.getE01STPAMT().trim()%>" onKeypress="enterDecimal()">
              </div>
            </td>
          </tr>
          <tr id="trclear"> 
            ...
            <td nowrap width="54%"> 
              <input type="text" name="E01STPRMK" size="35" maxlength="30" value="<%= ofStop.getE01STPRMK().trim()%>">
            </td>
          </tr>
          <tr id="trdark"> 
            <td nowrap width="46%"> 
            ...
            <td nowrap width="54%">
              <input type="radio" name="E01STPFLG" value="Y" <%if(!ofStop.getE01STPFLG().equals("N")) out.print("checked");%>>
              S&iacute; 
              <input type="radio" name="E01STPFLG" value="N" <%if(ofStop.getE01STPFLG().equals("N")) out.print("checked");%>>
              No 
			</td>
          </tr>
          <tr id="trclear"> 
            ...
            <td nowrap width="54%" > 
              <input type="text" name="E01STPF02" size="5" maxlength="4" value="<%= ofStop.getE01STPF02().trim()%>">
              ...
              <input type="text" name="D01DSCCAU" size="35" maxlength="35" value="<%=ofStop.getD01DSCCAU().trim()%>" readonly>
            </td>
          </tr>
        </table>
      </td>
