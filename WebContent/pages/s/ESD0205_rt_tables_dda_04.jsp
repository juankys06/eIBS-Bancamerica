...
<h3 align="center">Cuentas de Ahorro<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="ESD0205_rt_tables_dda_04, ESD0205" ></h3>
<hr size="4">
      ...
      <tr > 
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0" align="left" >
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="31%" > 
              <div align="left"> 
                <input type="text" name="E02RTEC02" size="5" maxlength="5" value="<%= charges.getE02RTEC02()%>">
              </div>
            </td>
          </tr>
          <tr id="trdark"> 
