...
<body>
<h3 align="center">Aprobación de Cobranza Simple<br>Comisiones y Cargos<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="sing_commissions.jsp, EDC0040"></h3>
<hr size="4">
