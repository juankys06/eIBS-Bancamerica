...
<SCRIPT Language="Javascript">
    builtNewMenu(noclient_opt);
	initMenu();

	function getIF01Forms(url) {
		var newurl = url+"&IDNUM="+document.forms[0].E01LN3.value;
...
<h3 align="center">Informacion No-Clientes<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left"
	name="EIBS_GIF" ALT="noclientes_maint, ESD0087"></h3>
<hr size="4">
...
<table class="tableinfo" cellspacing="0" cellpadding="2" width="100%"border="0">
	 <tr id="trclear">
	   ...
	   <td nowrap width="20%">
		 <input type="text" name="E01LN3" size="16"  readonly maxlength="15" value="<%=client.getE01LN3().trim()%>">
	   </td>
	   <td nowrap width="25%">
		   <div align="right">Tipo Cliente :</div>
		</td>
		<td nowrap width="20%">
		      <input type="hidden" name="E01LGT" value="<%= client.getField("E01LGT").getString().trim()%>">
              <input type="text" readonly  name="D01LGT" size="25" maxlength="30" 
				  value="<% if (client.getE01LGT().equals("1")) out.print("Jur&iacute;dico");
							else if (client.getE01LGT().equals("2")) out.print("F&iacute;sico");
							else if (client.getE01LGT().equals("3")) out.print("Otros");
						    else out.print("");%>" 
				>
            </td>
	</tr>
    ...
    <tr id="trclear">      
		...
		<td nowrap width="20%">
		  <input type="text" readonly name="E01PID" size="5" maxlength="4" value="<%=client.getE01PID().trim()%>">   
