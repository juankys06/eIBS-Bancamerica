...
<body>
<h3 align="center">Nuevo Embossing de Plastico<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="plastic_embossing_new.jsp, ECD0001"> 
</h3>
<hr size="4">
<% 
