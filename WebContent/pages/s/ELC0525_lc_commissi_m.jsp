...
<BODY>
<H3 align="center">Comisiones de Cartas de Credito<IMG src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="lc_commissi_m.jsp, ELC0525"></H3>
<HR size="4">
		...
		<TABLE cellspacing="0" cellpadding="2" width="100%" border="0"
			...
			<TR id="trclear">
				...
				<DIV align="left"><INPUT type="text" name="E04LCMBNK0" readonly
					...
					"<%=msg051004.getE04LCMID1() + "/" + msg051004.getE04LCMID2() +
					"/"+(msg051004.getE04LCMID3().length() == 1 ? "0"+msg051004.getE04LCMID3() : msg051004.getE04LCMID3())%>"></DIV></TD>
				<TD nowrap width="16%">
			...
			<TR id="trclear">
				...
				<DIV align="left"><INPUT type="text" name="E04LCMBNK0" readonly
					size="10" maxlength="10" value=
					"<%=msg051004.getE04LCMEX1()+"/"+msg051004.getE04LCMEX2()+"/"
					+(msg051004.getE04LCMEX3().length() == 1 ? "0"+msg051004.getE04LCMEX3() : msg051004.getE04LCMEX3())%>"></DIV></TD>
				<TD nowrap width="16%">
						...
						<TR id="<%=( i%2==0 ? "trclear" : "trdark" )%>">
							...
							<TD nowrap width="10%">
								<SELECT name="<%=field2.get(i)%>" disabled <%if( i >= name.size()-2) out.print("disabled");%> >
									...
									<%if(i < name.size()-2)
									{%>
										<OPTION value="B" <%=( msg051004.getField((String) field2.get(i)).getString().trim().equals("B") ? "selected" : "" )%>>
											Beneficiario
										</OPTION>
									<%}
									else{%>
