...
%>
<H3 align="center">Período para Presentación (48)<IMG src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="lc_48_info.jsp, ELC0510"></H3>
<HR size="4">
...
<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/servlet/datapro.eibs.products.JSELC0510" >
  ...
  <INPUT TYPE=HIDDEN NAME="E03LCDFCD" VALUE="48">
  ...
  <p align="center"><A href="javascript:getClausula('48','11','<%=request.getContextPath()%>/servlet/datapro.eibs.products.JSELC0510')"><b>Copiar Clausula 
