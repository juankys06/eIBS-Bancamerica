...
<html>
<head>
<title>Mantenimiento Parametrizacion Rango de Tasas en Moneda Extranjera</title>
...
<h3 align="center">Mantenimiento Parametrizacion Rango de Tasas en Moneda Extranjera
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="EFE5001_Mant_ParamRT.jsp,JSEFE0501"></h3> 
...
<INPUT TYPE=HIDDEN NAME="E01FEICOV" value="<%=gaMant.getE01FEICOV().trim() %>">
      ...
      <td nowrap> 
        <table cellspacing=0 cellpadding=2 width="100%" border="0">          
            ...
            <td nowrap ><INPUT type="text" name="E01FEICCY" readonly size="3" maxlength="3" value="<%=gaMant.getE01FEICCY().trim() %>" >      
          	  <INPUT type="text" name="E01FEICCD" readonly size="25" maxlength="25" value="<%=gaMant.getE01FEICCD().trim() %>" >      
            </td>
             <td nowrap>  
            ...
            <tr id="trclear"> 
	            ...
	            <td nowrap> 	             
	             ...
	             <td nowrap> 
	              <INPUT type="text" name="E01FEIBR1" onkeypress="enterInteger()" size="3" maxlength="3" value="<%=  gaMant.getE01FEIBR1()%>">   
	            <INPUT type="text" name="E01FEIBR1" onkeypress="enterInteger()" size="20" maxlength="20" value="<%=  gaMant.getE01FEIBRD()%>"> 
	            </td>	           
          </tr>
            <tr id="trdark"> 
	            <td nowrap> 
	            ...
	            <td nowrap ><INPUT type="text" name="E01FEIALT" onkeypress="enterDecimal()" size="8" maxlength="9" value="<%=  gaMant.getE01FEIALT()%>">    
            ...
            <tr id="trclear"> 
	            ...
	            <td nowrap ><INPUT type="text" name="E01FEIBAJ" onkeypress="enterDecimal()" size="8" maxlength="9" value="<%=  gaMant.getE01FEIBAJ()%>">      
	            			<img src="<%=request.getContextPath()%>/images/Check.gif" alt="campo obligatorio" align="bottom" border="0" width="16" height="20"  >        
	            </td> <td nowrap> 
 ...
 <p align=center>
  	<input class="EIBSBTN" id="EIBSBTN" type="button" onclick="javascript:enter(5)" value="Modificar"> 	
