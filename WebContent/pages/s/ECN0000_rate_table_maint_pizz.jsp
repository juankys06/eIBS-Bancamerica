...
<h3 align="center">Tasas de Pizarra<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="rate_table_maint_pizz.jsp,ECN0000"></h3>
<hr size="4">
	    	 ...
	    	 <TABLE>	  
	  			...
	  			<tr>
			        ...
			        <td colspan=3>
			            ...
			            <input type="text" name="E03CDRFTY" size="2" maxlength="2" value="<%= tbRate.getE03CDRFTY()%>" <%if (userPO.getPurpose().equals("READONLY")) {%>readonly<%}%>>
				  	</td>      
	  			</tr>
	  	     </TABLE>
	    </td>
       ...
       %>             
        ...
        <TR>
          ...
          <td NOWRAP align=center>
          	<input type="input" name="E03CL<%=name1%>" size="10" maxlength="10" value="<%= tbRate.getField("E03CL"+name1).getString().trim()%>" <%if (userPO.getPurpose().equals("READONLY")) {%>readonly<%}else{%>onkeypress="enterDecimal()"<%}%>>      	
		  </td>		  
		  <%}%>
		</TR>
        <%}%> 
