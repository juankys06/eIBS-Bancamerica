...
<h3 align="center">Mantenimiento de Ordenes de Pago<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="pr_enter_maint.jsp,EDD0670"></h3>
<hr size="4">
    ...
    <tr id="trclear"> 
      ...
      <td nowrap align="center" width="60%"> 
        <div align="left"> 
          ...
          <a href="javascript:GetAccount('E01ACCNUM','','','')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="help" align="absbottom" border="0" ></a></div>
      </td>
    </tr>
    <tr id="trdark"> 
      <td nowrap align="center" width="40%"> 
