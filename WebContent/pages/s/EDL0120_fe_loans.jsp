...
function Calculate(){
  ...
  document.forms[0].action = "<%=request.getContextPath()%>/servlet/datapro.eibs.forex.JSEDL0120?SCREEN=4600";
...
%> 
<h3 align="center"> Pr&eacute;stamos<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="fe_loans.jsp, EDL0120"> 
</h3>
<hr size="4">
        ...
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <% if(deal.getH01FLGWK3().equals("Y")){%>
            ...
            <td nowrap> 
              ...
              <a href="javascript:GetProduct('E01DLSPRO','10','')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="help" align="middle" border="0" ></a> 
