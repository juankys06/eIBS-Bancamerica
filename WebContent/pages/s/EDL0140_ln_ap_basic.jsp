...
<SCRIPT Language="Javascript">
  ...
  function getDeduct(acc,cod){
   ...
   page = webapp + "/servlet/datapro.eibs.products.JSEDL0370?SCREEN=10&ACCNUM=" + acc + "&COD=" + cod + "&ROW="+ row;
   CenterWindow(page,600,500,2);
  }
        ...
        <TABLE cellpadding="2" cellspacing="0" width="100%" border="0">
          ...
          <TR id="trdark"> 
            ...
            <TD nowrap> 
              ...
              <input type="text" name="E01DEAMIR" readonly size="12" maxlength="10" value="<%= apBasic.getE01DEAMIR().trim()%>">
            </TD>
          </TR>
          <TR id="trclear"> 
            <TD nowrap width="25%"> 
            ...
            <TD nowrap width="27%"> 
              ...
              <input type="text" name="E01DEAMXR"  readonly size="12" maxlength="10" value="<%= apBasic.getE01DEAMXR().trim()%>">
            </TD>
          </TR>
          <TR id="trdark"> 
            <TD nowrap width="25%"> 
          ...
          <TR id="trclear"> 
            ...
            <TD nowrap width="23%"> 
              ...
              <INPUT type="radio" name="CE01DEALNC" value="Y" onclick="document.forms[0].E01DEALNC.value='Y'" <%if(apBasic.getE01DEALNC().equals("Y")) out.print("checked");%> disabled>
              S&iacute; 
              <INPUT type="radio" name="CE01DEALNC" value="N" onclick="document.forms[0].E01DEALNC.value='N'" <%if(apBasic.getE01DEALNC().equals("N")) out.print("checked");%> disabled>
              No </TD>
            <TD nowrap width="25%"> 
          ...
          <TR id="trclear">         		          
            ...
            <TD nowrap width="23%"> 
              <INPUT type="text" readonly name="E01DLEPRO" size="5" maxlength="4" value="<%= apBasic.getE01DLEPRO().trim()%>">
          ...
          <TR id="trdark"> 
            ...
            <TD nowrap width="23%"> 
              <input type="text" readonly name="E01DEACUI" size="8" maxlength="6" value="<%= apBasic.getE01DEACUI().trim()%>">
              <input type="text" readonly name="D01DEACUI" size="40" maxlength="35" value="<%= apBasic.getD01DEACUI().trim()%>">
            </TD>
            <TD nowrap width="25%"> 
            </TD>
            <TD nowrap width="27%"> 
...
<table class="tableinfo">
	...
	while (ded.getNextRow()) { 
		...
		if (ded.getFlag().equals("") && (!(ded.getRecord(1).equals("FECI"))) && (mostrar)){%>
			<tr id="trclear">
				<td nowrap width="20%">
...
<%}%>
      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <tr id="trclear"> 
			...
			<td nowrap width="28%" > 
              <div align="center"> 
                <input type="text" readonly name="E01PAGNA1" size="25" maxlength="25" value="<%= apBasic.getE01PAGNA1().trim()%>">
              </div>
            </td>
  ...
  <h4><%if (apBasic.getE01FLGIBF().equals("R")) {  %> Préstamo Preferencial - Información Adicional</h4>
  <table class="tableinfo">
    <tr > 
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td nowrap width="23%"> 
              <input type="text" readonly name="E01FIXMOD" size="17" maxlength="15" value="<%= apBasic.getE01FIXMOD().trim()%>">
            </td>
            <td nowrap width="25%"> 
              <div align="right">Registro Forestal :</div>
            </td>
            <td nowrap width="27%">
              <input type="text" readonly name="E01FIXRMK" size="27" maxlength="25" value="<%= apBasic.getE01FIXRMK().trim()%>">
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap width="25%"> 
            ...
            <td nowrap width="23%"> 
              <input type="text" readonly name="E01FIXMTH" size="4" maxlength="2" value="<%= apBasic.getE01FIXMTH().trim()%>">
            </td>
            <td nowrap width="25%"> 
              <div align="right">Corregimiento :</div>
            </td>
            <td nowrap width="27%">
              <input type="text" readonly name="E01FIXCLS" size="5" maxlength="4" value="<%= apBasic.getE01FIXCLS().trim()%>">
            </td>
          </tr>
          <tr id="trdark"> 
            <td nowrap width="25%"> 
            ...
            <td nowrap width="23%">
              <input type="text" readonly name="E01DEAPS1" size="2" maxlength="2" value="<%= apBasic.getE01DEAPS1().trim()%>">
              <input type="text" readonly name="E01DEAPS2" size="2" maxlength="2" value="<%= apBasic.getE01DEAPS2().trim()%>">
              <input type="text" readonly name="E01DEAPS3" size="2" maxlength="2" value="<%= apBasic.getE01DEAPS3().trim()%>">
            ...
            <td nowrap width="27%"> 
              <input type="text" readonly name="E01FIXPPR" size="17" maxlength="15" value="<%= apBasic.getE01FIXPPR().trim()%>">
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap width="25%"> 
            ...
            <td nowrap width="23%">
              <input type="text" readonly name="E01FIXPIN" size="2" maxlength="2" value="<%= apBasic.getE01FIXPIN().trim()%>">
              <input type="text" readonly name="E01FIXCCN" size="2" maxlength="2" value="<%= apBasic.getE01FIXCCN().trim()%>">
              <input type="text" readonly name="E01FIXASN" size="2" maxlength="2" value="<%= apBasic.getE01FIXASN().trim()%>">
            </td>
            <td nowrap width="25%"> 
              <div align="right">Valor Mejoras :</div>
            </td>
            <td nowrap width="27%"> 
              <input type="text" readonly name="E01DLAIMP" size="17" maxlength="15" value="<%= apBasic.getE01DLAIMP().trim()%>">
            </td>
          </tr>
          <tr id="trdark"> 
            <td nowrap width="25%"> 
            ...
            <td nowrap width="27%"> 
              <input type="text" readonly name="E01FIXRVA" size="17" maxlength="15" value="<%= apBasic.getE01FIXRVA().trim()%>">
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap width="25%"> 
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="23%">
              <input type="text" readonly name="E01FIXMAR" size="22" maxlength="20" value="<%= apBasic.getE01FIXMAR().trim()%>">
            </td>
            <td nowrap width="25%"> 
              <div align="right">Número Préstamo Anterior :</div>
            </td>
            <td nowrap width="27%"> 
              <input type="text" readonly name="E01FIXSER" size="17" maxlength="15" value="<%= apBasic.getE01FIXSER().trim()%>">
            </td>
          </tr>
    ...
    <tr > 
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <%if (apBasic.getE01DEACLF().toUpperCase().equals("P")){%>
          <tr id="trdark"> 
            <td nowrap> 
              <div align="right"><b>Subsidio :</b></div>
            </td>
            <td nowrap colspan="2"> 
              <input type="text" id="txtright" name="E01DEAMPA" size="15" maxlength="15" value="<%= apBasic.getE01DEAMPA().trim()%>" onKeypress="enterDecimal()" readonly>
            </td>
          </tr>
          <%}%>
              ...
              &nbsp;&nbsp;
		        ...
		        <td nowrap colspan="1"> 
		              ...
		              <SELECT name="E01DEBCHF" onchange="setRecalculate()" disabled  >
                           <option value="1" <% if(apBasic.getE01DEBCHF().equals("1")) out.print("selected");%>>Cargo a Desembolso</option>
		                <option value="2" <% if(apBasic.getE01DEBCHF().equals("2")) out.print("selected");%>>Débito a Cuenta</option>
		                <option value="3" <% if(apBasic.getE01DEBCHF().equals("3")) out.print("selected");%>>Capitalizar</option>
		              </SELECT>
					<BR/>
					  <div id="DEBCHA" >
 			              Cuenta Numero :
			              <INPUT name="E01DEBCHA" size="13" maxlength="12" readonly value="<%= apBasic.getE01DEBCHA().trim()%>" >
					</div>
				</td>			
		     	<%
		          }
		  ...
		  <tr id="trdark">
            ...
            <td nowrap> 
              <input type="text" id="txtright" style="color:red;" readonly name="E01SUBTOT" size="15" maxlength="15" value="<%= apBasic.getE01SUBTOT().trim()%>">
            </td>
            <td nowrap>&nbsp; </td>		  
		  </tr>    	  
		  ...
		  <tr id="trdark">
            ...
            <td nowrap> 
              <input type="text" id="txtright" style="color:red;" readonly name="E01DEDFIN" size="15" maxlength="15" value="<%= apBasic.getE01DEDFIN().trim()%>">
            </td>
            <td nowrap>&nbsp; </td>		  
		  </tr>    	  
          ...
          <tr id="trdark"> 
            ...
            <td nowrap>    
             <div align="center">         	
              	<% out.println(
              		Util.formatCCY(apBasic.getBigDecimalE01BALNET().add(apBasic.getBigDecimalE01DEDFIN()).toString()));%> 
			</div>
            </td>
            <td nowrap>&nbsp; </td>
          </tr>
