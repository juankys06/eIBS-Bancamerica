...
<H3 align="center">Linea de Cr&eacute;dito y L&iacute;mite de Cr&eacute;dito<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="rt_credit.jsp, EDD0000"></H3>
<hr size="4">
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td nowrap width="60%"> 
              ...
              <a href="javascript:GetCustomer('E04ACMCMC')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Ayuda" align="absbottom" border="0" ></a> 
            </td>
          </tr>
          <tr id="trclear">
            <td nowrap width="40%">
            ...
            <td nowrap width="60%">
              ...
              <a href="javascript:GetCreditLine('E04ACMCMN',document.forms[0].E04ACMCMC.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Ayuda" align="absbottom" border="0" ></a></td>
          </tr>
          <tr id="trdark"> 
            <td nowrap width="40%"> 
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="60%" height="23"> 
              <input type="text" maxlength="2" size="2" name="E04ACMRV1" value="<%= rtCredit.getE04ACMRV1().trim()%>">
              <input type="text" maxlength="2" size="2" name="E04ACMRV2" value="<%= rtCredit.getE04ACMRV2().trim()%>">
              <input type="text" maxlength="2" size="2" name="E04ACMRV3" value="<%= rtCredit.getE04ACMRV3().trim()%>">
            </td>
          </tr>
        </table>
      </td>
