...
parent.results.window.location.href="<%=request.getContextPath()%>/pages/s/MISC_search_wait.jsp?URL='<%=request.getContextPath()%>/servlet/datapro.eibs.helps.JSEWD0092?shrAcc=" + shrAcc + "@shrCategory=" + shrCat + "@FromRecord=0" + "@shrAction=<%= request.getParameter("shrAction")%>"+"'";
}
</script>
<FORM>
<%
