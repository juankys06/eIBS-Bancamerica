        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          <tr id="trdark">
            ...
            <td nowrap width="25%">
              ...
              <a href="javascript:GetLedger('E01FEGPGL',document.forms[0].E01FEGBNK.value,document.forms[0].E01FEGCCY.value,'51')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Ayuda" border="0" ></a>
            </td>
            <td nowrap width="50%">
          ...
          <tr id="trdark">
            ...
            <td nowrap width="25%">
              ...
              <a href="javascript:GetLedger('E01FEGSGL',document.forms[0].E01FEGBNK.value,document.forms[0].E01FEGCCY.value,'51')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Ayuda" border="0" ></a>
            </td>
            <td nowrap width="50%">
          ...
          <tr id="trdark">
            ...
            <td nowrap width="25%">
              <input type="text" name="E01FEGX01" size="17" maxlength="18" value="<%= msgBasic.getE01FEGX01().trim()%>" onkeypress="enterInteger()">
