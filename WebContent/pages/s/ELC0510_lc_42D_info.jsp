...
%> 
<h3 align="center">Banco Girado (42D)<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF"></h3>
<hr size="4">
...
<INPUT TYPE=HIDDEN NAME="E03LCDFCD" VALUE="42D">
...
<table class="tableinfo">
	<tr>
		<td nowrap align="center"><input type="text" name="E03LCDM01" size="45" maxlength="35" value="<%=lcAdd.getE03LCDM01().trim()%>"><br>
