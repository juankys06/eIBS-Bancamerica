...
%>
<div align="center">
  <h3>Tabla de Comisiones para Bonos<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="inv_bonds_basic.jsp,EIE0000"> 
  </h3>
</div>
<hr size="4">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="66%" > 
              ...
              <%= invComm.getE01COMTYP()%> - <% if(invComm.getE01COMTYP().equals("BND")) out.print("Bonos");
							...
							else if(invComm.getE01COMTYP().equals("CST")) out.print("Custodio");
      ...
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td nowrap >Frec.</td>
            <td nowrap > 
              <div align="center">M&iacute;nimo </div>
            </td>
            <td nowrap > 
              <div align="center">M&aacute;ximo </div>
            </td>
            <td nowrap > 
