...
<body>
 ...
 <h3 align="center">Cambio de Contraseña - Banca por Internet<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="client_change_password_data, ESS2000"></h3>
<hr size="4">
