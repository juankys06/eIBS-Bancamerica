...
<TABLE class="tableinfo" cellspacing="0" cellpadding="2" width="100%" border="0">
	...
	<TR id="trclear">
		...
		<TD nowrap></TD>
		<TD nowrap>
		<DIV align="center"><INPUT type="text" name="E01RLCCA1" size="12" maxlength="11" value="<%= msg01.getE01RLCCA1().trim()%>" onKeyPress="return enterDecimalNum(event)" readonly></DIV>
		</TD>
		<TD nowrap>
		<DIV align="center"><INPUT type="text" name="E01RLCCO1" size="5" maxlength="4" value="<%= msg01.getE01RLCCO1().trim()%>" onKeyPress="enterInteger()" readonly></DIV>
		</TD>
		<TD nowrap>
			<DIV align="center"><INPUT type="text" name="E01RLCCN1" size="12" maxlength="11" value="<%= msg01.getE01RLCCN1().trim()%>" onKeyPress="enterDecimal()" readonly></DIV>
		</TD>
		<TD nowrap>
		<DIV align="center"><INPUT type="text" name="E01RLCCV1" size="12" maxlength="11" value="<%= msg01.getE01RLCCV1().trim()%>" onKeyPress="enterDecimal()" readonly></DIV>
		</TD>
		<TD nowrap>
			<DIV align="center"><SELECT name="E01RLCCI1" disabled>
...
<TABLE class="tableinfo" cellspacing="0" cellpadding="2" width="100%" border="0">
			...
			<TR id="trclear">
				...
				<DIV align="center"><INPUT type="text" name="E01RLCCG1" size="19"
						maxlength="16" value="<%= msg01.getE01RLCCG1().trim()%>" onKeyPress="enterInteger()" readonly> 
				</DIV>
				</TD>
				<TD nowrap width="234">
