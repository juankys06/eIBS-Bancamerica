...
<h3 align="center">Condiciones del Pr&eacute;stamo<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="ln_chg_status.jsp,EDL0135"> 
</h3>
<hr size="4">
    ...
    <tr > 
      <td nowrap> 
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          ...
          <% int status = 1;
          try { status = Integer.parseInt(lnChgSts.getE01DEADLC());} catch (Exception e) { status = 1;}
          if (status < 2) {%>
          
 			<td nowrap >                
				<INPUT type="radio" name="E01NEWDLC" value="2"><b>Vencido</b>		  			  
 			</td>
 		  ...
 		  if (status < 3) {%>
 			...
 			<td nowrap >                 
				<INPUT type="radio" name="E01NEWDLC" value="3"><b>Castigado</b>		  			   
 			</td>
 		  ...
 		  if (status < 4) {%>
 			...
 			<td nowrap >                 
				<INPUT type="radio" name="E01NEWDLC" value="4"><b>Castigado No Informado</b>		 			   
 			</td>
        ...
        <table cellpadding=2 cellspacing=0 width="100%" border="0">
          <tr id=trdark>
            <td nowrap align="right"> 
 			...
 			<td nowrap >                
			  <input type="text" name="E01DATEP1" size="2" maxlength="2" value="<%= lnChgSts.getE01DATEP1().trim()%>">
              <input type="text" name="E01DATEP2" size="2" maxlength="2" value="<%= lnChgSts.getE01DATEP2().trim()%>">
              <input type="text" name="E01DATEP3" size="2" maxlength="2" value="<%= lnChgSts.getE01DATEP3().trim()%>">		  			  
 			</td>
 		  </tr> 
 		  <tr id=trclear>
 			<td nowrap align="right">                 
 			...
 			<td nowrap >                 
                ...
                <a href="javascript:GetCodeDescCNOFC('E01RESPON','D01RESPON','XD')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt=". . ." align="absbottom" border="0" ></a> 
            </td>
 		  </tr>                     
        </table>
      </td>
