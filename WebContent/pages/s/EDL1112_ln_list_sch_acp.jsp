...
<h3 align="center">Abonos Masivos, Proceso Manual - Aceptar<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="ln_list_sch_acp.jsp,EDL1112"> 
</h3>
<hr size="4">
    ...
    <tr > 
   		<td nowrap >
      		<table cellpadding=2 cellspacing=0 width="100%" border="0">
     			...
     			<tr id="trdark"> 
          			<td nowrap width="40%"><div align="right"><b>Compañia de Pago :</b></div></td>
         		 ...
         		 <tr id="trclear"> 
            		...
            		<td nowrap width="60%" align="left"><input type="text" readonly name="E01FRECUE" size="20" maxlength="20" value=<%= userPO.getHeader5().equals("M") ? "MENSUAL" : userPO.getHeader5().equals("Q") ? "QUINCENAL" : "" %>>
	         		</td>
         		</tr>
    		    ...
    		    <tr id="trclear"> 
            		<td nowrap width="40%"> <div align="right"><b>Descripción :</b></div></td>
           			<td nowrap width="60%" ><input type="text" readonly name="E01NARRAT" size="31" maxlength="30" value="<%= userPO.getHeader9().trim()%>">
           			</td>
         		</tr>  
          
         		<tr id="trdark"> 
            		<td nowrap width="40%"> <div align="right"><b>Total :</b></div></td>
            		<td nowrap width="60%" ><input type="text" readonly name="E01TOTAMT" size="16" maxlength="15" value="<%= userPO.getHeader22().trim()%>">
           			</td>
         		</tr> 
