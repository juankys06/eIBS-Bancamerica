...
<H3 align="center">Sistema de Bastanteo - Mantenimiento de Autorizaciones Especiales<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="bastanteo_autoriz_maint,ECU0000"></H3>
<hr size="4">
    ...
    <table cellspacing=0 cellpadding=2 width="100%" border="0">
    	<tr id=trdark> 
		  <td> 
      	  ...
      	  <td nowrap> 
      	    <input type="text" name="E06CUARD1" size="2" maxlength="2" value="<%= msgMTAut.getE06CUARD1() %>">
	      	<input type="text" name="E06CUARD2" size="2" maxlength="2" value="<%= msgMTAut.getE06CUARD2() %>">
	      	<input type="text" name="E06CUARD3" size="2" maxlength="2" value="<%= msgMTAut.getE06CUARD3() %>">
    	...
    	<tr id=trclear> 
		  <td> 
      	  ...
      	  <td nowrap> 
      	    <input type="text" name="E06CUAAD1" size="2" maxlength="2" value="<%= msgMTAut.getE06CUAAD1() %>">
	      	<input type="text" name="E06CUAAD2" size="2" maxlength="2" value="<%= msgMTAut.getE06CUAAD2() %>">
	      	<input type="text" name="E06CUAAD3" size="2" maxlength="2" value="<%= msgMTAut.getE06CUAAD3() %>">
     	...
     	<tr id=trclear> 
		  <td> 
      	  ...
      	  <td nowrap> 
      	    <input type="text" name="E06CUAMA1" size="2" maxlength="2" value="<%= msgMTAut.getE06CUAMA1() %>">
	      	<input type="text" name="E06CUAMA2" size="2" maxlength="2" value="<%= msgMTAut.getE06CUAMA2() %>">
	      	<input type="text" name="E06CUAMA3" size="2" maxlength="2" value="<%= msgMTAut.getE06CUAMA3() %>">
  ...
  <table class="tableinfo">
      <tr > 
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0" align="left">
          <tr id="trdark"> 
            <td nowrap width="100%"> 
              <input type="text" name="E06CUAOB1" size="90" maxlength="80" value="<%= msgMTAut.getE06CUAOB1().trim()%>">
            </td>
          </tr>
          <tr id="teclear"> 
            <td nowrap width="100%"> 
              <input type="text" name="E06CUAOB2" size="90" maxlength="80" value="<%= msgMTAut.getE06CUAOB2().trim()%>">
            </td>
          </tr>
          <tr id="trdark"> 
            <td nowrap width="100%"> 
              <input type="text" name="E06CUAOB3" size="90" maxlength="80" value="<%= msgMTAut.getE06CUAOB3().trim()%>">
            </td>
          </tr>
          <tr id="teclear"> 
            <td nowrap width="100%"> 
              <input type="text" name="E06CUAOB4" size="90" maxlength="80" value="<%= msgMTAut.getE06CUAOB4().trim()%>">
            </td>
          </tr>
          <tr id="trdark"> 
            <td nowrap width="100%"> 
              <input type="text" name="E06CUAOB5" size="90" maxlength="80" value="<%= msgMTAut.getE06CUAOB5().trim()%>">
            </td>
          </tr>
        </table>
      </tr>
