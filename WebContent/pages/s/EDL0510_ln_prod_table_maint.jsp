        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <tr id="trdark">
            ...
            <td nowrap colspan=2> 
              ...
              <a href="javascript:GetCode('E02DLSRFT','STATIC_ln_tables_factor.jsp')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="ayuda" align="absbottom" border="0"></a>	
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap> 
            ...
            <td nowrap colspan=4> 
 	        ...
 	        <td nowrap colspan=2> 
              ...
              <a href="javascript:GetCode('E02DLSMMT','STATIC_ln_tables_max_rate.jsp')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="ayuda" align="absbottom" border="0"></a>	
            </td>
          </tr>
          <tr id="trdark">
            <td nowrap>
            ...
            <td nowrap>
              ...
              <a href="javascript:GetCode('E02DLSICT','STATIC_cd_formula.jsp')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="ayuda" align="absbottom" border="0"></a> 
            </td>
            <td nowrap> 
            ...
            <td nowrap colspan=2>        
              ...
              <a href="javascript:GetCode('E02DLSFL2','STATIC_ln_tables_penalty_rate.jsp')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="ayuda" align="absbottom" border="0"></a> 
            </td>
          </tr>
          <tr id="trclear">
            <td nowrap>
            ...
            <td nowrap>
              ...
              <a href="javascript:GetCode('E02DLSPPR','STATIC_ln_tables_partial_payment.jsp')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="ayuda" align="absbottom" border="0"></a> 
            </td>
            <td nowrap> 
		  ...
		  <tr id="trdark">
			...
			<td nowrap>
              ...
              <a href="javascript:GetCode('E02DLSFCO','STATIC_ln_tables_holidays.jsp')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="ayuda" align="absbottom" border="0"></a></td>
  			<td nowrap>
          ...
          <tr id="trclear">
			...
			<td nowrap>
              ...
              <a href="javascript:GetCode('E02DLSTCG','STATIC_ln_tables_accounting_changes.jsp')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="ayuda" align="absbottom" border="0"></a></td>
  			<td nowrap>
            ...
            <td nowrap> 
              <div align="center"> 
                <input type="text" name="E02DLSGB<%= name %>" size="3" maxlength="3" 
				 oncontextmenu="showPopUp(currencyHelp,this.name,'','','','','')"
