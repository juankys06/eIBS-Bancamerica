<html>
<head>
<title>Tranferencia de Cheques Devueltos</title>
...
<h3 align="center">Tranferencia de Cheques Devueltos<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="EDD_ibsTopkm.jsp,JSEDD2000"></h3>
<hr size="4">
...
<table id="TBHELP" align="center" width="100%" height="10%"  border="0">
    <tr> 
      ...
      <td nowrap ALIGN="right">
      		Monto Total:  </td>
      <td nowrap ALIGN="left"> 
        <INPUT type="text" name="MONTO" size="14" maxlength="14" readonly value=<%=userPO.getHeader22() %>>
        </td>
    </tr> 
