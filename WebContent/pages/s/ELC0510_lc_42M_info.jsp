...
%> 
<h3 align="center">Detalle de Pago Mixto (42M)<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="lc_42M_info.jsp, ELC0510"></h3>
<hr size="4">
 ...
 <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/servlet/datapro.eibs.products.JSELC0510" >
  ...
  <INPUT TYPE=HIDDEN NAME="E03LCDFCD" VALUE="42M">
