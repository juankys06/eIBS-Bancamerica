      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          <tr id="trdark"> 
            ...
            <td nowrap width="20%" > 
              <div align="left">
                <input type="text" name="E01ACMCUN" id="E01ACMCUN" size="9" maxlength="9" value="<%= CUSCUN%>">
                <a href="javascript:GetCustomerDescId('E01ACMCUN','E01CUSNA1','')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Ayuda" border="0" ></a></div>
            </td>
            <td nowrap width="16%" > 
    ...
    <tr bordercolor="#FFFFFF"> 
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <tr id="trclear"> 
            <td nowrap width="29%" height="19"> 
              <div align="right">N&uacute;mero Direcci&oacute;n Postal :</div>
            </td>
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <tr id="trclear">
            ...
            <td nowrap colspan=3>
              <INPUT type="text" name="E01ACMCK2" readonly size="35" maxlength="35" value="<%= rtBasic.getE01ACMCK2().trim()%>">
            </td>
