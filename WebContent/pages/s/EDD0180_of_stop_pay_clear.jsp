...
<H3 align="center">Aclarar Ordenes de No Pago <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="rt_stop_pay_det.jsp , EDD0180"></H3> 
<hr size="4">
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap> 
              <div align="left"> 
                <input type="text" name="E01STPFCK" size="10" maxlength="9" value="<%=stop.getRecord(1).trim()%>" readonly>
              </div>
            </td>
          ...
          <tr id="trdark"> 
            ...
            <td nowrap > 
              <div align="left"> 
                <input type="text" name="E01STPAMT" size="15" maxlength="15" value="<%=stop.getRecord(7).trim()%>" readonly>
              </div>
            </td>
          </tr>
          <tr id="trclear"> 
          ...
          <tr id="trdark"> 
            ...
            <td nowrap > 
              <input type="text" name="E01STPFLG" size="3" maxlength="2" value="<% if(stop.getRecord(12).equals("Y")) out.print("SI"); else out.print("NO");%>" readonly>
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap width="44%" > 
