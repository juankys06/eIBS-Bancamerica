...
%> 
<h3 align="center">Detalle de Pago Mixto (42M)<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="letter_of_credit_42M_info.jsp,ELC0525"></h3>
<hr size="4">
