...
<BODY>
<h3 align="center">Aprobación de Cambio de Producto<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="product_change_approval.jsp, ESD0940"></h3>
<hr size="4">
		 ...
		 %>
          <tr> 
            <td NOWRAP  align=CENTER width="2%"> 
              <input type="radio" name="CURRCODE" value="<%= ESD094001Help.getCurrentRow() %>" <%=chk%> onClick="getParams(this.value,'<%= msgList.getE01CHGAPL() %>','<%= msgList.getE01CHGACC() %>','<%= previousValue %>','<%= newValue %>','<%= msgList.getE01CHGTYP() %>');">
            </td>
