...
%>
  ...
  <h3 align="center">Emisi&oacute;n de Cheques de Gerencia<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="of_chk_help.jsp,EOF0115"> 
  </h3>
  <hr size="4">
  <p>&nbsp;</p>
