...
%>
<div align="center"> 
  <h3>Confirmaci&oacute;n de Pago de Cup&oacute;n <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="inv_coupon_approval.jsp,EIE0210"> 
  </h3>
</div>
<hr size="4">
