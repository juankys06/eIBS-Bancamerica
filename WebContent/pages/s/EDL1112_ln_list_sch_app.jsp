...
<h3 align="center">Abonos Masivos, Proceso Manual - Aprobación<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="ln_list_sch_app.jsp,EDL1112"> 
</h3>
<hr size="4">
    	...
    	<td nowrap > 
        	<table cellpadding=2 cellspacing=0 width="100%" border="0">
				...
				<tr id="trclear"> 
          		...
          		<tr id="trclear"> 
            		<td nowrap width="40%" align="right"><b>Descripción :</b></td>
