...
<h3 align="center">Inversi&oacute;n Nocturna - Back Office<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="fe_ffs.jsp,EDL0130B"></h3>
<hr size="4">
      ...
      <td nowrap width="32%" > 
        <div align="center"> 
          ...
          <input type="text" name="E11OFFCO1" size="25" maxlength="25"  value="<%= deal.getE11OFFCO1().trim()%>"
                  oncontextmenu="showPopUp(conceptHelp,this.name,document.forms[0].E11DEABNK.value,'','E11OFFGL1','E11OFFOP1','15')">
        </div>
      </td>
      <td nowrap width="14%" > 
        <div align="center"> 
