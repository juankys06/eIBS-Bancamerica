    ...
    <tr > 
      <td nowrap> 
        <table cellspacing=0 cellpadding=2 width="100%" border="0">
          ...
          <tr id="trclear" >
            <td nowrap > 
              <div align="right">Saldo Inicial :</div>
            </td> 
            <td nowrap > 
              <input type="text" name="E01NOTVAL" size="20" maxlength="19" value="<%= inqLoans.getE01NOTVAL().trim()%>" readonly>
            </td>
            <td nowrap > 
              <div align="right">Comision de Apertura :</div>
            </td>
            <td nowrap > 
              <input type="text" name="E01DEATDA" size="20" maxlength="19" value="<%= inqLoans.getE01DEATDA().trim()%>" readonly>
            </td>
          </tr>
          <tr id="trdark"> 
            <td nowrap > 
          ...
          <tr id="trclear"> 
            ...
            <td nowrap >
              <input type="text" name="E01DLCAV3" size="15" maxlength="15" value="<%= inqLoans.getE01DLCAV3().trim()%>" readonly>
            </td>
            <td nowrap >
          ...
          <tr id="trdark"> 
            ...
            <td nowrap >
              <input type="text" name="E01DEAIDG" size="15" maxlength="15" value="<%= inqLoans.getE01DLCAV1().trim()%>" readonly>
            </td>
            <td nowrap >
              <div align="right">Pagado Interes DGI  :</div>
            </td>
            <td nowrap >
              <input type="text" name="E01DEAMPA" size="20" maxlength="19" value="<%= inqLoans.getE01DLCAV2().trim()%>" readonly>
            </td>
          </tr>
          ...
          <tr id="trclear"> 
            ...
            <td nowrap >
              <input type="text" name="E01DEAOPI" size="15" maxlength="15" value="<%= inqLoans.getE01DEATDM().trim()%>" readonly>
            </td>
            <td nowrap >
              <div align="right">Mensual Interes DGI  :</div>
            </td>
            <td nowrap >
              <input type="text" name="E01DEAAVI" size="15" maxlength="15" value="<%= inqLoans.getE01DEAAVI().trim()%>" readonly>
            </td>
          </tr>
