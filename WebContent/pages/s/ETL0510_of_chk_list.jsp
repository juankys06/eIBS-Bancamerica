...
<FORM>
  <h3 align="center">Listado Cheques de Gerencia - Orden de No Pago<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="of_chk_list.jsp, ETL0510">   </h3>
  <hr size="4">
<%
