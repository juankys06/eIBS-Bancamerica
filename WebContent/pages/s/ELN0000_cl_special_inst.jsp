...
%> 
<h3 align="center">Instrucciones Especiales <img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="cl_special_inst,ELN0000"></h3>
<hr size="4">
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="20%"> 
              <div align="left">
                <input type="text" name="LINEA" size="4" maxlength="4" value="<%= userPO.getCreditLineNum().trim()%>" readonly>
              </div>
            </td>
            <td nowrap width="16%"> 
    ...
    <tr  > 
      <td nowrap> 
        <p align="center"> 
          ...
          <input type="text" name="EE5DSC" size="80" maxlength="80" value="<%= clInst.getEE5DSC().trim()%>"><br>
