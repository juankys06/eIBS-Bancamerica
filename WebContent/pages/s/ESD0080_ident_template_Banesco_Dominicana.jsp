          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="20%"> 
              <input type="text" name="<%= "E" + suffix %>TID" size="8" maxlength="4" value="<%= mr.getField("E" + suffix + "TID").getString().trim()%>" <%=READ_ONLY_TAG %> <% if (mr.getField("F" + suffix + "TID").getString().equals("Y")) out.print("id=\"txtchanged\""); %>>
               <% if( !readOnly){ %>
              <a href="javascript:GetCodeAuxCNOFC('<%= "E" + suffix %>TID','34','<%=mr.getField("H" + suffix + "SCR").getString().trim() + lastDig %>' )"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="ayuda" align="bottom" border="0"></a> 
               <% }%>
            </td>
            <td nowrap width="11%"> 
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="20%"> 
              <input type="text" name="<%= "E" + suffix %>TIF" size="8" maxlength="4" value="<%= mr.getField("E" + suffix + "TIF").getString().trim()%>" <%=READ_ONLY_TAG %> <% if ( mr.getField("F" + suffix + "TIF").getString().equals("Y")) out.print("id=\"txtchanged\""); %>>
               <% if( !readOnly){ %>
              <a href="javascript:GetCodeAuxCNOFC('<%= "E" + suffix %>TIF','34','<%=mr.getField("H" + suffix + "SCR").getString().trim() + lastDig %>')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="ayuda" align="bottom" border="0" ></a> 
               <% } %>
            </td>
            <td nowrap width="11%"> 
              <div align="right">Pa&iacute;s :</div>
          ...
          <tr id="trdark"> 
            ...
            <td nowrap width="20%" > 
              <input type="text" name="<%= "E" + suffix %>TI3" size="8" maxlength="4" value="<%= mr.getField("E" + suffix + "TI3").getString().trim()%>" <%=READ_ONLY_TAG %> <% if (mr.getField("F" + suffix + "TI3").getString().equals("Y")) out.print("id=\"txtchanged\""); %>>
               <% if( !readOnly){ %>
              <a href="javascript:GetCodeAuxCNOFC('<%= "E" + suffix %>TI3','34','<%=mr.getField("H" + suffix + "SCR").getString().trim() + lastDig %>')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="ayuda" align="bottom" border="0" ></a> 
               <% } %>
            </td>
            <td nowrap width="11%" > 
              <div align="right">Pa&iacute;s :</div>
