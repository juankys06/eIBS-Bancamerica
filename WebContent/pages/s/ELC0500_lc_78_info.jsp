...
%> 
<h3 align="center">Instrucciones para el Banco Pagador (78)<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="lc_78_info.jsp, ELC0500"></h3>
<hr size="4">
