...
<h3 align="center">Consulta de Operaciones Compraventa Moneda Extranjera<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="foreign_currency_exchange_detail, EPR0395"></H3>
<hr size="4">
   ...
   <td>
    <table cellspacing=0 cellpadding=2 width="100%" border="0">    
		...
		<tr>
			...
			<td nowrap width="60%">
                <input type="text" name="E01REQCR1" size="2" maxlength="2" value="<%= msgInst.getE01REQCR1() %>" readonly>
                <input type="text" name="E01REQCR2" size="2" maxlength="2" value="<%= msgInst.getE01REQCR2() %>" readonly>
                <input type="text" name="E01REQCR3" size="2" maxlength="2" value="<%= msgInst.getE01REQCR3() %>" readonly>
		...
		<tr>
			...
			<td nowrap width="60%">
                <input type="text" name="E01REQUP1" size="2" maxlength="2" value="<%= msgInst.getE01REQUP1() %>" readonly>
                <input type="text" name="E01REQUP2" size="2" maxlength="2" value="<%= msgInst.getE01REQUP2() %>" readonly>
                <input type="text" name="E01REQUP3" size="2" maxlength="2" value="<%= msgInst.getE01REQUP3() %>" readonly>
                <input type="text" name="E01REQUPT" size="8" maxlength="8" value="<%= Util.formatTime(msgInst.getE01REQUPT()) %>" readonly> 
			</td>
		</tr>
		<tr>
			<td nowrap width="40%">
		...
		<tr>
			...
			<td nowrap width="60%">
                <input type="text" name="E01REQVA1" size="2" maxlength="2" value="<%= msgInst.getE01REQVA1() %>" readonly>
                <input type="text" name="E01REQVA2" size="2" maxlength="2" value="<%= msgInst.getE01REQVA2() %>" readonly>
                <input type="text" name="E01REQVA3" size="2" maxlength="2" value="<%= msgInst.getE01REQVA3() %>" readonly>
			</td>
		</tr>
		<%}%>
		...
		<tr>
			...
			<td nowrap width="60%">
                <input type="text" name="E01REQSN1" size="2" maxlength="2" value="<%= msgInst.getE01REQSN1() %>" readonly>
                <input type="text" name="E01REQSN2" size="2" maxlength="2" value="<%= msgInst.getE01REQSN2() %>" readonly>
                <input type="text" name="E01REQSN3" size="2" maxlength="2" value="<%= msgInst.getE01REQSN3() %>" readonly>
				<input type="text" name="E01REQSNT" size="8" maxlength="8" value="<%= Util.formatTime(msgInst.getE01REQSNT()) %>" readonly> 
			</td>
		</tr>
		<tr>
			<td nowrap width="40%">
		...
		<tr>
			...
			<td nowrap width="60%">
                <input type="text" name="E01REQAP1" size="2" maxlength="2" value="<%= msgInst.getE01REQAP1() %>" readonly>
                <input type="text" name="E01REQAP2" size="2" maxlength="2" value="<%= msgInst.getE01REQAP2() %>" readonly>
                <input type="text" name="E01REQAP3" size="2" maxlength="2" value="<%= msgInst.getE01REQAP3() %>" readonly>
				<input type="text" name="E01REQAPT" size="8" maxlength="8" value="<%= Util.formatTime(msgInst.getE01REQAPT()) %>" readonly> 
			</td>
		</tr>
		<tr>
			<td nowrap width="40%">
		...
		<tr>
			...
			<td nowrap width="60%">
                <input type="text" name="E01REQRJ1" size="2" maxlength="2" value="<%= msgInst.getE01REQRJ1() %>" readonly>
                <input type="text" name="E01REQRJ2" size="2" maxlength="2" value="<%= msgInst.getE01REQRJ2() %>" readonly>
                <input type="text" name="E01REQRJ3" size="2" maxlength="2" value="<%= msgInst.getE01REQRJ3() %>" readonly>
		...
		<tr>
			...
			<td nowrap width="60%">
                <input type="text" name="E01REQSU1" size="2" maxlength="2" value="<%= msgInst.getE01REQSU1() %>" readonly>
                <input type="text" name="E01REQSU2" size="2" maxlength="2" value="<%= msgInst.getE01REQSU2() %>" readonly>
                <input type="text" name="E01REQSU3" size="2" maxlength="2" value="<%= msgInst.getE01REQSU3() %>" readonly>
				<input type="text" name="E01REQSUT" size="8" maxlength="8" value="<%= Util.formatTime(msgInst.getE01REQSUT()) %>" readonly> 
			</td>
		</tr>
		<tr>
			<td nowrap width="40%">
		...
		<tr>
			...
			<td nowrap width="60%">
                <input type="text" name="E01REQRE1" size="2" maxlength="2" value="<%= msgInst.getE01REQRE1() %>" readonly>
                <input type="text" name="E01REQRE2" size="2" maxlength="2" value="<%= msgInst.getE01REQRE2() %>" readonly>
                <input type="text" name="E01REQRE3" size="2" maxlength="2" value="<%= msgInst.getE01REQRE3() %>" readonly>
				<input type="text" name="E01REQRET" size="8" maxlength="8" value="<%= Util.formatTime(msgInst.getE01REQRET()) %>" readonly> 
			</td>
		</tr>
		<tr>
			<td nowrap width="40%">
		...
		<tr>
			...
			<td nowrap width="60%">
                <input type="text" name="E01REQTR1" size="2" maxlength="2" value="<%= msgInst.getE01REQTR1() %>" readonly>
                <input type="text" name="E01REQTR2" size="2" maxlength="2" value="<%= msgInst.getE01REQTR2() %>" readonly>
                <input type="text" name="E01REQTR3" size="2" maxlength="2" value="<%= msgInst.getE01REQTR3() %>" readonly>
				<input type="text" name="E01REQTRT" size="8" maxlength="8" value="<%= Util.formatTime(msgInst.getE01REQTRT()) %>" readonly> 
			</td>
		</tr>
		<tr>
			<td nowrap width="40%">
		...
		<tr>
			...
			<td nowrap width="60%">
                <input type="text" name="E01REQFR1" size="2" maxlength="2" value="<%= msgInst.getE01REQFR1() %>" readonly>
                <input type="text" name="E01REQFR2" size="2" maxlength="2" value="<%= msgInst.getE01REQFR2() %>" readonly>
                <input type="text" name="E01REQFR3" size="2" maxlength="2" value="<%= msgInst.getE01REQFR3() %>" readonly>
				<input type="text" name="E01REQFRT" size="8" maxlength="8" value="<%= Util.formatTime(msgInst.getE01REQFRT()) %>" readonly> 
			</td>
		</tr>
		<tr>
			<td nowrap width="40%">
