...
%> 
<h3 align="center">Intrucciones de Pago  (Renovación)<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="cp_ap_renov_options,EDL0105"></h3>
<hr size="4">
      ...
      <td>
        <table cellpadding=2 cellspacing=0 align=center width=100% bordercolor="#000000">
          ...
          <tr id="trdark"> 
            ...
            <td colspan="2" >El Principal e Interés será pagado basado en una cronograma de pago  <a href="javascript:document.forms[0].typeS.click();showCDPayMaint()"><img src="<%=request.getContextPath()%>/images/eibs_deducciones.gif" alt="Payment Plan" align="absmiddle" border="0" ></a> 
