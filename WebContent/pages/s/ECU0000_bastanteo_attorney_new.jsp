...
<H3 align="center">Sistema de Bastanteo - Creacion del Propetario/Apoderado<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="bastanteo_attorney_new,ECU0000"></H3>
<hr size="4">
    ...
    <table cellspacing=0 cellpadding=2 width="100%" border="0">
    	...
    	<tr id=trdark> 
		  <td> 
      	  ...
      	  <td nowrap> 
      	    <input type="text" name="E05CUMDD1" size="2" maxlength="2" value="<%= msgMem.getE05CUMDD1() %>">
	      	<input type="text" name="E05CUMDD2" size="2" maxlength="2" value="<%= msgMem.getE05CUMDD2() %>">
	      	<input type="text" name="E05CUMDD3" size="2" maxlength="2" value="<%= msgMem.getE05CUMDD3() %>">
	      	...
	      	&nbsp;T&eacute;rmino&nbsp;
	      	<input type="text" name="E05MBMTRM" size="4" maxlength="4" value="<%= msgMem.getE05MBMTRM().trim()%>">
     	...
     	<tr id=trclear> 
		  <td> 
      	  ...
      	  <td nowrap> 
      	    <input type="text" name="E05CUMD21" size="2" maxlength="2" value="<%= msgMem.getE05CUMD21() %>">
	      	<input type="text" name="E05CUMD22" size="2" maxlength="2" value="<%= msgMem.getE05CUMD22() %>">
	      	<input type="text" name="E05CUMD23" size="2" maxlength="2" value="<%= msgMem.getE05CUMD23() %>">
      ...
      <tr > 
        ...
        <tr id=trdark> 
		  <td> 
      	  ...
      	  <td nowrap> 
      	    <input type="text" name="E05REGRDD" size="2" maxlength="2" value="<%= msgMem.getE05REGRDD() %>">
	      	<input type="text" name="E05REGRMM" size="2" maxlength="2" value="<%= msgMem.getE05REGRMM() %>">
	      	<input type="text" name="E05REGRYY" size="2" maxlength="2" value="<%= msgMem.getE05REGRYY() %>">
  ...
  <table class="tableinfo">
      <tr > 
        ...
        <table cellspacing="0" cellpadding="2" width="100%" border="0" align="left">
          <tr id="trdark"> 
            <td nowrap width="100%"> 
              <input type="text" name="E05CUMOB1" size="90" maxlength="80" value="<%= msgMem.getE05CUMOB1().trim()%>">
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap width="100%"> 
              <input type="text" name="E05CUMOB2" size="90" maxlength="80" value="<%= msgMem.getE05CUMOB2().trim()%>">
            </td>
          </tr>
          <tr id="trdark"> 
            <td nowrap width="100%"> 
              <input type="text" name="E05CUMOB3" size="90" maxlength="80" value="<%= msgMem.getE05CUMOB3().trim()%>">
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap width="100%"> 
              <input type="text" name="E05CUMOB4" size="90" maxlength="80" value="<%= msgMem.getE05CUMOB4().trim()%>">
            </td>
          </tr>
          <tr id="trdark"> 
            <td nowrap width="100%"> 
              <input type="text" name="E05CUMOB5" size="90" maxlength="80" value="<%= msgMem.getE05CUMOB5().trim()%>">
            </td>
          </tr>
        </table>
      </tr>
