...
%>
<h3 align="center">MT 210 - Notificaci&oacute;n de Recibo<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="fe_fw_format.jsp, ESWF210M"> 
</h3>
<hr size="4">
