...
%>
  ...
  <h3 align="center">Estado de Cuentas<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="st_list_fp.jsp,ECIF030"> 
  </h3>
  <hr size="4">
  <br>
  ...
  <TABLE id=cfTable class="tableinfo">
    <TR> 
      ...
      <TH ALIGN=CENTER style="display:none" width="57" nowrap>Fecha de <BR>
        Registro</TH>
