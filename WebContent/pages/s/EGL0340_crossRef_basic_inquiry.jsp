...
<h3 align="center">Consulta Referencias Cruzadas<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="crossRef_basic_inquiry,EGL0340"></h3>
<hr size="4">      
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.products.JSEGL0340">
  ...
  <table class="tableinfo">
    ...
    <%if(currUser.getE01INT().equals("06")){%> 
      ...
      <td align="left" width="60%" nowrap> 
        <input type="text" readonly name="E02GLXG22" size="17" maxlength="17" value = "<%= crossRef.getE02GLXG22() %>"
        oncontextmenu="showPopUp(ledgerHelp,this.name,document.forms[0].E02GLMBNK.value,document.forms[0].E02GLMCCY.value,'','','')">
        <input type="text" readonly name="D02GLXG22" size="35" maxlength="35" value = "<%= crossRef.getD02GLXG22() %>">
      </td>
    </tr>
        <tr  id="trclear">
      <td align="right" width="30%"> 
      ...
      <td align="left" width="60%" nowrap> 
        <input type="text" readonly name="E02GLXG23" size="17" maxlength="17" value = "<%= crossRef.getE02GLXG23() %>" 
        oncontextmenu="showPopUp(ledgerHelp,this.name,document.forms[0].E02GLMBNK.value,document.forms[0].E02GLMCCY.value,'','','')">
        <input type="text" readonly name="D02GLXG23" size="35" maxlength="35" value = "<%= crossRef.getD02GLXG23() %>">
      </td>
    </tr>
        <tr  id="trclear">
      <td align="right" width="30%"> 
      ...
      <td align="left" width="60%" nowrap> 
        <input type="text" readonly name="E02GLXG24" size="17" maxlength="17" value = "<%= crossRef.getE02GLXG24() %>"
        oncontextmenu="showPopUp(ledgerHelp,this.name,document.forms[0].E02GLMBNK.value,document.forms[0].E02GLMCCY.value,'','','')">
        <input type="text" readonly name="D02GLXG24" size="35" maxlength="35" value = "<%= crossRef.getD02GLXG24() %>">
      </td>
    </tr>
      <% } %>
    <tr  id="trdark">
    ...
    <tr  id="trclear">
      ...
      <td align="left" width="60%" nowrap> 
        <input type="text" readonly name="E02GLXG30" size="17" maxlength="17" value = "<%= crossRef.getE02GLXG30() %>"
        oncontextmenu="showPopUp(ledgerHelp,this.name,document.forms[0].E02GLMBNK.value,document.forms[0].E02GLMCCY.value,'','','')">
        <input type="text" readonly name="D02GLXG30" size="35" maxlength="35" value = "<%= crossRef.getD02GLXG30() %>">
      </td>
    </tr>
    <tr  id="trclear">
      <td align="right" width="30%"> 
    ...
    <tr  id="trclear">
      ...
      <td align="left" width="60%" nowrap> 
        <input type="text" readonly name="E02GLXG21" size="17" maxlength="17" value = "<%= crossRef.getE02GLXG21() %>"
        oncontextmenu="showPopUp(ledgerHelp,this.name,document.forms[0].E02GLMBNK.value,document.forms[0].E02GLMCCY.value,'','','')">
        <input type="text" readonly name="D02GLXG21" size="35" maxlength="35" value = "<%= crossRef.getD02GLXG21() %>">
      </td>
    </tr>
    <tr  id="trclear">
      <td align="right" width="30%"> 
      ...
      <td align="left" width="60%" nowrap> 
        <input type="text" readonly name="E02GLXG29" size="17" maxlength="17" value = "<%= crossRef.getE02GLXG29() %>"
        oncontextmenu="showPopUp(ledgerHelp,this.name,document.forms[0].E02GLMBNK.value,document.forms[0].E02GLMCCY.value,'','','')">
        <input type="text" readonly name="D02GLXG29" size="35" maxlength="35" value = "<%= crossRef.getD02GLXG29() %>">
      </td>
    </tr>
  ...
  <table class="tableinfo">
	...
	<TR>
		...
		<TD align="left" width="60%" nowrap>
		<INPUT type="text" readonly name="E02GLMX28" size="17" maxlength="17" value="<%= crossRef.getE02GLMX28() %>"
			oncontextmenu="showPopUp(ledgerHelp,this.name,document.forms[0].E02GLMBNK.value,document.forms[0].E02GLMCCY.value,'','','')"> 
		<INPUT type="text" readonly name="D02GLMX28" size="35" maxlength="35" value="<%= crossRef.getD02GLMX28() %>"></TD>
	</TR>
	<tr  id="trdark">
    ...
    <tr  id="trclear">
      <td align="right" width="30%"> 
        Contra Sobregiro Mayor 66 Dias : 
      </td>
      <td align="left" width="60%" nowrap> 
        <input type="text" readonly name="E02GLMXO2" size="17" maxlength="17" value = "<%= crossRef.getE02GLMXO2() %>"
        oncontextmenu="showPopUp(ledgerHelp,this.name,document.forms[0].E02GLMBNK.value,document.forms[0].E02GLMCCY.value,'','','')">
    ...
    <tr  id="trclear">
      ...
      <td align="left" width="60%" nowrap> 
        <input type="text" readonly name="E02GLMX26" size="17" maxlength="17" value = "<%= crossRef.getE02GLMX26() %>"
        oncontextmenu="showPopUp(ledgerHelp,this.name,document.forms[0].E02GLMBNK.value,document.forms[0].E02GLMCCY.value,'','','')">
        <input type="text" readonly name="D02GLMX26" size="35" maxlength="35" value = "<%= crossRef.getD02GLMX26() %>">
      </td>
    </tr>
    <tr  id="trclear">
      <td align="right" width="30%"> 
      ...
      <td align="left" width="60%" nowrap> 
        <input type="text" readonly name="E02GLMX27" size="17" maxlength="17" value = "<%= crossRef.getE02GLMX27() %>"
        oncontextmenu="showPopUp(ledgerHelp,this.name,document.forms[0].E02GLMBNK.value,document.forms[0].E02GLMCCY.value,'','','')">
        <input type="text" readonly name="D02GLMX27" size="35" maxlength="35" value = "<%= crossRef.getD02GLMX27() %>">
      </td>
    </tr>
    <tr  id="trdark">
    ...
    <tr  id="trclear">
      ...
      <td align="left" width="60%" nowrap> 
        <input type="text" readonly name="E02GLMX23" size="17" maxlength="17" value = "<%= crossRef.getE02GLMX23() %>"
        oncontextmenu="showPopUp(ledgerHelp,this.name,document.forms[0].E02GLMBNK.value,document.forms[0].E02GLMCCY.value,'','','')">
        <input type="text" readonly name="D02GLMX23" size="35" maxlength="35" value = "<%= crossRef.getD02GLMX23() %>">
      </td>
    </tr>
    <tr  id="trclear">
      <td align="right" width="30%"> 
      ...
      <td align="left" width="60%" nowrap> 
        <input type="text" readonly name="E02GLMX24" size="17" maxlength="17" value = "<%= crossRef.getE02GLMX24() %>"
        oncontextmenu="showPopUp(ledgerHelp,this.name,document.forms[0].E02GLMBNK.value,document.forms[0].E02GLMCCY.value,'','','')">
        <input type="text" readonly name="D02GLMX24" size="35" maxlength="35" value = "<%= crossRef.getD02GLMX24() %>">
      </td>
    </tr>
    <tr  id="trclear">
      <td align="right" width="30%"> 
  ...
  <table class="tableinfo">
    ...
    <tr  id="trclear">
      ...
      <td align="left" width="60%" nowrap> 
        <input type="text" readonly name="E02GLXG01" size="17" maxlength="17" value = "<%= crossRef.getE02GLXG01() %>"
        oncontextmenu="showPopUp(ledgerHelp,this.name,document.forms[0].E02GLMBNK.value,document.forms[0].E02GLMCCY.value,'','','')">
        <input type="text" readonly name="D02GLXG01" size="35" maxlength="35" value = "<%= crossRef.getD02GLXG01() %>">
      </td>
    </tr>
    <tr  id="trclear">
      <td align="right" width="30%"> 
      ...
      <td align="left" width="60%" nowrap> 
        <input type="text" readonly name="E02GLXG02" size="17" maxlength="17" value = "<%= crossRef.getE02GLXG02() %>"
        oncontextmenu="showPopUp(ledgerHelp,this.name,document.forms[0].E02GLMBNK.value,document.forms[0].E02GLMCCY.value,'','','')">
        <input type="text" readonly name="D02GLXG02" size="35" maxlength="35" value = "<%= crossRef.getD02GLXG02() %>">
      </td>
    </tr>
    ...
    <tr  id="trclear">
      ...
      <td align="left" width="60%" nowrap> 
        <input type="text" readonly name="E02GLXG03" size="17" maxlength="17" value = "<%= crossRef.getE02GLXG03() %>"
        oncontextmenu="showPopUp(ledgerHelp,this.name,document.forms[0].E02GLMBNK.value,document.forms[0].E02GLMCCY.value,'','','')">
        <input type="text" readonly name="D02GLXG03" size="35" maxlength="35" value = "<%= crossRef.getD02GLXG03() %>">
      </td>
    </tr>
    <tr  id="trclear">
      ...
      <td align="left" width="60%" nowrap> 
        <input type="text" readonly name="E02GLXG04" size="17" maxlength="17" value = "<%= crossRef.getE02GLXG04() %>"
        oncontextmenu="showPopUp(ledgerHelp,this.name,document.forms[0].E02GLMBNK.value,document.forms[0].E02GLMCCY.value,'','','')">
        <input type="text" readonly name="D02GLXG04" size="35" maxlength="35" value = "<%= crossRef.getD02GLXG04() %>">
      </td>
    </tr>   
     <tr  id="trclear">
      ...
      <td align="left" width="60%" nowrap> 
        <input type="text" readonly name="E02GLXG05" size="17" maxlength="17" value = "<%= crossRef.getE02GLXG05() %>"
        oncontextmenu="showPopUp(ledgerHelp,this.name,document.forms[0].E02GLMBNK.value,document.forms[0].E02GLMCCY.value,'','','')">
        <input type="text" readonly name="D02GLXG05" size="35" maxlength="35" value = "<%= crossRef.getD02GLXG05() %>">
      </td>
    </tr>     
    <tr  id="trclear">
      <td align="right" width="30%"> 
      ...
      <td align="left" width="60%" nowrap> 
        <input type="text" readonly name="E02GLXG06" size="17" maxlength="17" value = "<%= crossRef.getE02GLXG06() %>"
        oncontextmenu="showPopUp(ledgerHelp,this.name,document.forms[0].E02GLMBNK.value,document.forms[0].E02GLMCCY.value,'','','')">
        <input type="text" readonly name="D02GLXG06" size="35" maxlength="35" value = "<%= crossRef.getD02GLXG06() %>">
      </td>
    </tr>
    <tr  id="trclear">
      <td align="right" width="30%"> 
      ...
      <td align="left" width="60%" nowrap> 
        <input type="text" readonly name="E02GLXG07" size="17" maxlength="17" value = "<%= crossRef.getE02GLXG07() %>"
        oncontextmenu="showPopUp(ledgerHelp,this.name,document.forms[0].E02GLMBNK.value,document.forms[0].E02GLMCCY.value,'','','')">
        <input type="text" readonly name="D02GLXG07" size="35" maxlength="35" value = "<%= crossRef.getD02GLXG07() %>">
      </td>
    </tr>
    <tr  id="trclear">
      <td align="right" width="30%"> 
      ...
      <td align="left" width="60%" nowrap> 
        <input type="text" readonly name="E02GLXG08" size="17" maxlength="17" value = "<%= crossRef.getE02GLXG08() %>"
        oncontextmenu="showPopUp(ledgerHelp,this.name,document.forms[0].E02GLMBNK.value,document.forms[0].E02GLMCCY.value,'','','')">
        <input type="text" readonly name="D02GLXG08" size="35" maxlength="35" value = "<%= crossRef.getD02GLXG08() %>">
      </td>
    </tr>
    <tr  id="trclear">
      <td align="right" width="30%"> 
      ...
      <td align="left" width="60%" nowrap> 
        <input type="text" readonly name="E02GLXG09" size="17" maxlength="17" value = "<%= crossRef.getE02GLXG09() %>"
        oncontextmenu="showPopUp(ledgerHelp,this.name,document.forms[0].E02GLMBNK.value,document.forms[0].E02GLMCCY.value,'','','')">
        <input type="text" readonly name="D02GLXG09" size="35" maxlength="35" value = "<%= crossRef.getD02GLXG09() %>">
      </td>
    </tr>
    <tr  id="trclear">
      <td align="right" width="30%"> 
      ...
      <td align="left" width="60%" nowrap> 
        <input type="text" readonly name="E02GLXG10" size="17" maxlength="17" value = "<%= crossRef.getE02GLXG10() %>"
        oncontextmenu="showPopUp(ledgerHelp,this.name,document.forms[0].E02GLMBNK.value,document.forms[0].E02GLMCCY.value,'','','')">
        <input type="text" readonly name="D02GLXG10" size="35" maxlength="35" value = "<%= crossRef.getD02GLXG10() %>">
      </td>
    </tr>
    <tr  id="trclear">
      <td align="right" width="30%"> 
      ...
      <td align="left" width="60%" nowrap> 
        <input type="text" readonly name="E02GLXG11" size="17" maxlength="17" value = "<%= crossRef.getE02GLXG11() %>"
        oncontextmenu="showPopUp(ledgerHelp,this.name,document.forms[0].E02GLMBNK.value,document.forms[0].E02GLMCCY.value,'','','')">
        <input type="text" readonly name="D02GLXG11" size="35" maxlength="35" value = "<%= crossRef.getD02GLXG11() %>">
      </td>
    </tr>
    <tr  id="trclear">
      <td align="right" width="30%"> 
      ...
      <td align="left" width="60%" nowrap> 
        <input type="text" readonly name="E02GLXG12" size="17" maxlength="17" value = "<%= crossRef.getE02GLXG12() %>"
        oncontextmenu="showPopUp(ledgerHelp,this.name,document.forms[0].E02GLMBNK.value,document.forms[0].E02GLMCCY.value,'','','')">
        <input type="text" readonly name="D02GLXG12" size="35" maxlength="35" value = "<%= crossRef.getD02GLXG12() %>">
      </td>
    </tr>
     <tr  id="trclear">
      <td align="right" width="30%"> 
      ...
      <td align="left" width="60%" nowrap> 
        <input type="text" readonly name="E02GLXG13" size="17" maxlength="17" value = "<%= crossRef.getE02GLXG13() %>"
        oncontextmenu="showPopUp(ledgerHelp,this.name,document.forms[0].E02GLMBNK.value,document.forms[0].E02GLMCCY.value,'','','')">
        <input type="text" readonly name="D02GLXG13" size="35" maxlength="35" value = "<%= crossRef.getD02GLXG13() %>">
      </td>
    </tr>
  <% } %>
  </table>
  ...
  <table class="tableinfo">
    ...
    <tr  id="trclear">
      ...
      <td align="left" width="60%" nowrap> 
        <input type="text" readonly name="E02GLMX30X" size="17" maxlength="17" value = ""
        oncontextmenu="showPopUp(ledgerHelp,this.name,document.forms[0].E02GLMBNK.value,document.forms[0].E02GLMCCY.value,'','','')">
        <input type="text" readonly name="D02GLMX30X" size="35" maxlength="35" value = "">
      </td>
    </tr>
    <tr  id="trclear">
      <td align="right" width="30%"> 
      ...
      <td align="left" width="60%" nowrap> 
        <input type="text" readonly name="E02GLMX31" size="17" maxlength="17" value = "<%= crossRef.getE02GLMX31() %>"
        oncontextmenu="showPopUp(ledgerHelp,this.name,document.forms[0].E02GLMBNK.value,document.forms[0].E02GLMCCY.value,'','','')">
        <input type="text" readonly name="D02GLMX31" size="35" maxlength="35" value = "<%= crossRef.getD02GLMX31() %>">
      </td>
    </tr>
    <tr  id="trclear">
      <td align="right" width="30%"> 
      ...
      <td align="left" width="60%" nowrap> 
        <input type="text" readonly name="E02GLMX32X" size="17" maxlength="17" value = ""
        oncontextmenu="showPopUp(ledgerHelp,this.name,document.forms[0].E02GLMBNK.value,document.forms[0].E02GLMCCY.value,'','','')">
        <input type="text" readonly name="D02GLMX32X" size="35" maxlength="35" value = "">
      </td>
    </tr>
    <tr  id="trclear">
      <td align="right" width="30%"> 
    ...
    <tr  id="trclear">
      ...
      <td align="left" width="60%" nowrap> 
        <input type="text" readonly name="E02GLMX28" size="17" maxlength="17" value = "<%= crossRef.getE02GLMX28() %>"
        oncontextmenu="showPopUp(ledgerHelp,this.name,document.forms[0].E02GLMBNK.value,document.forms[0].E02GLMCCY.value,'','','')">
        <input type="text" readonly name="D02GLMX28" size="35" maxlength="35" value = "<%= crossRef.getD02GLMX28() %>">
      </td>
    </tr>
    <tr  id="trclear">
      <td align="right" width="30%"> 
      ...
      <td align="left" width="60%" nowrap> 
        <input type="text" readonly name="E02GLMX29" size="17" maxlength="17" value = "<%= crossRef.getE02GLMX29() %>"
        oncontextmenu="showPopUp(ledgerHelp,this.name,document.forms[0].E02GLMBNK.value,document.forms[0].E02GLMCCY.value,'','','')">
        <input type="text" readonly name="D02GLMX29" size="35" maxlength="35" value = "<%= crossRef.getD02GLMX29() %>">
      </td>
    </tr>
  </table>
  <% } %>
  ...
  <table class="tableinfo">
    <tr  id="trdark"> 
      ...
      <td align="left" width="60%" nowrap> 
        <div align="left"> 
          <input type="text" readonly name="E02GLMX32" size="13" maxlength="12" value = "<%= crossRef.getE02GLMX32() %>"
        oncontextmenu="showPopUp(ledgerHelp,this.name,document.forms[0].E02GLMBNK.value,document.forms[0].E02GLMCCY.value,'','','')">
    ...
    <tr  id="trclear"> 
      ...
      <td align="left" width="60%" nowrap> 
        <div align="left"> 
          <input type="text" readonly name="E02GLMXCR" size="13" maxlength="12" value = "<%= crossRef.getE02GLMXCR() %>"
        oncontextmenu="showPopUp(ledgerHelp,this.name,document.forms[0].E02GLMBNK.value,document.forms[0].E02GLMCCY.value,'','','')">
          <input type="text" readonly name="D02GLMXCR" size="35" maxlength="35" value = "<%= crossRef.getD02GLMXCR() %>">
        </div>
      </td>
    ...
    <tr  id="trdark"> 
      ...
      <td align="left" width="60%" nowrap> 
        <div align="left"> 
          <input type="text" readonly name="E02GLMXSM" size="13" maxlength="12" value = "<%= crossRef.getE02GLMXSM() %>"
        oncontextmenu="showPopUp(ledgerHelp,this.name,document.forms[0].E02GLMBNK.value,document.forms[0].E02GLMCCY.value,'','','')">
          <input type="text" readonly name="D02GLMXSM" size="35" maxlength="35" value = "<%= crossRef.getD02GLMXSM() %>">
        </div>
      </td>
    ...
    <tr  id="trdark"> 
      ...
      <td align="left" width="60%" nowrap> 
        <div align="left"> 
          <input type="text" readonly name="E02GLMXSD" size="13" maxlength="12" value = "<%= crossRef.getE02GLMXSD() %>"
        oncontextmenu="showPopUp(ledgerHelp,this.name,document.forms[0].E02GLMBNK.value,document.forms[0].E02GLMCCY.value,'','','')">
          <input type="text" readonly name="D02GLMXSD" size="35" maxlength="35" value = "<%= crossRef.getD02GLMXSD() %>">
        </div>
      </td>
    ...
    <tr  id="trclear"> 
      ...
      <td align="left" width="60%" nowrap> 
        <div align="left"> 
          <input type="text" readonly name="E02GLMXST" size="13" maxlength="12" value = "<%= crossRef.getE02GLMXST() %>"
        oncontextmenu="showPopUp(ledgerHelp,this.name,document.forms[0].E02GLMBNK.value,document.forms[0].E02GLMCCY.value,'','','')">
          <input type="text" readonly name="D02GLMXST" size="35" maxlength="35" value = "<%= crossRef.getD02GLMXST() %>">
        </div>
      </td>
    ...
    <tr  id="trdark"> 
      ...
      <td align="left" width="60%" nowrap> 
        <div align="left"> 
          <input type="text" readonly name="E02GLMXSO" size="13" maxlength="12" value = "<%= crossRef.getE02GLMXSO() %>"
        oncontextmenu="showPopUp(ledgerHelp,this.name,document.forms[0].E02GLMBNK.value,document.forms[0].E02GLMCCY.value,'','','')">
          <input type="text" readonly name="D02GLMXSO" size="35" maxlength="35" value = "<%= crossRef.getD02GLMXSO() %>">
        </div>
      </td>
    ...
    <tr  id="trclear"> 
      ...
      <td align="left" width="60%" nowrap> 
        <div align="left"> 
          <input type="text" readonly name="E02GLMXLR" size="13" maxlength="12" value = "<%= crossRef.getE02GLMXLR() %>"
        oncontextmenu="showPopUp(ledgerHelp,this.name,document.forms[0].E02GLMBNK.value,document.forms[0].E02GLMCCY.value,'','','')">
          <input type="text" readonly name="D02GLMXLR" size="35" maxlength="35" value = "<%= crossRef.getD02GLMXLR() %>">
        </div>
      </td>
    ...
    <tr  id="trdark"> 
      ...
      <td align="left" width="60%" nowrap> 
        <div align="left"> 
          <input type="text" readonly name="E02GLMXO2" size="13" maxlength="12" value = "<%= crossRef.getE02GLMXO2() %>"
        oncontextmenu="showPopUp(ledgerHelp,this.name,document.forms[0].E02GLMBNK.value,document.forms[0].E02GLMCCY.value,'','','')">
          <input type="text" readonly name="D02GLMXO2" size="35" maxlength="35" value = "<%= crossRef.getD02GLMXO2() %>">
        </div>
      </td>
    ...
    <tr  id="trclear"> 
      ...
      <td align="left" width="60%" nowrap> 
        <div align="left"> 
          <input type="text" readonly name="E02GLMX17" size="13" maxlength="12" value = "<%= crossRef.getE02GLMX17() %>"
        oncontextmenu="showPopUp(ledgerHelp,this.name,document.forms[0].E02GLMBNK.value,document.forms[0].E02GLMCCY.value,'','','')">
          <input type="text" readonly name="D02GLMX17" size="35" maxlength="35" value = "<%= crossRef.getD02GLMX17() %>">
        </div>
      </td>
    ...
    <tr  id="trdark"> 
      ...
      <td align="left" width="60%" nowrap> 
        <div align="left"> 
          <input type="text" readonly name="E02GLMX18" size="13" maxlength="12" value = "<%= crossRef.getE02GLMX18() %>"
        oncontextmenu="showPopUp(ledgerHelp,this.name,document.forms[0].E02GLMBNK.value,document.forms[0].E02GLMCCY.value,'','','')">
    ...
    <tr  id="trclear"> 
      ...
      <td align="left" width="60%" nowrap> 
        <div align="left"> 
          <input type="text" readonly name="E02GLMXSR" size="13" maxlength="12" value = "<%= crossRef.getE02GLMXSR() %>"
        oncontextmenu="showPopUp(ledgerHelp,this.name,document.forms[0].E02GLMBNK.value,document.forms[0].E02GLMCCY.value,'','','')">
          <input type="text" readonly name="D02GLMXSR" size="35" maxlength="35" value = "<%= crossRef.getD02GLMXSR() %>">
        </div>
      </td>
    ...
    <tr  id="trdark"> 
      ...
      <td align="left" width="60%" nowrap> 
        <div align="left"> 
          <input type="text" readonly name="E02GLMXCC" size="13" maxlength="12" value = "<%= crossRef.getE02GLMXCC() %>"
        oncontextmenu="showPopUp(ledgerHelp,this.name,document.forms[0].E02GLMBNK.value,document.forms[0].E02GLMCCY.value,'','','')">
          <input type="text" readonly name="D02GLMXCC" size="35" maxlength="35" value = "<%= crossRef.getD02GLMXCC() %>">
        </div>
      </td>
...
<TABLE class="tableinfo">
	<TBODY>
		<TR id="trdark">
			...
			<TD align="left" width="60%" nowrap>
			<DIV align="left">
			<INPUT type="text" readonly name="E02GLMDFP" size="13" maxlength="12" value="<%= crossRef.getE02GLMDFP() %>"
				oncontextmenu="showPopUp(ledgerHelp,this.name,document.forms[0].E02GLMBNK.value,document.forms[0].E02GLMCCY.value,'','','')">
			<INPUT type="text" readonly name="D02GLMDFP0" size="35" maxlength="35" value="<%= crossRef.getD02GLMDFP() %>"></DIV>
			</TD>
		</TR>
		<TR id="trclear">
			<TD align="right" width="30%">
			...
			<TD align="left" width="60%" nowrap>
			<DIV align="left">
			<INPUT type="text" readonly name="E02GLMX16" size="13" maxlength="12" value="<%= crossRef.getE02GLMX16() %>"
				oncontextmenu="showPopUp(ledgerHelp,this.name,document.forms[0].E02GLMBNK.value,document.forms[0].E02GLMCCY.value,'','','')">
			<INPUT type="text" readonly name="D02GLMX160" size="35" maxlength="35" value="<%= crossRef.getD02GLMX16() %>"></DIV>
			</TD>
		</TR>
		<TR id="trdark">
			<TD align="right" width="30%">
			...
			<TD align="left" width="60%" nowrap>
			<DIV align="left">
			<INPUT type="text" readonly name="E02GLMXIE" size="13" maxlength="12" value="<%= crossRef.getE02GLMXIE() %>"
				oncontextmenu="showPopUp(ledgerHelp,this.name,document.forms[0].E02GLMBNK.value,document.forms[0].E02GLMCCY.value,'','','')">
			<INPUT type="text" readonly name="D02GLMXIE" size="35" maxlength="35" value="<%= crossRef.getD02GLMXIE() %>"></DIV>
			</TD>
		</TR>
		<TR id="trclear">
			<TD align="right" width="30%">
			...
			<TD align="left" width="60%" nowrap>
			<DIV align="left">
			<INPUT type="text" readonly name="E02GLMX19" size="13" maxlength="12" value="<%= crossRef.getE02GLMX19() %>"
				oncontextmenu="showPopUp(ledgerHelp,this.name,document.forms[0].E02GLMBNK.value,document.forms[0].E02GLMCCY.value,'','','')">
			<INPUT type="text" readonly name="D02GLMX19" size="35" maxlength="35" value="<%= crossRef.getD02GLMX19() %>"></DIV>
			</TD>			
		</TR>
		<TR id="trclear">
			<TD align="right" width="30%">
			...
			<TD align="left" width="60%" nowrap>
			<DIV align="left">
			<INPUT type="text" readonly name="E02GLMX20" size="13" maxlength="12" value="<%= crossRef.getE02GLMX20() %>"
				oncontextmenu="showPopUp(ledgerHelp,this.name,document.forms[0].E02GLMBNK.value,document.forms[0].E02GLMCCY.value,'','','')">
			<INPUT type="text" readonly name="D02GLMX20" size="35" maxlength="35" value="<%= crossRef.getD02GLMX20() %>"></DIV>
			</TD>		
		</TR>		
	</TBODY>
</TABLE>
