...
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="ln_ap_tit.jsp,EDL0140"> 
<hr size="4">
                ...
                <input type="text" name="E06TY<%= name %>" size="20"  maxlength="15" 
				  value="<%	cnofcList.initRow();
							while(cnofcList.getNextRow()){ 
     							...
     							if (cnofcDetail.getEWDCOD().trim().equals(lnTit.getField("E06TY"+name).getString().trim()) &&
