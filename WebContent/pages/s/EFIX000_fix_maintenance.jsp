...
%>
<h3 align="center">Mantenimiento de Activos Fijos / Amortizaciones<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="fix_maintenance.jsp, EFIX000"> 
</h3>
<hr size="4">
          ...
          <tr id="trdark"> 
            ...
            <td nowrap > 
              <div align="left"> 
                ...
                <a href="javascript:GetDepTyp('E01FIXDTY','STATIC_ln_dep_typ.jsp')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="ayuda" align="absbottom" border="0" ></a></div>
            </td>
          </tr>
          <tr id="trclear"> 
            <td nowrap width="21%" > 
      ...
      <td nowrap> 
        <table width="100%">
          ...
          <tr id="trclear"> 
            <td nowrap  colspan="2"> 
              <div align="center">
              	<input type="text" name="E01FIXMDP" size="20" maxlength="19" value="<%= fix.getE01FIXMDP().trim()%>">
              </div>
            </td>
            <td nowrap > 
              <div align="center">
              	<input type="text" name="E01FIXADP" size="20" maxlength="19" value="<%= fix.getE01FIXADP().trim()%>">
              </div>
            </td>
            <td nowrap >
              <div align="center">
              	<input type="text" name="E01FIXBKV" size="20" maxlength="19" value="<%= fix.getE01FIXBKV().trim()%>">
              </div>
            </td>
            <td nowrap > 
              <div align="center">
              	<input type="text" name="E01FIXLDM" size="3" maxlength="2" value="<%= fix.getE01FIXLDM().trim()%>">
              	<input type="text" name="E01FIXLDD" size="3" maxlength="2" value="<%= fix.getE01FIXLDD().trim()%>">
              	<input type="text" name="E01FIXLDY" size="3" maxlength="2" value="<%= fix.getE01FIXLDY().trim()%>">
              </div>
            </td>
          </tr>
        </table>
