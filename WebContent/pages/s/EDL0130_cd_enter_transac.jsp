...
<h3 align="center">Transacciones de Certificados de Dep&oacute;sito<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="cd_enter_transac,EDL0130"></h3>
<hr size="4">
<p>&nbsp;</p>
		  ...
		  <tr><td>&nbsp;</td></tr>
		   <tr><td>&nbsp;</td></tr>
            ...
            <td nowrap width="50%"> 
              ...
              <a href="javascript:GetAccount('E03DEAACC','','CD','')"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="Numero de Certificado" align="absbottom" border="0" ></a> 
            </td>
          </tr>
        </table>
      </td>
