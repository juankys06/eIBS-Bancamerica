...
<jsp:useBean id= "prefere" class= "datapro.eibs.beans.EWD038001Message"   scope="session"/>
...
<H3 align="center">Tramos y Tasas Preferenciales<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="limits_parameters.jsp, EWD0380"></H3>
<hr size="4">
<form method="post" action="<%=request.getContextPath()%>/servlet/datapro.eibs.helps.JSEWD0380" >
      ...
      <td nowrap> 
        <table cellspacing="0" cellpadding="2" width="100%" border="0" class="tbhead">
          <tr id="trdark"> 
            ...
            <td nowrap colspan="3" > 
              <div align="left">
                <input type="text" name="E01TASDTE" size="11" maxlength="10" value="<%= prefere.getE01TASDTE().trim()%>">
              </div>
            </td>
          </tr>
        </table>
