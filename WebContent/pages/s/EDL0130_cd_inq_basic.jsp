  ...
  <table class=tbenter>
   <tr > 
      ...
      <td nowrap align=left> 
   		<b>GARANTIA :<font color="#ff6600"> <% 	if (cdMant.getE02COLATR().trim().equals("") )
        ...
        <table cellspacing=0 cellpadding=2 width="100%" border="0">
          <tr id="trclear"> 
            ...
            <td nowrap width="31%" height="35"> 
              <input type="text" name="E02DEANME" size="81" maxlength="80" value="<%= cdMant.getE02DEANME().trim()%>" readonly>
            </td>
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="31%" height="23"> 
              <input type="text" name="E02DEAIFL" size="2" maxlength="1" value="<%= cdMant.getE02DEAIFL().trim()%>" readonly>
            </td>
            <td nowrap width="20%" height="23"> 
            ...
            <td nowrap width="23%" height="23"> 
              ...
              <input type="text" name="E02DEAFTY" size="20" 
				  value="<% if (cdMant.getE02DEAFTY().equals("FP")) out.print("Primaria Flotante");
							else if (cdMant.getE02DEAFTY().equals("FS")) out.print("Secundaria Flotante");
							else out.print("");%>" 
				readonly>
            </td>
          </tr>
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="23%" height="19">
              <input type="text" name="E02DEAGLN" size="20" maxlength="16" value="<%= cdMant.getE02DEAGLN().trim()%>" readonly>
            </td>
          </tr>
          <tr id="trdark"> 
            <td nowrap width="26%" height="19"> 
          ...
          <tr id="trdark">
            ...
            <td nowrap>
           <input type="text" name="E02DEASOF" size="13" 
				  value="<% if (cdMant.getE02DEASOF().equals("1")) out.print("Electronica");
							else if (cdMant.getE02DEASOF().equals("2")) out.print("Impreso");
            ...
            <td nowrap width="23%">           
              <input type="text" name="E02DEABNK" size="2" maxlength="2" value="<%= cdMant.getE02DEABNK().trim()%>" readonly>
              <input type="text" name="E02DEABRN" size="2" maxlength="3" value="<%= cdMant.getE02DEABRN().trim()%>" readonly>
            </td>      
          </tr>
        </table>
      </td>
