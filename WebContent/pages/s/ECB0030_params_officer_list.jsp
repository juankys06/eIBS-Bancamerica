    ...
    if (opt == "D") {
	  ...
	  if (ok) document.forms[0].submit();
    	...
    	page = "<%=request.getContextPath()%>/pages/s/ECB0030_params_officer_maint.jsp?ROW=" + row;
  	    ...
  	    //page = "<%=request.getContextPath()%>/pages/s/ECB0030_params_officer_new.jsp";
...
<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="params_officer_list.jsp,ECB0030">
</h3>
<hr size="4">
    ...
    <TD NOWRAP valign=top>
     ...
     %>               
        <TR>
			...
			<TD NOWRAP ALIGN="CENTER"><%=Util.formatDate(msgMT.getE01ECBDT1())%></TD>
			<TD NOWRAP ALIGN="CENTER"><%=Util.formatTime(msgMT.getE01ECBTIM())%></TD>
			<TD NOWRAP ALIGN="LEFT"><%=Util.formatCell(msgMT.getE01ECBNA0())%></TD>
			<TD NOWRAP ALIGN="CENTER"><%=Util.formatCell(msgMT.getE01ECBUSR())%></TD>
