...
<h3 align="center">Tasas Flotantes Mantenimiento<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="rt_tables_maint,EDL0110F" ></h3>
<hr size="4">
