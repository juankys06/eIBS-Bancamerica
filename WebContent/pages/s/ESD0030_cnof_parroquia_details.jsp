          ...
          <tr id="trclear" >
            ...
            <td nowrap height="23"> 
              <div align="left"> 
                ...
                <a href="javascript:GetCNOFCFilteredCodes('MNCODE','MNDSC', form1.STATECODE.value ,'85')" onblur="document.all.MNDSCL.innerHTML = form1.MNDSC.value" >
                <img src="<%=request.getContextPath()%>/images/1b.gif" alt="ayuda" align="absbottom" border="0"></a> 
				<SPAN id="MNDSCL" ></SAPAN>
              </div>
            </td>
          </tr>
