...
<H3 align="center">Consulta de Emisi&oacute;n Cheques de Gerencia por Desembolso de Préstamos<img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="of_chk_basic_lns_inq.jsp, EOF0115"> 
</H3>
<hr size="4">
        ...
        <table cellspacing=0 cellpadding=2 width="100%" border="0">
          <tr id="trdark"> 
            ...
            <td nowrap width="27%">
              ...
              <input type="text" readonly name="E01OFMCKN" size="9" maxlength="9" value="<%= offBasic.getE01OFMCKN().trim()%>" >
          ...
          <tr id="trclear"> 
			...
			<td nowrap colspan="3">
            	<input type="text" readonly name="E01OFMBNF" size="36" maxlength="35" value="<%= offBasic.getE01OFMBNF().trim()%>"><br>
            	<input type="text" readonly name="E01OFMBN1" size="36" maxlength="35" value="<%= offBasic.getE01OFMBN1().trim()%>"><br>
            	<input type="text" readonly name="E01OFMBN2" size="36" maxlength="35" value="<%= offBasic.getE01OFMBN2().trim()%>">
          ...
          <tr id="trdark"> 
            ...
            <INPUT type="text" readonly name="E01OFMBID" size="15" maxlength="15"
          ...
          <tr id="trclear"> 
            ...
            <td nowrap height="19" colspan="3"> 
              <input type="text" readonly name="E01OFMAMT" size="22" maxlength="20" value="<%= offBasic.getE01OFMAMT().trim()%>" onKeypress="enterDecimal()">
            </td>
          </tr>
        </table>
      </td>
...
<%			if (!offBasic.getE01SELFMT().equals("1")) {  %>
            ...
            <td nowrap colspan="3"> 
              <input type="text" readonly name="E01OFMCO1" size="41" maxlength="40" value="<%= offBasic.getE01OFMCO1().trim()%>">
            </td>
          </tr>
...
<%			} else {	%>
            ...
            <td nowrap colspan="3"> 
              <input type="text" readonly name="E01OFMCO1" size="61" maxlength="60" value="<%= offBasic.getE01OFMCO1().trim()%>">
            </td>
          </tr>
          ...
          <tr id="trclear"> 
          	  ...
          	  <table class="tableinfo" style="filter:''">
          		...
          		<tr id="trclear"> 
            		...
            		<td width="13%"> 
              		<div align="center"> 
                		<input readonly type="text" name="E01DEBBRN" size="3" maxlength="3" value="<%= offBasic.getE01DEBBRN().trim()%>">
              		</div>
            		</td>
            		<td width="12%" > 
              		<div align="center">
