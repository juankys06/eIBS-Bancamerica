...
%>
<h3 align="center"> <%= sTitle%><img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" alt="fe_basic_forward.jsp,EFE0120P"> 
</h3>
<hr size="4">
          ...
          <tr id="trdark"> 
          	<% if(fex.getH01FLGWK3().equals("Y")){%>
            	...
            	<td nowrap > 
              		...
              		<a href="javascript:GetClassFex('E01FESCLS','FWR',document.forms[0].E01FESCCY.value)"><img src="<%=request.getContextPath()%>/images/1b.gif" alt="help" align="absmiddle" border="0" ></a> 
            	</td> 
             <%}%>
            <td nowrap  colspan="5" > 
              <div align="right"></div>
