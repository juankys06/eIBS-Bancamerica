...
%> 
<h3 align="center">Titulares <%= userPO.getHeader4().trim()%><img src="<%=request.getContextPath()%>/images/e_ibs.gif" align="left" name="EIBS_GIF" ALT="dft_ap_tit.jsp, EDL0800"></h3>
<hr size="4">
      ...
      <td nowrap> 
        <table id="headTable" width="100%">
          ...
          <tr id="trclear"> 
            ...
            <td nowrap width="18%"> 
              <div align="center"> 
                <input type="text" name="E06TY<%= name %>" size="2"  maxlength="1" readonly>
              </div>
            </td>
          </tr>
          <%}%> 
