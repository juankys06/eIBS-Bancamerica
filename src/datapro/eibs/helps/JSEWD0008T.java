...
public class JSEWD0008T extends datapro.eibs.master.SuperServlet {
	...
	public void service(HttpServletRequest req, HttpServletResponse res)
		...
		if (session == null) {
			...
			try {
				...
				try {
					msgHelp =
						(EWD0008DSMessage) mc.getMessageRecord("EWD0008DS");
					...
					if (newmessage.getFormatName().equals("EWD0008DS")) {
						...
						try {
							flexLog(
								"About to call Page: "
									+ LangPath
									+ "EWD0008T_client_help_helpmessage.jsp");
							callPage(
								LangPath
									+ "EWD0008T_client_help_helpmessage.jsp",
								req,
