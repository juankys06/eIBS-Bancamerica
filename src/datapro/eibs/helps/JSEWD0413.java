...
public class JSEWD0413 extends datapro.eibs.master.SuperServlet {
			...
			try {
				...
				try {
					...
					if (newmessage.getFormatName().equals("EWD0413DS")) {
						...
						try {
							flexLog("About to call Page: " + LangPath + "EWD0413_cc_helpmessage.jsp");
							callPage(LangPath + "EWD0413_cc_helpmessage.jsp",	req, res);
						} catch (Exception e) {
