...
public class JSEWD0325 extends datapro.eibs.master.SuperServlet {
		...
		if (session == null) {
			...
			try {
				...
				try {
					...
					msgHelp.setSWDTYP("");
					msgHelp.setRWDTYP("D");
					msgHelp.setSWDDID(msgUser.getH01USR());
					msgHelp.send();
					msgHelp.destroy();
					...
					if (newmessage.getFormatName().equals("EWD0325DS")) {
						...
						try {
							flexLog(
								"About to call Page: "
									+ LangPath
									+ "EWD0325_fe_ref_helpmessage.jsp");
							callPage(
								LangPath + "EWD0325_fe_ref_helpmessage.jsp",
								req,
								res);
						} catch (Exception e) {
