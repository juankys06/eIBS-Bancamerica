...
public class JSEWD0005Cust extends datapro.eibs.master.SuperServlet {

	/**
	 * Insert the method's description here.
	 * Creation date: (1/14/00 12:29:44 PM)
	 */
	public JSEWD0005Cust() {
		super();
	}
	/**
		...
		if (session == null) {
			...
			try {
				...
				try {
					...
					try {
						msgHelp.setEWDOAC(req.getParameter("shrOldAcc"));
					} catch (Exception e) {
						msgHelp.setEWDOAC("0");
					}					
					//search by Client
					...
					if (newmessage.getFormatName().equals("EWD0005DS")) {
						...
						try {
							...
							flexLog(
								"About to call Page: "
									+ LangPath
									+ "EWD0005C_client_help_helpmessage.jsp");
							callPage(
								LangPath
									+ "EWD0005C_client_help_helpmessage.jsp",
								req,
