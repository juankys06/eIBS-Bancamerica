...
public class JSEWD0091 extends datapro.eibs.master.SuperServlet {
	...
	public void service(HttpServletRequest req, HttpServletResponse res)
		...
		if (session == null) {
			...
			try {
				...
				try {
					msgHelp =
						(EWD0091DSMessage) mc.getMessageRecord("EWD0091DS");
					...
					try{
					 msgHelp.setEWDCOD(req.getParameter("shrCode"));
					} catch (Exception e) {
					}
					
					msgHelp.send();
					msgHelp.destroy();
					flexLog("EWD0091DS Message Sent");
				} catch (Exception e) {
					e.printStackTrace();
					flexLog("Error: " + e);
				...
				try {
					...
					if (newmessage.getFormatName().equals("EWD0091DS")) {

						try {
							beanList = new JBList();
							flexLog("EWD0091DS Message Received");
						} catch (Exception ex) {
							flexLog("Error: " + ex);
						}
						...
						while (true) {
							...
							msgHelp = (EWD0091DSMessage) newmessage;
						...
						try {
							...
							flexLog(
								"About to call Page: "
									+ LangPath
									+ "EWD0091_client_help_helpmessage.jsp");
							callPage(
								LangPath
									+ "EWD0091_client_help_helpmessage.jsp",
								req,
