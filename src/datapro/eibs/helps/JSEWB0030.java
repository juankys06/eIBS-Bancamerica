...
public class JSEWB0030 extends datapro.eibs.master.SuperServlet {
	...
	public void destroy() {
		...
		flexLog("free resources used by JSEWB0030");
		...
		if (ses == null) {
			...
			try {
				...
				try {
					...
					try {
						flexLog("About to call Page: " + LangPath + "EWB0030_safe_deposit_locations_help.jsp");
						callPage(LangPath + "EWB0030_safe_deposit_locations_help.jsp", req, res);						
					} catch (Exception e) {
