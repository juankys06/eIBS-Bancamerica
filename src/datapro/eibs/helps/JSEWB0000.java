...
public class JSEWB0000 extends datapro.eibs.master.SuperServlet {
	...
	public void destroy() {
		...
		flexLog("free resources used by JSEWB0000");
		...
		if (ses == null) {
			...
			try {
				...
				try {
					...
					try {
						flexLog("About to call Page: " + LangPath + "EWB0000_safe_deposit_fee_help.jsp");
						callPage(LangPath + "EWB0000_safe_deposit_fee_help.jsp", req, res);						
					} catch (Exception e) {
