...
public class JSEWD0030 extends datapro.eibs.master.SuperServlet {
	...
	public void service(HttpServletRequest req, HttpServletResponse res)
		...
		if (session == null) {
			...
			try {
				...
				try {
					msgHelp =
						(EWD0030DSMessage) mc.getMessageRecord("EWD0030DS");
					try {
						msgHelp.setEWDSHR(
					...
					msgHelp.send();
					msgHelp.destroy();
					flexLog("EWD0030DS Message Sent");
				} catch (Exception e) {
					e.printStackTrace();
					flexLog("Error: " + e);
				...
				try {
					...
					if (newmessage.getFormatName().equals("EWD0030DS")) {
						...
						while (true) {
							...
							msgHelp = (EWD0030DSMessage) newmessage;
						...
						try {
							...
							flexLog(
								"About to call Page: "
									+ LangPath
									+ "EWD0030_vendor_help_helpmessage.jsp");
							callPage(
								LangPath
									+ "EWD0030_vendor_help_helpmessage.jsp",
								req,
