...
public class JSESD0817 extends datapro.eibs.master.SuperServlet {
	  	...
	  	if (newmessage.getFormatName().equals("ELEERR")) {
			...
			ses.setAttribute("lcBalances", msgHeader);
	  		...
	  		if (newmessage.getFormatName().equals("ESD081701")) {
				...
				try {
					 flexLog("About to call Page: " + LangPath + "ESD0817_lc_list_fp.jsp");
					 callPage(LangPath + "ESD0817_lc_list_fp.jsp", req, res);
				}
				catch (Exception e) {
					flexLog("Exception calling page " + e);
				}
	...
	try
	{
	  	...
	  	if (newmessage.getFormatName().equals("ELEERR")) {
			...
			if (newmessage.getFormatName().equals("ESD081701")) {
				...
				try {
					 flexLog("About to call Page: " + LangPath + "ESD0817_lc_list_print_fp.jsp");
					 callPage(LangPath + "ESD0817_lc_list_print_fp.jsp", req, res);
				}
				catch (Exception e) {
					flexLog("Exception calling page " + e);
				}
