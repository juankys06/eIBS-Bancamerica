...
public class JSELC0455 extends datapro.eibs.master.SuperServlet {
	...
	try
	{
	  	...
	  	if (newmessage.getFormatName().equals("ELEERR")) {
			...
			if (userPO.getPurpose().equals("INQUIRY")){
			 	try {
					flexLog("About to call Page: " + LangPath + "ELC0450_lc_inq_basic.jsp");
					callPage(LangPath + "ELC0450_lc_inq_basic.jsp", req, res);
				 }
				 catch (Exception e) {
		 		...
		 		try {
					flexLog("About to call Page: " + LangPath + "ESD0817_lc_enter_stat.jsp");
					callPage(LangPath + "ESD0817_lc_enter_stat.jsp", req, res);
		 		}
		 		catch (Exception e) {
					flexLog("Exception calling page " + e);
		 		}			
			...
			try {
				 flexLog("About to call Page: " + LangPath + "ELC0455_lc_list_doc_det.jsp");
				 callPage(LangPath + "ELC0455_lc_list_doc_det.jsp", req, res);
			}
			catch (Exception e) {
				flexLog("Exception calling page " + e);
			}
...
protected void procReqList(MessageContext mc, ESS0030DSMessage user, HttpServletRequest req, HttpServletResponse res, HttpSession ses)
	...
	try
	{
	  	...
	  	if (newmessage.getFormatName().equals("ELEERR")) {
			...
			try {
				 flexLog("About to call Page: " + LangPath + "ELC0455_lc_list_doc.jsp");
				 callPage(LangPath + "ELC0455_lc_list_doc.jsp", req, res);
			}
			catch (Exception e) {
				flexLog("Exception calling page " + e);
			}
