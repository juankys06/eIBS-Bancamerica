...
public class JSEGL0420 extends datapro.eibs.master.SuperServlet {
	 ...
	 */
	protected void procActionSelection(MessageContext mc,
				...
				if (newmessage.getFormatName().equals("EGL042001")) {
					...
					while (true) {
						...
						if (marker.equals("*")) {
							...
							if (firstTime) {
								firstTime = false;
								int pos = Integer.parseInt(msgList
										.getE01NUMREC());
							...
							DT1 = (userPO.getHeader8().equals("B")) ? msgList
									.getE01DATE11() : msgList.getE01DATE21();
							DT2 = (userPO.getHeader8().equals("B")) ? msgList
									.getE01DATE12() : msgList.getE01DATE22();
							DT3 = (userPO.getHeader8().equals("B")) ? msgList
									.getE01DATE13() : msgList.getE01DATE23();
							...
							if (userPO.getHeader8().equals("B")) {
								myRow
										.append("<TD NOWRAP ALIGN=\"CENTER\"><A HREF=\"javascript:GetBatchDet('"
							...
							if (msgList.getE01TRADRR().equals("0")) {
								...
								myRow
										.append("<TD NOWRAP><A HREF=\"javascript:GetStatDesc('"
					...
					try {
						if (msgList.getE01VALBTH().equals("V")) {
							...
							callPage(LangPath + "EGL0420_st_list_fv.jsp", req,
									res);
						} else if (msgList.getE01VALBTH().equals("B")) {
							flexLog("About to call Page: " + LangPath
									+ "EGL0420_st_list_fp.jsp");
							callPage(LangPath + "EGL0420_st_list_fp.jsp", req,
									res);
						}
					} catch (Exception e) {
						flexLog("Exception calling page " + e);
				...
				if (newmessage.getFormatName().equals("EGL042001")) {
					...
					while (true) {
						...
						if (marker.equals("*")) {
							...
							myRow = new StringBuffer("<TR>");
							myRow.append("<TD NOWRAP ALIGN=\"CENTER\">"
									+ Util.formatDate(msgList.getE01DATE11(),
											msgList.getE01DATE12(), msgList
													.getE01DATE13()) + "</TD>");
							myRow.append("<TD NOWRAP ALIGN=\"RIGHT\">"
									+ Util.formatCell(msgList.getE01TRAACC())
									+ "</TD>");
							if (msgList.getE01NUMNAR().equals("0")) {
								...
								if (msgList.getE01NUMNAR().trim().equals("1")) {
									myRow.append("<TD NOWRAP>"
											...
											+ Util.formatCell(msgList
													.getE01TRANA1()) + "</TD>");
								} else if (msgList.getE01NUMNAR().trim()
										.equals("2")) {
									myRow.append("<TD NOWRAP>"
											+ Util.formatCell(msgList
													.getE01TRANAR())
					...
					try {
						if (msgList.getE01VALBTH().equals("V")) {
							...
							callPage(LangPath + "EGL0420_st_list_print_fv.jsp",
									req, res);
						} else if (msgList.getE01VALBTH().equals("B")) {
							flexLog("About to call Page: " + LangPath
									+ "EGL0420_st_list_print_fp.jsp");
							callPage(LangPath + "EGL0420_st_list_print_fp.jsp",
									req, res);
						}
					} catch (Exception e) {
						flexLog("Exception calling page " + e);
	 ...
	 */
	protected void procReqSelection(ESS0030DSMessage user,
			HttpServletRequest req, HttpServletResponse res, HttpSession ses)
			throws ServletException, IOException {
