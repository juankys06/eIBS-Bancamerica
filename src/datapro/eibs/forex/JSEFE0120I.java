	...
	try
	{
		...
		if (newmessage.getFormatName().equals("EFE0120DS")) {
			...
			if (IsNotError) {  // There are no errors
				if(ACD.equals("34")){
					try {
						flexLog("About to call Page: " + LangPath + "EFE0120I_fe_basic_opt.jsp");
					...
					try {
						flexLog("About to call Page: " + LangPath + "EFE0120I_fe_basic_sf.jsp");
					...
					try {
						flexLog("About to call Page: " + LangPath + "EFE0120I_fe_basic_forward.jsp");
					...
					try {
						flexLog("About to call Page: " + LangPath + "EFE0120I_fe_basic_swap.jsp");
					...
					try {
						flexLog("About to call Page: " + LangPath + "EFE0120I_fe_basic_fast_spot.jsp");
