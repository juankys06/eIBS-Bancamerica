...
* 
* File level identifier is 1070519141913.
* Record format level identifier is 3D3393AE831AF.
*/
...
public class ELC052501Message extends MessageRecord
{
  ...
  final static String fid = "1070519141913";
  final static String rid = "3D3393AE831AF";
  ...
  */
  protected void createFields()
  {
    ...
    new DecimalField(message, HEADERSIZE + 151, 17, 2, "E01LCMAMN");
    fields[20] = fieldE01LCMUBT =
    new DecimalField(message, HEADERSIZE + 168, 5, 0, "E01LCMUBT");
    fields[21] = fieldE01LCMOPR =
    new CharacterField(message, HEADERSIZE + 173, 10, "E01LCMOPR");
    fields[22] = fieldE01LCMATY =
    new CharacterField(message, HEADERSIZE + 183, 4, "E01LCMATY");
    fields[23] = fieldE01LCMTYP =
    new CharacterField(message, HEADERSIZE + 187, 1, "E01LCMTYP");
    fields[24] = fieldE01LCMOPT =
    new CharacterField(message, HEADERSIZE + 188, 1, "E01LCMOPT");
    fields[25] = fieldE01REMARK =
    new CharacterField(message, HEADERSIZE + 189, 20, "E01REMARK");
    fields[26] = fieldE01DSCPRO =
    new CharacterField(message, HEADERSIZE + 209, 15, "E01DSCPRO");
