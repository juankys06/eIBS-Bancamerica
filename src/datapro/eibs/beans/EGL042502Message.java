...
/**
* Class generated by AS/400 CRTCLASS command from EGL042502 physical file definition.
* 
* File level identifier is 1040726202836.
* Record format level identifier is 3A36A4F529070.
*/

public class EGL042502Message extends MessageRecord
{
  ...
  final static String fid = "1040726202836";
  final static String rid = "3A36A4F529070";
  final static String fmtname = "EGL042502";
  ...
  /**
  * Constructor for EGL042502Message.
  */
  public EGL042502Message()
  {
    createFields();
    initialize();
  }
  ...
  */
  protected void createFields()
  {
    ...
    fields[12] = fieldE02GLMATY =
    new CharacterField(message, HEADERSIZE + 64, 4, "E02GLMATY");
    fields[13] = fieldE02GLMACD =
    new CharacterField(message, HEADERSIZE + 68, 2, "E02GLMACD");
    fields[14] = fieldE02GLMCLS =
    new DecimalField(message, HEADERSIZE + 70, 3, 0, "E02GLMCLS");
    fields[15] = fieldE02GLMDSC =
    new CharacterField(message, HEADERSIZE + 73, 35, "E02GLMDSC");
    fields[16] = fieldE02GLMRCL =
    new CharacterField(message, HEADERSIZE + 108, 1, "E02GLMRCL");
    fields[17] = fieldE02GLMCCN =
    new CharacterField(message, HEADERSIZE + 109, 1, "E02GLMCCN");
    fields[18] = fieldE02GLBBAL =
    new DecimalField(message, HEADERSIZE + 110, 17, 2, "E02GLBBAL");
    fields[19] = fieldE02GLBAVG =
    new DecimalField(message, HEADERSIZE + 127, 17, 2, "E02GLBAVG");
    fields[20] = fieldE02GLBOP1 =
    new DecimalField(message, HEADERSIZE + 144, 3, 0, "E02GLBOP1");
    fields[21] = fieldE02GLBOP2 =
    new DecimalField(message, HEADERSIZE + 147, 3, 0, "E02GLBOP2");
    fields[22] = fieldE02GLBOP3 =
    new DecimalField(message, HEADERSIZE + 150, 3, 0, "E02GLBOP3");
    fields[23] = fieldE02GLBLU1 =
    new DecimalField(message, HEADERSIZE + 153, 3, 0, "E02GLBLU1");
    fields[24] = fieldE02GLBLU2 =
    new DecimalField(message, HEADERSIZE + 156, 3, 0, "E02GLBLU2");
    fields[25] = fieldE02GLBLU3 =
    new DecimalField(message, HEADERSIZE + 159, 3, 0, "E02GLBLU3");
    fields[26] = fieldE02DSCCLS =
    new CharacterField(message, HEADERSIZE + 162, 35, "E02DSCCLS");
    fields[27] = fieldE02DSCATY =
    new CharacterField(message, HEADERSIZE + 197, 35, "E02DSCATY");
