...
* Record format level identifier is 51D17798B7E21.
*/
...
public class ETR0130DSMessage extends MessageRecord
{
  ...
  final static String rid = "51D17798B7E21";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 200, 4, "E01WFROF2");
    fields[35] = fieldE01WFRGRC =
    new CharacterField(message, HEADERSIZE + 204, 4, "E01WFRGRC");
    fields[36] = fieldE01WFRGEC =
    new CharacterField(message, HEADERSIZE + 208, 4, "E01WFRGEC");
    fields[37] = fieldE01WFRBUC =
    new CharacterField(message, HEADERSIZE + 212, 4, "E01WFRBUC");
    fields[38] = fieldE01WFRIND =
    new CharacterField(message, HEADERSIZE + 216, 4, "E01WFRIND");
    fields[39] = fieldE01WFRCST =
    new DecimalField(message, HEADERSIZE + 220, 9, 0, "E01WFRCST");
    fields[40] = fieldE01WFRPVI =
    new CharacterField(message, HEADERSIZE + 229, 1, "E01WFRPVI");
    fields[41] = fieldE01WFRCFT =
    new CharacterField(message, HEADERSIZE + 230, 1, "E01WFRCFT");
    fields[42] = fieldE01WFRHEF =
    new CharacterField(message, HEADERSIZE + 231, 1, "E01WFRHEF");
    fields[43] = fieldE01WFRHEM =
    new DecimalField(message, HEADERSIZE + 232, 13, 0, "E01WFRHEM");
    fields[44] = fieldE01WFROT1 =
    new CharacterField(message, HEADERSIZE + 245, 60, "E01WFROT1");
    fields[45] = fieldE01WFROT2 =
    new CharacterField(message, HEADERSIZE + 305, 60, "E01WFROT2");
    fields[46] = fieldD01WFRCP1 =
    new CharacterField(message, HEADERSIZE + 365, 35, "D01WFRCP1");
    fields[47] = fieldD01WFRCP2 =
    new CharacterField(message, HEADERSIZE + 400, 35, "D01WFRCP2");
    fields[48] = fieldD01WFRCP3 =
    new CharacterField(message, HEADERSIZE + 435, 35, "D01WFRCP3");
    fields[49] = fieldD01LIMAMT =
    new DecimalField(message, HEADERSIZE + 470, 17, 2, "D01LIMAMT");
    fields[50] = fieldD01LIMAVL =
    new DecimalField(message, HEADERSIZE + 487, 17, 2, "D01LIMAVL");
    fields[51] = fieldD01LIMEND =
    new DecimalField(message, HEADERSIZE + 504, 17, 2, "D01LIMEND");
    fields[52] = fieldD01FEOLIM =
    new DecimalField(message, HEADERSIZE + 521, 17, 2, "D01FEOLIM");
    fields[53] = fieldD01FEOAVL =
    new DecimalField(message, HEADERSIZE + 538, 17, 2, "D01FEOAVL");
    fields[54] = fieldD01FEOEND =
    new DecimalField(message, HEADERSIZE + 555, 17, 2, "D01FEOEND");
    fields[55] = fieldD01USRDSC =
    new CharacterField(message, HEADERSIZE + 572, 30, "D01USRDSC");
    fields[56] = fieldD01APCDSC =
    new CharacterField(message, HEADERSIZE + 602, 78, "D01APCDSC");
