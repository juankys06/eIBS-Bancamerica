...
* 
* File level identifier is 1030121191924.
* Record format level identifier is 4A1B8FF517334.
*/
...
public class EGC049001Message extends MessageRecord
{
  ...
  final static String fid = "1030121191924";
  final static String rid = "4A1B8FF517334";
  ...
  */
  protected void createFields()
  {
    ...
    new DecimalField(message, HEADERSIZE + 63, 10, 0, "E01SELCUN");
    fields[12] = fieldE01SELACC =
    new DecimalField(message, HEADERSIZE + 73, 13, 0, "E01SELACC");
    fields[13] = fieldE01NUMREC =
    new DecimalField(message, HEADERSIZE + 86, 8, 0, "E01NUMREC");
