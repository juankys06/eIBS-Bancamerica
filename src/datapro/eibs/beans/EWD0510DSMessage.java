...
* 
* File level identifier is 1050414211459.
* Record format level identifier is 474A344B84ED8.
*/
...
public class EWD0510DSMessage extends MessageRecord
{
  ...
  final static String fid = "1050414211459";
  final static String rid = "474A344B84ED8";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 10, 10, "EWDUSR");
    fields[4] = fieldEWDSUB =
    new CharacterField(message, HEADERSIZE + 20, 4, "EWDSUB");
    fields[5] = fieldEWDSUN =
    new CharacterField(message, HEADERSIZE + 24, 35, "EWDSUN");
    fields[6] = fieldEWDLOT =
    new DecimalField(message, HEADERSIZE + 59, 13, 0, "EWDLOT");
    fields[7] = fieldEWDINI =
    new DecimalField(message, HEADERSIZE + 72, 13, 0, "EWDINI");
    fields[8] = fieldEWDFIN =
    new DecimalField(message, HEADERSIZE + 85, 13, 0, "EWDFIN");
    fields[9] = fieldEWDBAL =
    new DecimalField(message, HEADERSIZE + 98, 8, 0, "EWDBAL");
    fields[10] = fieldEWDCHK =
    new DecimalField(message, HEADERSIZE + 106, 13, 0, "EWDCHK");
    fields[11] = fieldEWDOPE =
    new CharacterField(message, HEADERSIZE + 119, 1, "EWDOPE");
