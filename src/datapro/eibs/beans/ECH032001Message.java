...
* 
* File level identifier is 1060822183642.
* Record format level identifier is 3A10F18C593E8.
*/
...
public class ECH032001Message extends MessageRecord
{
  ...
  final static String fid = "1060822183642";
  final static String rid = "3A10F18C593E8";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 42, 2, "BANK");
    fields[10] = fieldE01SELBRN =
    new DecimalField(message, HEADERSIZE + 44, 4, 0, "BRANCH");
    ...
    new CharacterField(message, HEADERSIZE + 68, 2, "BANK");
    fields[20] = fieldE01CHMBRN =
    new DecimalField(message, HEADERSIZE + 70, 4, 0, "BRANCH");
    fields[21] = fieldE01CHMCCY =
    new CharacterField(message, HEADERSIZE + 74, 3, "CURRENCY");
    fields[22] = fieldE01CHMACC =
    new DecimalField(message, HEADERSIZE + 77, 13, 0, "ACCOUNT");
    fields[23] = fieldE01CHMACD =
    new CharacterField(message, HEADERSIZE + 90, 2, "APLICATION");
    fields[24] = fieldE01CHMPRO =
    new CharacterField(message, HEADERSIZE + 92, 4, "PRODUCT");
    fields[25] = fieldE01CHMCUN =
    new DecimalField(message, HEADERSIZE + 96, 10, 0, "CUSTOMER");
    fields[26] = fieldE01CHMNA1 =
    new CharacterField(message, HEADERSIZE + 106, 45, "NAME");
    fields[27] = fieldE01CHMOFC =
    new CharacterField(message, HEADERSIZE + 151, 4, "CODE");
    fields[28] = fieldE01DSCOFC =
    new CharacterField(message, HEADERSIZE + 155, 35, "DESCRIPTION");
    ...
    new DecimalField(message, HEADERSIZE + 199, 5, 0, "LAST");
    fields[33] = fieldE01CHMTCB =
    new DecimalField(message, HEADERSIZE + 204, 3, 0, "CHECK");
    fields[34] = fieldE01CHMICK =
    new DecimalField(message, HEADERSIZE + 207, 10, 0, "CHECK");
    fields[35] = fieldE01CHMFCK =
    new DecimalField(message, HEADERSIZE + 217, 10, 0, "CHECK");
    fields[36] = fieldE01CHMNTC =
    new DecimalField(message, HEADERSIZE + 227, 5, 0, "NO.");
    fields[37] = fieldE01CHMDBR =
    new DecimalField(message, HEADERSIZE + 232, 4, 0, "BRANCH");
    fields[38] = fieldE01CHMDES =
    new DecimalField(message, HEADERSIZE + 236, 4, 0, "BRANCH");
    fields[39] = fieldE01CHMACT =
    new CharacterField(message, HEADERSIZE + 240, 1, "ACTION");
    fields[40] = fieldE01OPECDE =
    new CharacterField(message, HEADERSIZE + 241, 1, "LAST");
