...
* 
* File level identifier is 1040329165917.
* Record format level identifier is 3A11418C593E8.
*/
...
public class ECH032501Message extends MessageRecord
{
  ...
  final static String fid = "1040329165917";
  final static String rid = "3A11418C593E8";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 48, 1, "E01SELOSTA");
    fields[12] = fieldE01SELFSTA =
    new CharacterField(message, HEADERSIZE + 49, 1, "E01SELFSTA");
    fields[13] = fieldE01SELID1 =
    new DecimalField(message, HEADERSIZE + 50, 3, 0, "E01SELID1");
    fields[14] = fieldE01SELID2 =
    new DecimalField(message, HEADERSIZE + 53, 3, 0, "E01SELID2");
    fields[15] = fieldE01SELID3 =
    new DecimalField(message, HEADERSIZE + 56, 3, 0, "E01SELID3");
    fields[16] = fieldE01SELFD1 =
    new DecimalField(message, HEADERSIZE + 59, 3, 0, "E01SELFD1");
    fields[17] = fieldE01SELFD2 =
    new DecimalField(message, HEADERSIZE + 62, 3, 0, "E01SELFD2");
    fields[18] = fieldE01SELFD3 =
    new DecimalField(message, HEADERSIZE + 65, 3, 0, "E01SELFD3");
    fields[19] = fieldE01CHMBNK =
    new CharacterField(message, HEADERSIZE + 68, 2, "E01CHMBNK");
    fields[20] = fieldE01CHMBRN =
    new DecimalField(message, HEADERSIZE + 70, 4, 0, "E01CHMBRN");
    fields[21] = fieldE01CHMCCY =
    new CharacterField(message, HEADERSIZE + 74, 3, "E01CHMCCY");
    fields[22] = fieldE01CHMACC =
    new DecimalField(message, HEADERSIZE + 77, 13, 0, "E01CHMACC");
    fields[23] = fieldE01CHMACD =
    new CharacterField(message, HEADERSIZE + 90, 2, "E01CHMACD");
    fields[24] = fieldE01CHMPRO =
    new CharacterField(message, HEADERSIZE + 92, 4, "E01CHMPRO");
    fields[25] = fieldE01CHMCUN =
    new DecimalField(message, HEADERSIZE + 96, 10, 0, "E01CHMCUN");
    fields[26] = fieldE01CHMNA1 =
    new CharacterField(message, HEADERSIZE + 106, 45, "E01CHMNA1");
    fields[27] = fieldE01CHMOFC =
    new CharacterField(message, HEADERSIZE + 151, 4, "E01CHMOFC");
    fields[28] = fieldE01DSCOFC =
    new CharacterField(message, HEADERSIZE + 155, 35, "E01DSCOFC");
    fields[29] = fieldE01CHMRQ1 =
    new DecimalField(message, HEADERSIZE + 190, 3, 0, "E01CHMRQ1");
    fields[30] = fieldE01CHMRQ2 =
    new DecimalField(message, HEADERSIZE + 193, 3, 0, "E01CHMRQ2");
    fields[31] = fieldE01CHMRQ3 =
    new DecimalField(message, HEADERSIZE + 196, 3, 0, "E01CHMRQ3");
    fields[32] = fieldE01CHMNCB =
    new DecimalField(message, HEADERSIZE + 199, 5, 0, "E01CHMNCB");
    fields[33] = fieldE01CHMTCB =
    new DecimalField(message, HEADERSIZE + 204, 3, 0, "E01CHMTCB");
    fields[34] = fieldE01CHMICK =
    new DecimalField(message, HEADERSIZE + 207, 10, 0, "E01CHMICK");
    fields[35] = fieldE01CHMFCK =
    new DecimalField(message, HEADERSIZE + 217, 10, 0, "E01CHMFCK");
    fields[36] = fieldE01CHMNTC =
    new DecimalField(message, HEADERSIZE + 227, 5, 0, "E01CHMNTC");
    fields[37] = fieldE01CHMDBR =
    new DecimalField(message, HEADERSIZE + 232, 4, 0, "E01CHMDBR");
    fields[38] = fieldE01CHMDES =
    new DecimalField(message, HEADERSIZE + 236, 4, 0, "E01CHMDES");
    fields[39] = fieldE01CHMACT =
    new CharacterField(message, HEADERSIZE + 240, 1, "E01CHMACT");
    fields[40] = fieldE01OPECDE =
    new CharacterField(message, HEADERSIZE + 241, 1, "E01OPECDE");
