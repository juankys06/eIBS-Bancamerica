...
* 
* File level identifier is 1070821105351.
* Record format level identifier is 4B14ADFE82B84.
*/
...
public class EFO001002Message extends MessageRecord
{
  ...
  final static String fid = "1070821105351";
  final static String rid = "4B14ADFE82B84";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 184, 1, "E02CUSCCL");
    fields[21] = fieldE02CUPOFC =
    new CharacterField(message, HEADERSIZE + 185, 4, "E02CUPOFC");
    fields[22] = fieldE02OFCBRN =
    new DecimalField(message, HEADERSIZE + 189, 4, 0, "E02OFCBRN");
