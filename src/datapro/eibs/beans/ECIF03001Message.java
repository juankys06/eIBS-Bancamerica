...
* 
* File level identifier is 1100204184624.
* Record format level identifier is 4BF73895D4AB6.
*/
...
public class ECIF03001Message extends MessageRecord
{
  ...
  final static String fid = "1100204184624";
  final static String rid = "4BF73895D4AB6";
  ...
  */
  protected void createFields()
  {
    ...
    new DecimalField(message, HEADERSIZE + 63, 3, 0, "E01FRDTE3");
    fields[15] = fieldE01TODTE1 =
    new DecimalField(message, HEADERSIZE + 66, 3, 0, "E01TODTE1");
    fields[16] = fieldE01TODTE2 =
    new DecimalField(message, HEADERSIZE + 69, 3, 0, "E01TODTE2");
    fields[17] = fieldE01TODTE3 =
    new DecimalField(message, HEADERSIZE + 72, 3, 0, "E01TODTE3");
    fields[18] = fieldE01FRCHKN =
    new DecimalField(message, HEADERSIZE + 75, 10, 0, "E01FRCHKN");
    fields[19] = fieldE01TOCHKN =
    new DecimalField(message, HEADERSIZE + 85, 10, 0, "E01TOCHKN");
    fields[20] = fieldE01FRAMNT =
    new DecimalField(message, HEADERSIZE + 95, 17, 2, "E01FRAMNT");
    fields[21] = fieldE01TOAMNT =
    new DecimalField(message, HEADERSIZE + 112, 17, 2, "E01TOAMNT");
    fields[22] = fieldE01TRABTH =
    new DecimalField(message, HEADERSIZE + 129, 5, 0, "E01TRABTH");
    fields[23] = fieldE01TRACDE =
    new CharacterField(message, HEADERSIZE + 134, 2, "E01TRACDE");
    fields[24] = fieldE01TRANAR =
    new CharacterField(message, HEADERSIZE + 136, 30, "E01TRANAR");
    fields[25] = fieldE01DATE11 =
    new DecimalField(message, HEADERSIZE + 166, 3, 0, "E01DATE11");
    fields[26] = fieldE01DATE12 =
    new DecimalField(message, HEADERSIZE + 169, 3, 0, "E01DATE12");
    fields[27] = fieldE01DATE13 =
    new DecimalField(message, HEADERSIZE + 172, 3, 0, "E01DATE13");
    fields[28] = fieldE01DATE21 =
    new DecimalField(message, HEADERSIZE + 175, 3, 0, "E01DATE21");
    fields[29] = fieldE01DATE22 =
    new DecimalField(message, HEADERSIZE + 178, 3, 0, "E01DATE22");
    fields[30] = fieldE01DATE23 =
    new DecimalField(message, HEADERSIZE + 181, 3, 0, "E01DATE23");
    fields[31] = fieldE01TRAPD1 =
    new DecimalField(message, HEADERSIZE + 184, 3, 0, "E01TRAPD1");
    fields[32] = fieldE01TRAPD2 =
    new DecimalField(message, HEADERSIZE + 187, 3, 0, "E01TRAPD2");
    fields[33] = fieldE01TRAPD3 =
    new DecimalField(message, HEADERSIZE + 190, 3, 0, "E01TRAPD3");
    fields[34] = fieldE01TRACKN =
    new DecimalField(message, HEADERSIZE + 193, 10, 0, "E01TRACKN");
    fields[35] = fieldE01TRAAMT =
    new DecimalField(message, HEADERSIZE + 203, 17, 2, "E01TRAAMT");
    fields[36] = fieldE01TRADCC =
    new CharacterField(message, HEADERSIZE + 220, 1, "E01TRADCC");
    fields[37] = fieldE01TRAAPC =
    new CharacterField(message, HEADERSIZE + 221, 1, "E01TRAAPC");
    fields[38] = fieldE01TRAEXR =
    new DecimalField(message, HEADERSIZE + 222, 13, 6, "E01TRAEXR");
    fields[39] = fieldE01TRAOBK =
    new CharacterField(message, HEADERSIZE + 235, 2, "E01TRAOBK");
    fields[40] = fieldE01TRAOBR =
    new DecimalField(message, HEADERSIZE + 237, 4, 0, "E01TRAOBR");
    fields[41] = fieldE01TRATIM =
    new DecimalField(message, HEADERSIZE + 241, 7, 0, "E01TRATIM");
    fields[42] = fieldE01TRAUSR =
    new CharacterField(message, HEADERSIZE + 248, 7, "E01TRAUSR");
    fields[43] = fieldE01TRADRR =
    new DecimalField(message, HEADERSIZE + 255, 8, 0, "E01TRADRR");
    fields[44] = fieldE01TRAACR =
    new DecimalField(message, HEADERSIZE + 263, 13, 0, "E01TRAACR");
    fields[45] = fieldE01TRAPTS =
    new DecimalField(message, HEADERSIZE + 276, 6, 0, "E01TRAPTS");
    fields[46] = fieldE01TRATRN =
    new DecimalField(message, HEADERSIZE + 282, 6, 0, "E01TRATRN");
    fields[47] = fieldE01TRAPMN =
    new DecimalField(message, HEADERSIZE + 288, 6, 0, "E01TRAPMN");
    fields[48] = fieldE01TRACNU =
    new DecimalField(message, HEADERSIZE + 294, 8, 0, "E01TRACNU");
    fields[49] = fieldE01BEGBAL =
    new DecimalField(message, HEADERSIZE + 302, 17, 2, "E01BEGBAL");
    fields[50] = fieldE01ENDBAL =
    new DecimalField(message, HEADERSIZE + 319, 17, 2, "E01ENDBAL");
    fields[51] = fieldE01NUITBMS =
    new DecimalField(message, HEADERSIZE + 336, 7, 0, "E01NUITBMS");
    fields[52] = fieldE01SUITBMS =
    new DecimalField(message, HEADERSIZE + 343, 17, 2, "E01SUITBMS");
    fields[53] = fieldE01NUMNAR =
    new DecimalField(message, HEADERSIZE + 360, 3, 0, "E01NUMNAR");
    fields[54] = fieldE01TRANA1 =
    new CharacterField(message, HEADERSIZE + 363, 30, "E01TRANA1");
    fields[55] = fieldE01TRANA2 =
    new CharacterField(message, HEADERSIZE + 393, 30, "E01TRANA2");
    fields[56] = fieldE01TRANA3 =
    new CharacterField(message, HEADERSIZE + 423, 30, "E01TRANA3");
    fields[57] = fieldE01TRANA4 =
    new CharacterField(message, HEADERSIZE + 453, 30, "E01TRANA4");
    fields[58] = fieldE01TRANA5 =
    new CharacterField(message, HEADERSIZE + 483, 30, "E01TRANA5");
    fields[59] = fieldE01TRANA6 =
    new CharacterField(message, HEADERSIZE + 513, 30, "E01TRANA6");
    fields[60] = fieldE01TRANA7 =
    new CharacterField(message, HEADERSIZE + 543, 30, "E01TRANA7");
    fields[61] = fieldE01TRANA8 =
    new CharacterField(message, HEADERSIZE + 573, 30, "E01TRANA8");
    fields[62] = fieldE01TRANA9 =
    new CharacterField(message, HEADERSIZE + 603, 30, "E01TRANA9");
    fields[63] = fieldE01NUMREC =
    new DecimalField(message, HEADERSIZE + 633, 8, 0, "E01NUMREC");
    fields[64] = fieldE01INDOPE =
    new CharacterField(message, HEADERSIZE + 641, 1, "E01INDOPE");
