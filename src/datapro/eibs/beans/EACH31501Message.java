...
* 
* File level identifier is 1080707150052.
* Record format level identifier is 43A8E93990ED4.
*/
...
public class EACH31501Message extends MessageRecord
{
  ...
  final static String fid = "1080707150052";
  final static String rid = "43A8E93990ED4";
  ...
  */
  protected void createFields()
  {
    ...
    fields[21] = fieldE01ACUACT =
    new CharacterField(message, HEADERSIZE + 133, 1, "E01ACUACT");
    fields[22] = fieldE01ACUCCY =
    new CharacterField(message, HEADERSIZE + 134, 3, "E01ACUCCY");
    fields[23] = fieldE01ACUAMT =
    new DecimalField(message, HEADERSIZE + 137, 17, 2, "E01ACUAMT");
    fields[24] = fieldE01ACUADD =
    new CharacterField(message, HEADERSIZE + 154, 80, "E01ACUADD");
    fields[25] = fieldE01ACUCDE =
    new CharacterField(message, HEADERSIZE + 234, 2, "E01ACUCDE");
    fields[26] = fieldE01ACUIDN =
    new CharacterField(message, HEADERSIZE + 236, 15, "E01ACUIDN");
    fields[27] = fieldE01ACUNME =
    new CharacterField(message, HEADERSIZE + 251, 45, "E01ACUNME");
    fields[28] = fieldE01ACUADR =
    new CharacterField(message, HEADERSIZE + 296, 45, "E01ACUADR");
    fields[29] = fieldE01ACUCSZ =
    new CharacterField(message, HEADERSIZE + 341, 45, "E01ACUCSZ");
    fields[30] = fieldE01ACUEMA =
    new CharacterField(message, HEADERSIZE + 386, 60, "E01ACUEMA");
    fields[31] = fieldE01ACURDY =
    new DecimalField(message, HEADERSIZE + 446, 3, 0, "E01ACURDY");
    fields[32] = fieldE01ACURDM =
    new DecimalField(message, HEADERSIZE + 449, 3, 0, "E01ACURDM");
    fields[33] = fieldE01ACURDD =
    new DecimalField(message, HEADERSIZE + 452, 3, 0, "E01ACURDD");
    fields[34] = fieldE01ACUSTS =
    new CharacterField(message, HEADERSIZE + 455, 1, "E01ACUSTS");
    fields[35] = fieldE01ACURTS =
    new DecimalField(message, HEADERSIZE + 456, 13, 0, "E01ACURTS");
    fields[36] = fieldE01ACUPTS =
    new DecimalField(message, HEADERSIZE + 469, 13, 0, "E01ACUPTS");
    fields[37] = fieldE01ACUSTC =
    new CharacterField(message, HEADERSIZE + 482, 3, "E01ACUSTC");
    fields[38] = fieldE01CUNDSC =
    new CharacterField(message, HEADERSIZE + 485, 35, "E01CUNDSC");
    fields[39] = fieldE01OCDDSC =
    new CharacterField(message, HEADERSIZE + 520, 35, "E01OCDDSC");
    fields[40] = fieldE01ECDDSC =
    new CharacterField(message, HEADERSIZE + 555, 35, "E01ECDDSC");
    fields[41] = fieldE01CDEDSC =
    new CharacterField(message, HEADERSIZE + 590, 35, "E01CDEDSC");
    fields[42] = fieldE01ACT =
    new CharacterField(message, HEADERSIZE + 625, 1, "E01ACT");
    fields[43] = fieldE01NUMREC =
    new DecimalField(message, HEADERSIZE + 626, 8, 0, "E01NUMREC");
    fields[44] = fieldE01INDOPE =
    new CharacterField(message, HEADERSIZE + 634, 1, "E01INDOPE");
