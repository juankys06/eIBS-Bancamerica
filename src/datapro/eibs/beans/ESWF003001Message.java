...
* 
* File level identifier is 1050908125549.
* Record format level identifier is 493A4CD3B29AA.
*/
...
public class ESWF003001Message extends MessageRecord
{
  ...
  final static String fid = "1050908125549";
  final static String rid = "493A4CD3B29AA";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 54, 12, "ESWFSWI");
    fields[12] = fieldESWFFMT =
    new DecimalField(message, HEADERSIZE + 66, 4, 0, "ESWFFMT");
    fields[13] = fieldESWF00 =
    new CharacterField(message, HEADERSIZE + 70, 50, "ESWF00");
    fields[14] = fieldESWF01 =
    new CharacterField(message, HEADERSIZE + 120, 50, "ESWF01");
    fields[15] = fieldESWF02 =
    new CharacterField(message, HEADERSIZE + 170, 50, "ESWF02");
    fields[16] = fieldESWF03 =
    new CharacterField(message, HEADERSIZE + 220, 50, "ESWF03");
    fields[17] = fieldESWF04 =
    new CharacterField(message, HEADERSIZE + 270, 50, "ESWF04");
    fields[18] = fieldESWF05 =
    new CharacterField(message, HEADERSIZE + 320, 50, "ESWF05");
    fields[19] = fieldESWF06 =
    new CharacterField(message, HEADERSIZE + 370, 50, "ESWF06");
    fields[20] = fieldESWF07 =
    new CharacterField(message, HEADERSIZE + 420, 50, "ESWF07");
    fields[21] = fieldESWF08 =
    new CharacterField(message, HEADERSIZE + 470, 50, "ESWF08");
    fields[22] = fieldESWF09 =
    new CharacterField(message, HEADERSIZE + 520, 50, "ESWF09");
    fields[23] = fieldESWF10 =
    new CharacterField(message, HEADERSIZE + 570, 50, "ESWF10");
    fields[24] = fieldESWF11 =
    new CharacterField(message, HEADERSIZE + 620, 50, "ESWF11");
    fields[25] = fieldESWF12 =
    new CharacterField(message, HEADERSIZE + 670, 50, "ESWF12");
    fields[26] = fieldESWF13 =
    new CharacterField(message, HEADERSIZE + 720, 50, "ESWF13");
    fields[27] = fieldESWF14 =
    new CharacterField(message, HEADERSIZE + 770, 50, "ESWF14");
    fields[28] = fieldESWF15 =
    new CharacterField(message, HEADERSIZE + 820, 50, "ESWF15");
    fields[29] = fieldESWF16 =
    new CharacterField(message, HEADERSIZE + 870, 50, "ESWF16");
    fields[30] = fieldESWF17 =
    new CharacterField(message, HEADERSIZE + 920, 50, "ESWF17");
    fields[31] = fieldESWF18 =
    new CharacterField(message, HEADERSIZE + 970, 50, "ESWF18");
    fields[32] = fieldESWF19 =
    new CharacterField(message, HEADERSIZE + 1020, 50, "ESWF19");
    fields[33] = fieldESWF20 =
    new CharacterField(message, HEADERSIZE + 1070, 50, "ESWF20");
    fields[34] = fieldESWF21 =
    new CharacterField(message, HEADERSIZE + 1120, 50, "ESWF21");
    fields[35] = fieldESWF22 =
    new CharacterField(message, HEADERSIZE + 1170, 50, "ESWF22");
    fields[36] = fieldESWF23 =
    new CharacterField(message, HEADERSIZE + 1220, 50, "ESWF23");
    fields[37] = fieldESWF24 =
    new CharacterField(message, HEADERSIZE + 1270, 50, "ESWF24");
    fields[38] = fieldESWF25 =
    new CharacterField(message, HEADERSIZE + 1320, 50, "ESWF25");
    fields[39] = fieldESWF26 =
    new CharacterField(message, HEADERSIZE + 1370, 50, "ESWF26");
    fields[40] = fieldESWF27 =
    new CharacterField(message, HEADERSIZE + 1420, 50, "ESWF27");
    fields[41] = fieldESWF28 =
    new CharacterField(message, HEADERSIZE + 1470, 50, "ESWF28");
    fields[42] = fieldESWF29 =
    new CharacterField(message, HEADERSIZE + 1520, 50, "ESWF29");
    fields[43] = fieldESWF30 =
    new CharacterField(message, HEADERSIZE + 1570, 50, "ESWF30");
    fields[44] = fieldESWF31 =
    new CharacterField(message, HEADERSIZE + 1620, 50, "ESWF31");
    fields[45] = fieldESWF32 =
    new CharacterField(message, HEADERSIZE + 1670, 50, "ESWF32");
    fields[46] = fieldESWF33 =
    new CharacterField(message, HEADERSIZE + 1720, 50, "ESWF33");
    fields[47] = fieldESWF34 =
    new CharacterField(message, HEADERSIZE + 1770, 50, "ESWF34");
    fields[48] = fieldESWF35 =
    new CharacterField(message, HEADERSIZE + 1820, 50, "ESWF35");
