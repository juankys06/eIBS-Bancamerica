...
* 
* File level identifier is 1080118125527.
* Record format level identifier is 410611BB9CB8C.
*/
...
public class ECIF01002Message extends MessageRecord
{
  ...
  final static String fid = "1080118125527";
  final static String rid = "410611BB9CB8C";
  ...
  */
  protected void createFields()
  {
    ...
    new DecimalField(message, HEADERSIZE + 184, 10, 0, "E02CIFOCU");
    fields[21] = fieldE02CIFACC =
    new DecimalField(message, HEADERSIZE + 194, 13, 0, "E02CIFACC");
    fields[22] = fieldE02OCUNME =
    new CharacterField(message, HEADERSIZE + 207, 45, "E02OCUNME");
    fields[23] = fieldE02OCUIDN =
    new CharacterField(message, HEADERSIZE + 252, 15, "E02OCUIDN");
    fields[24] = fieldE02CUSLN3 =
    new CharacterField(message, HEADERSIZE + 267, 30, "E02CUSLN3");
