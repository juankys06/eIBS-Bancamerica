...
* Record format level identifier is 36E11A8D6FA71.
*/
...
public class EWD0332DSMessage extends MessageRecord
{
  ...
  final static String rid = "36E11A8D6FA71";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 45, 4, "SWDSBT");
    fields[9] = fieldSWDITP =
    new CharacterField(message, HEADERSIZE + 49, 5, "SWDITP");
    fields[10] = fieldSWDTRA =
    new DecimalField(message, HEADERSIZE + 54, 7, 0, "SWDTRA");
    fields[11] = fieldSWDVAL =
    new DecimalField(message, HEADERSIZE + 61, 7, 0, "SWDVAL");
    fields[12] = fieldSWDMAT =
    new DecimalField(message, HEADERSIZE + 68, 7, 0, "SWDMAT");
    fields[13] = fieldSWDCUN =
    new DecimalField(message, HEADERSIZE + 75, 10, 0, "SWDCUN");
    fields[14] = fieldSWDPRI =
    new DecimalField(message, HEADERSIZE + 85, 17, 2, "SWDPRI");
    fields[15] = fieldSWDOAM =
    new DecimalField(message, HEADERSIZE + 102, 17, 2, "SWDOAM");
    fields[16] = fieldSWDRTE =
    new DecimalField(message, HEADERSIZE + 119, 13, 6, "SWDRTE");
    fields[17] = fieldSWDDSC =
    new CharacterField(message, HEADERSIZE + 132, 30, "SWDDSC");
    fields[18] = fieldSWDSTS =
    new CharacterField(message, HEADERSIZE + 162, 15, "SWDSTS");
