...
* Record format level identifier is 4570527187CD4.
*/
...
public class EDP073201Message extends MessageRecord
{
  ...
  final static String rid = "4570527187CD4";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 61, 1, "E01IFDCFO");
    fields[14] = fieldE01IFMCFA =
    new CharacterField(message, HEADERSIZE + 62, 4, "E01IFMCFA");
    fields[15] = fieldE01LIQUID =
    new DecimalField(message, HEADERSIZE + 66, 15, 2, "E01LIQUID");
    fields[16] = fieldE01PRUACI =
    new DecimalField(message, HEADERSIZE + 81, 15, 2, "E01PRUACI");
    fields[17] = fieldE01PEMECO =
    new DecimalField(message, HEADERSIZE + 96, 15, 2, "E01PEMECO");
    fields[18] = fieldE01ROTINV =
    new DecimalField(message, HEADERSIZE + 111, 15, 2, "E01ROTINV");
    fields[19] = fieldE01PEMEPA =
    new DecimalField(message, HEADERSIZE + 126, 15, 2, "E01PEMEPA");
    fields[20] = fieldE01ENDEUD =
    new DecimalField(message, HEADERSIZE + 141, 15, 2, "E01ENDEUD");
    fields[21] = fieldE01ENDFIN =
    new DecimalField(message, HEADERSIZE + 156, 15, 2, "E01ENDFIN");
    fields[22] = fieldE01RENACT =
    new DecimalField(message, HEADERSIZE + 171, 15, 2, "E01RENACT");
    fields[23] = fieldE01RENPAT =
    new DecimalField(message, HEADERSIZE + 186, 15, 2, "E01RENPAT");
    fields[24] = fieldE01MANEUT =
    new DecimalField(message, HEADERSIZE + 201, 15, 2, "E01MANEUT");
    fields[25] = fieldE01MAROPE =
    new DecimalField(message, HEADERSIZE + 216, 15, 2, "E01MAROPE");
    fields[26] = fieldE01RIEPAT =
    new DecimalField(message, HEADERSIZE + 231, 15, 2, "E01RIEPAT");
    fields[27] = fieldE01RIEVTA =
    new DecimalField(message, HEADERSIZE + 246, 15, 2, "E01RIEVTA");
