...
* 
* File level identifier is 1041012151558.
* Record format level identifier is 4EABE6930DE18.
*/
...
public class ESD003001Message extends MessageRecord
{
  ...
  final static String fid = "1041012151558";
  final static String rid = "4EABE6930DE18";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 44, 35, "E01CNODCN");
    fields[11] = fieldE01CNOSCR =
    new DecimalField(message, HEADERSIZE + 79, 3, 0, "E01CNOSCR");
    fields[12] = fieldE01CNOFLD =
    new DecimalField(message, HEADERSIZE + 82, 2, 0, "E01CNOFLD");
    fields[13] = fieldE01CNOLAN =
    new CharacterField(message, HEADERSIZE + 84, 1, "E01CNOLAN");
    fields[14] = fieldE01CNOOPE =
    new CharacterField(message, HEADERSIZE + 85, 1, "E01CNOOPE");
