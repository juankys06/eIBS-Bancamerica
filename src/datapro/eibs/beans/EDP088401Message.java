...
* 
* File level identifier is 1090105165650.
* Record format level identifier is 432BDEFE8C0D4.
*/
...
public class EDP088401Message extends MessageRecord
{
  ...
  final static String fid = "1090105165650";
  final static String rid = "432BDEFE8C0D4";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 99, 4, "E01MODCOD");
    fields[14] = fieldE01MODDSC =
    new CharacterField(message, HEADERSIZE + 103, 35, "E01MODDSC");
    fields[15] = fieldE01MODPER =
    new DecimalField(message, HEADERSIZE + 138, 11, 6, "E01MODPER");
    fields[16] = fieldE01MODPET =
    new DecimalField(message, HEADERSIZE + 149, 11, 6, "E01MODPET");
    fields[17] = fieldE01PTSPTS =
    new DecimalField(message, HEADERSIZE + 160, 8, 3, "E01PTSPTS");
    fields[18] = fieldE01RECPOS =
    new DecimalField(message, HEADERSIZE + 168, 8, 0, "E01RECPOS");
    fields[19] = fieldE01OPECDE =
    new CharacterField(message, HEADERSIZE + 176, 1, "E01OPECDE");
