...
* Record format level identifier is 4741460AB4A24.
*/
...
public class ELC045501Message extends MessageRecord
{
  ...
  final static String rid = "4741460AB4A24";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 151, 1, "E01LCDTYP");
    fields[20] = fieldE01LCDBNK =
    new CharacterField(message, HEADERSIZE + 152, 2, "E01LCDBNK");
    fields[21] = fieldE01LCDDNO =
    new DecimalField(message, HEADERSIZE + 154, 3, 0, "E01LCDDNO");
    fields[22] = fieldE01LCDFUN =
    new CharacterField(message, HEADERSIZE + 157, 1, "E01LCDFUN");
    fields[23] = fieldE01LCDLIN =
    new CharacterField(message, HEADERSIZE + 158, 77, "E01LCDLIN");
    fields[24] = fieldE01LCDTXF =
    new CharacterField(message, HEADERSIZE + 235, 1, "E01LCDTXF");
