...
* 
* File level identifier is 1080526162607.
* Record format level identifier is 38E6C2904627D.
*/
...
public class EWD0600DSMessage extends MessageRecord
{
  ...
  final static String fid = "1080526162607";
  final static String rid = "38E6C2904627D";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 292, 30, "EWDFNA");
    fields[24] = fieldEWDFN2 =
    new CharacterField(message, HEADERSIZE + 322, 30, "EWDFN2");
    fields[25] = fieldEWDLN1 =
    new CharacterField(message, HEADERSIZE + 352, 30, "EWDLN1");
    fields[26] = fieldEWDLN2 =
    new CharacterField(message, HEADERSIZE + 382, 30, "EWDLN2");
    fields[27] = fieldEWDOPM =
    new DecimalField(message, HEADERSIZE + 412, 3, 0, "EWDOPM");
    fields[28] = fieldEWDOPD =
    new DecimalField(message, HEADERSIZE + 415, 3, 0, "EWDOPD");
    fields[29] = fieldEWDOPY =
    new DecimalField(message, HEADERSIZE + 418, 3, 0, "EWDOPY");
