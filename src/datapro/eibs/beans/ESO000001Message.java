...
* 
* File level identifier is 1070829132129.
* Record format level identifier is 455927E22E5E5.
*/
...
public class ESO000001Message extends MessageRecord
{
  ...
  final static String fid = "1070829132129";
  final static String rid = "455927E22E5E5";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 77, 45, "E01CUSNA1");
    fields[14] = fieldE01SOLPRO =
    new CharacterField(message, HEADERSIZE + 122, 4, "E01SOLPRO");
    fields[15] = fieldE01SOLPRI =
    new DecimalField(message, HEADERSIZE + 126, 17, 2, "E01SOLPRI");
    fields[16] = fieldE01SOLTRM =
    new DecimalField(message, HEADERSIZE + 143, 5, 0, "E01SOLTRM");
    fields[17] = fieldE01SOLTRC =
    new CharacterField(message, HEADERSIZE + 148, 1, "E01SOLTRC");
    fields[18] = fieldE01SOLOPE =
    new CharacterField(message, HEADERSIZE + 149, 2, "E01SOLOPE");
    fields[19] = fieldE01SOLRTE =
    new DecimalField(message, HEADERSIZE + 151, 11, 6, "E01SOLRTE");
    fields[20] = fieldE01SOLART =
    new DecimalField(message, HEADERSIZE + 162, 11, 6, "E01SOLART");
    fields[21] = fieldE01DEAMA1 =
    new DecimalField(message, HEADERSIZE + 173, 3, 0, "E01DEAMA1");
    fields[22] = fieldE01DEAMA2 =
    new DecimalField(message, HEADERSIZE + 176, 3, 0, "E01DEAMA2");
    fields[23] = fieldE01DEAMA3 =
    new DecimalField(message, HEADERSIZE + 179, 3, 0, "E01DEAMA3");
    fields[24] = fieldE01SOLPVI =
    new CharacterField(message, HEADERSIZE + 182, 1, "E01SOLPVI");
    fields[25] = fieldE01SOLABY =
    new CharacterField(message, HEADERSIZE + 183, 10, "E01SOLABY");
    fields[26] = fieldE01SOLNME =
    new CharacterField(message, HEADERSIZE + 193, 30, "E01SOLNME");
    fields[27] = fieldE01SOLFCK =
    new DecimalField(message, HEADERSIZE + 223, 10, 0, "E01SOLFCK");
    fields[28] = fieldE01SOLTCK =
    new DecimalField(message, HEADERSIZE + 233, 10, 0, "E01SOLTCK");
    fields[29] = fieldE01ACTION =
    new CharacterField(message, HEADERSIZE + 243, 1, "E01ACTION");
    fields[30] = fieldE01FINDAT =
    new CharacterField(message, HEADERSIZE + 244, 1, "E01FINDAT");
