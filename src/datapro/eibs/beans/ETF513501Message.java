...
* Record format level identifier is 50B5B98C64C95.
*/
...
public class ETF513501Message extends MessageRecord
{
  ...
  final static String rid = "50B5B98C64C95";
  ...
  */
  protected void createFields()
  {
    ...
    new DecimalField(message, HEADERSIZE + 335, 4, 0, "E01DEABRN");
    fields[23] = fieldE01DEARAC =
    new DecimalField(message, HEADERSIZE + 339, 13, 0, "E01DEARAC");
    fields[24] = fieldE01DEAMD1 =
    new DecimalField(message, HEADERSIZE + 352, 3, 0, "E01DEAMD1");
    fields[25] = fieldE01DEAMD2 =
    new DecimalField(message, HEADERSIZE + 355, 3, 0, "E01DEAMD2");
    fields[26] = fieldE01DEAMD3 =
    new DecimalField(message, HEADERSIZE + 358, 3, 0, "E01DEAMD3");
    fields[27] = fieldE01DEANAR =
    new CharacterField(message, HEADERSIZE + 361, 30, "E01DEANAR");
    fields[28] = fieldE01DEACCY =
    new CharacterField(message, HEADERSIZE + 391, 3, "E01DEACCY");
    fields[29] = fieldE01DEAINT =
    new DecimalField(message, HEADERSIZE + 394, 23, 8, "E01DEAINT");
    fields[30] = fieldE01DEATOT =
    new DecimalField(message, HEADERSIZE + 417, 23, 8, "E01DEATOT");
    fields[31] = fieldE01DEAMEX =
    new CharacterField(message, HEADERSIZE + 440, 1, "E01DEAMEX");
