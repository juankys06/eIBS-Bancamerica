...
* 
* File level identifier is 1030121191911.
* Record format level identifier is 446051358E415.
*/
...
public class EDL081601Message extends MessageRecord
{
  ...
  final static String fid = "1030121191911";
  final static String rid = "446051358E415";
  ...
  */
  protected void createFields()
  {
    ...
    new DecimalField(message, HEADERSIZE + 172, 17, 2, "E01DEAPRI");
    fields[22] = fieldE01DEARTE =
    new DecimalField(message, HEADERSIZE + 189, 11, 6, "E01DEARTE");
    fields[23] = fieldE01MORRTE =
    new DecimalField(message, HEADERSIZE + 200, 11, 6, "E01MORRTE");
    fields[24] = fieldE01DEABAS =
    new DecimalField(message, HEADERSIZE + 211, 4, 0, "E01DEABAS");
    fields[25] = fieldE01DEAICT =
    new CharacterField(message, HEADERSIZE + 215, 1, "E01DEAICT");
    fields[26] = fieldE01OPEND1 =
    new DecimalField(message, HEADERSIZE + 216, 3, 0, "E01OPEND1");
    fields[27] = fieldE01OPEND2 =
    new DecimalField(message, HEADERSIZE + 219, 3, 0, "E01OPEND2");
    fields[28] = fieldE01OPEND3 =
    new DecimalField(message, HEADERSIZE + 222, 3, 0, "E01OPEND3");
    fields[29] = fieldE01MATUR1 =
    new DecimalField(message, HEADERSIZE + 225, 3, 0, "E01MATUR1");
    fields[30] = fieldE01MATUR2 =
    new DecimalField(message, HEADERSIZE + 228, 3, 0, "E01MATUR2");
    fields[31] = fieldE01MATUR3 =
    new DecimalField(message, HEADERSIZE + 231, 3, 0, "E01MATUR3");
    fields[32] = fieldE01LSTCL1 =
    new DecimalField(message, HEADERSIZE + 234, 3, 0, "E01LSTCL1");
    fields[33] = fieldE01LSTCL2 =
    new DecimalField(message, HEADERSIZE + 237, 3, 0, "E01LSTCL2");
    fields[34] = fieldE01LSTCL3 =
    new DecimalField(message, HEADERSIZE + 240, 3, 0, "E01LSTCL3");
