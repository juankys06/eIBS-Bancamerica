...
* 
* File level identifier is 1070726131950.
* Record format level identifier is 2CAF957D79301.
*/
...
public class EWD0001RMessage extends MessageRecord
{
  ...
  final static String fid = "1070726131950";
  final static String rid = "2CAF957D79301";
  ...
  */
  protected void createFields()
  {
    ...
    new CharacterField(message, HEADERSIZE + 10, 30, "RWDSHR");
    fields[2] = fieldRWDTYP =
    new CharacterField(message, HEADERSIZE + 40, 1, "RWDTYP");
    fields[3] = fieldRWDSEL =
    new CharacterField(message, HEADERSIZE + 41, 1, "RWDSEL");
    fields[4] = fieldRWDFRC =
    new DecimalField(message, HEADERSIZE + 42, 8, 0, "RWDFRC");
    fields[5] = fieldRWDACC =
    new DecimalField(message, HEADERSIZE + 50, 13, 0, "RWDACC");
