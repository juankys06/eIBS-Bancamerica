...
* 
* File level identifier is 1060613124740.
* Record format level identifier is 4A840C73ADE54.
*/
...
public class EWD0123DSMessage extends MessageRecord
{
  ...
  final static String fid = "1060613124740";
  final static String rid = "4A840C73ADE54";
  ...
  */
  protected void createFields()
  {
    ...
    new DecimalField(message, HEADERSIZE + 211, 4, 0, "EWDBRN");
    fields[16] = fieldEWDREC =
    new DecimalField(message, HEADERSIZE + 215, 8, 0, "EWDREC");
    fields[17] = fieldEWDOPE =
    new CharacterField(message, HEADERSIZE + 223, 1, "EWDOPE");
