...
* 
* File level identifier is 1100914162333.
* Record format level identifier is 48FDC6B38F9D0.
*/
...
public class EFRM00071Message extends MessageRecord
{
  ...
  final static String fid = "1100914162333";
  final static String rid = "48FDC6B38F9D0";
  ...
  */
  protected void createFields()
  {
    ...
    new DecimalField(message, HEADERSIZE + 42, 14, 0, "AccountALineC");
    fields[10] = fieldE01RCLACCY =
    new CharacterField(message, HEADERSIZE + 56, 3, "CollatCcy");
    fields[11] = fieldE01RCLAPRO =
    new CharacterField(message, HEADERSIZE + 59, 4, "ProdType");
    fields[12] = fieldE01RCLATYP =
    new CharacterField(message, HEADERSIZE + 63, 4, "COllatTypeSta");
    fields[13] = fieldE01RCLAACD =
    new CharacterField(message, HEADERSIZE + 67, 2, "ApplicatCodeA");
    fields[14] = fieldE01CUSNA1 =
    new CharacterField(message, HEADERSIZE + 69, 45, "LegalName");
    fields[15] = fieldE01RCLABAL =
    new DecimalField(message, HEADERSIZE + 114, 17, 2, "Balance");
    fields[16] = fieldE01RCLADIS =
    new DecimalField(message, HEADERSIZE + 131, 17, 2, "BalenceDisp");
    fields[17] = fieldE01RCLACB =
    new DecimalField(message, HEADERSIZE + 148, 13, 0, "AccountBCollat");
    fields[18] = fieldE01RCLBCCY =
    new CharacterField(message, HEADERSIZE + 161, 3, "CollatBCcy");
    fields[19] = fieldE01RCLBPRO =
    new CharacterField(message, HEADERSIZE + 164, 4, "ProdBType");
    fields[20] = fieldE01RCLBTYP =
    new CharacterField(message, HEADERSIZE + 168, 4, "CollatBTypeSta");
    fields[21] = fieldE01RCLBACD =
    new CharacterField(message, HEADERSIZE + 172, 2, "ApplicatCodeB");
    fields[22] = fieldE01RCLBCOL =
    new DecimalField(message, HEADERSIZE + 174, 17, 2, "BalanceColl");
    fields[23] = fieldE01RCLOCOL =
    new DecimalField(message, HEADERSIZE + 191, 17, 2, "BalanceColl1");
    fields[24] = fieldE01RCLBDIS =
    new DecimalField(message, HEADERSIZE + 208, 17, 2, "BalancEDisp1");
    fields[25] = fieldE01RCLBBAL =
    new DecimalField(message, HEADERSIZE + 225, 17, 2, "BalanceEnd");
    fields[26] = fieldE01ENDFLD =
    new CharacterField(message, HEADERSIZE + 242, 1, "EndOfFile");
