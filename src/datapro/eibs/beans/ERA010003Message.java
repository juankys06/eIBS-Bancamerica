...
* 
* File level identifier is 1091123171830.
* Record format level identifier is 371EE89A4639F.
*/
...
public class ERA010003Message extends MessageRecord
{
  ...
  final static String fid = "1091123171830";
  final static String rid = "371EE89A4639F";
  ...
  */
  protected void createFields()
  {
    ...
    new DecimalField(message, HEADERSIZE + 67, 6, 0, "E03ROCICN");
    fields[13] = fieldE03ROCICM =
    new CharacterField(message, HEADERSIZE + 73, 35, "E03ROCICM");
    fields[14] = fieldE03ROCIPD =
    new CharacterField(message, HEADERSIZE + 108, 30, "E03ROCIPD");
    fields[15] = fieldE03ROCCIN =
    new CharacterField(message, HEADERSIZE + 138, 40, "E03ROCCIN");
    fields[16] = fieldE03ROCEM1 =
    new DecimalField(message, HEADERSIZE + 178, 3, 0, "E03ROCEM1");
    fields[17] = fieldE03ROCEM2 =
    new DecimalField(message, HEADERSIZE + 181, 3, 0, "E03ROCEM2");
    fields[18] = fieldE03ROCEM3 =
    new DecimalField(message, HEADERSIZE + 184, 3, 0, "E03ROCEM3");
    fields[19] = fieldE03ROCMD1 =
    new DecimalField(message, HEADERSIZE + 187, 3, 0, "E03ROCMD1");
    fields[20] = fieldE03ROCMD2 =
    new DecimalField(message, HEADERSIZE + 190, 3, 0, "E03ROCMD2");
    fields[21] = fieldE03ROCMD3 =
    new DecimalField(message, HEADERSIZE + 193, 3, 0, "E03ROCMD3");
    fields[22] = fieldE03ROCICY =
    new CharacterField(message, HEADERSIZE + 196, 3, "E03ROCICY");
    fields[23] = fieldE03ROCIPA =
    new DecimalField(message, HEADERSIZE + 199, 17, 2, "E03ROCIPA");
    fields[24] = fieldE03ROCCLF =
    new CharacterField(message, HEADERSIZE + 216, 1, "E03ROCCLF");
    fields[25] = fieldE03ROCRGK =
    new CharacterField(message, HEADERSIZE + 217, 1, "E03ROCRGK");
    fields[26] = fieldE03ROCEMB =
    new CharacterField(message, HEADERSIZE + 218, 4, "E03ROCEMB");
    fields[27] = fieldE03ROCUSC =
    new CharacterField(message, HEADERSIZE + 222, 4, "E03ROCUSC");
    fields[28] = fieldE03ROCCRR =
    new CharacterField(message, HEADERSIZE + 226, 4, "E03ROCCRR");
    fields[29] = fieldE03ROCEDO =
    new CharacterField(message, HEADERSIZE + 230, 1, "E03ROCEDO");
    fields[30] = fieldE03ROCTS1 =
    new CharacterField(message, HEADERSIZE + 231, 1, "E03ROCTS1");
    fields[31] = fieldE03ROCTS2 =
    new CharacterField(message, HEADERSIZE + 232, 1, "E03ROCTS2");
    fields[32] = fieldE03ROCTS3 =
    new CharacterField(message, HEADERSIZE + 233, 1, "E03ROCTS3");
    fields[33] = fieldE03ROCTS4 =
    new CharacterField(message, HEADERSIZE + 234, 1, "E03ROCTS4");
    fields[34] = fieldE03ROCTS5 =
    new CharacterField(message, HEADERSIZE + 235, 1, "E03ROCTS5");
