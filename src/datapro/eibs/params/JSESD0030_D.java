...
public class JSESD0030 extends datapro.eibs.master.SuperServlet {
	...
	protected void procActionMaintenance(
		...
		try {
			...
			if (req.getParameter("E02SETRCD")!= null) {
	...
	private String getRedirectPage(int screencode, String tablecode) {
		...
		switch (screencode) {
			...
			case 6 : //Account Cancellation
				if (tablecode.equals("80")) { //PARROQUIA BANCO TESORO
											  // VENEZUELA
				try {
					flexLog("About to call Page: " + LangPath
							+ "ESD0030_cnof_parroquia_details.jsp");
					ret = LangPath + "ESD0030_cnof_parroquia_details.jsp";
				} catch (Exception e) {
					flexLog("Exception calling page " + e);
				}
			} else { //Generic 6 Digits table
				try {
					flexLog("About to call Page: " + LangPath
							+ "ESD0030_cnof_cancellation_accounts.jsp");
					ret = LangPath + "ESD0030_cnof_cancellation_accounts.jsp";
				} catch (Exception e) {
					flexLog("Exception calling page " + e);
				}
			}
