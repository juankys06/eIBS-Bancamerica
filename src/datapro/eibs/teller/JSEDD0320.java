...
public class JSEDD0320 extends datapro.eibs.master.SuperServlet {
				...
				if (newmessage.getFormatName().equals("EDD032001")) {
					...
					while (true) {
						...
						if (marker.equals("*")) {
							...
							+ msgList.getE01TDRTCD() 
							+ "')\"></TD>");
							myRow.append("<TD NOWRAP  ALIGN=CENTER width=\"30%\">" + msgList.getE01TDRTCD() + "</td>");
							myRow.append("<TD NOWRAP  ALIGN=LEFT width=\"60%\">" + msgList.getE01TDRITD() + "</td>");
							myRow.append("</TR>");
	...
	protected void procActionPos(
		...
		switch (inptOPT) {
			...
			case 3 : //Delete
				res.sendRedirect(super.srctx + 
				"/servlet/datapro.eibs.teller.JSESD0205?SCREEN=500" + "&E01CODE=" + E01CODE );
				break;
