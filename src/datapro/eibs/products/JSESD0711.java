...
public class JSESD0711 extends datapro.eibs.master.SuperServlet
{
			...
			switch (appCode)
			{
				...
				case 50 : // Cobranzas Simples
					try
					{
						...
						ses.setAttribute("userPO", userPO);
						procReqProductDetails(req, res);
						flexLog("Product Debt Collections Requested");
					}
					catch (Exception ex)
					{
						flexLog("Error: " + ex);
	 ...
	 * @param response HttpServletResponse
	 */
	protected void procReqProductCOL(
		MessageContext mc,
		ESS0030DSMessage user,
		HttpServletRequest req,
		HttpServletResponse res,
	 ...
	 * @param response HttpServletResponse
	 */
	protected void procReqProductDDA(
		MessageContext mc,
		ESS0030DSMessage user,
		HttpServletRequest req,
		HttpServletResponse res,
	 ...
	 * @param response HttpServletResponse
	 */
	protected void procReqProductINV(
		MessageContext mc,
		ESS0030DSMessage user,
		HttpServletRequest req,
		HttpServletResponse res,
	 ...
	 * @param response HttpServletResponse
	 */
	protected void procReqProductLC(
		MessageContext mc,
		ESS0030DSMessage user,
		HttpServletRequest req,
		HttpServletResponse res,
	 ...
	 * @param response HttpServletResponse
	 */
	protected void procReqProductLN(
		MessageContext mc,
		ESS0030DSMessage user,
		HttpServletRequest req,
		HttpServletResponse res,
	 ...
	 * @param response HttpServletResponse
	 */
	protected void procReqProductPRY(
		MessageContext mc,
		ESS0030DSMessage user,
		HttpServletRequest req,
		HttpServletResponse res,
				...
				if (msgTree.getE01RECTYP().equals("0"))
				{
					...
					while (true)
					{
						...
						else
						{
							...
							if (msgTree.getE01RECTYP().equals("*"))
								break;
						}
					}
