 ...
 * @author Ramses Amaro
 */
public class JSEDD5700A extends JSEDD5700 {
	
	/**
	 * JSEDD5700A constructor comment.
	 */
	public JSEDD5700A() {
		super();
	}
				...
				if (newmessage.getFormatName().equals("ELEERR")) {
					...
					try {
						flexLog(
							"About to call Page3: "
								+ LangPath
								+ "EDD1000_rt_condit_signers_list.jsp");
						callPage(LangPath + "EDD1000_rt_condit_signers_list.jsp", req, res);
					} catch (Exception e) {
						flexLog("Exception calling page " + e);
					}
