...
public class JSEDL1112 extends datapro.eibs.master.SuperServlet {
	...
	protected static final int A_ENTER_LIST_LN_APP	= 650;
	protected static final int R_ENTER_PRINT_LN	    = 250;
	protected static final int A_ENTER_LIST_LN		= 260;
	protected static final int A_ENTER_SCH_LN_PRINT = 270;
...
protected void procActionEnterSchemeLN(MessageContext mc, ESS0030DSMessage user, HttpServletRequest req, HttpServletResponse res, HttpSession ses)
	...
	try {
		...
		try {
			userPO.setHeader5(req.getParameter("E01FRECUE"));
		} catch (Exception e) {
			userPO.setHeader5(" ");
		}
		try {
			if (req.getParameter("E01PRETYP") != null) {
				userPO.setHeader6(req.getParameter("E01PRETYP"));
			}	else {
				userPO.setHeader6("N");
  ...
  ses.setAttribute("lnScheme", msgLN);
	...
	try
	{
		...
		if (newmessage.getFormatName().equals("EDL111201")) {
			...
			userPO.setHeader5(msgLN.getE01FRECUE());
			userPO.setHeader6(msgLN.getE01PRETYP());
 ...
 * This method was created in VisualAge.
 */
protected void procReqEnterPrintLN(ESS0030DSMessage user, HttpServletRequest req, HttpServletResponse res, HttpSession ses)
			throws ServletException, IOException {
    EDL111201Message msgLN = null;
	ELEERRMessage msgError = null;
	UserPos	userPO = null;	
	...
	try {
		flexLog("About to call Page: " + LangPath + "EDL1112_ln_enter_sch_print.jsp");
		callPage(LangPath + "EDL1112_ln_enter_sch_print.jsp", req, res);	
	}
	catch (Exception e) {
		flexLog("Exception calling page " + e);
	}
...
protected void procReqSchemeLNList(MessageContext mc, ESS0030DSMessage user, HttpServletRequest req, HttpServletResponse res, HttpSession ses)
	...
	try
	{
		...
		msgLN.setE01FRECUE(userPO.getHeader5());
		msgLN.setE01PRETYP(userPO.getHeader6());
 ...
 * This method was created in VisualAge.
 */
protected void procReqListLNListApp(MessageContext mc, ESS0030DSMessage user, HttpServletRequest req, HttpServletResponse res, HttpSession ses)
			throws ServletException, IOException {
	...
	try
	{
	  newmessage = mc.receiveMessage();
		...
		if (newmessage.getFormatName().equals("ELEERR")) {
				...
				ses.setAttribute("error", msgError);
				try {
					flexLog("About to call Page: " + LangPath + "EDL1112_ln_enter_list_app.jsp");
					callPage(LangPath + "EDL1112_ln_enter_list_app.jsp", req, res);
				} catch (Exception e) {
					flexLog("Exception calling page " + e);
				}
		} 
...
//ojo
		  if (userPO.getHeader23() == null) {
			...
			try {
					flexLog("About to call Page: " + LangPath + "EDL1112_ln_list_enter_app.jsp");
					callPage(LangPath + "EDL1112_ln_list_enter_app.jsp", req, res);					
			}
			catch (Exception e) {
					flexLog("Exception calling page " + e);
			}			
 ...
 * This method was created in VisualAge.
 */
protected void procReqEnterListLN(MessageContext mc, ESS0030DSMessage user, HttpServletRequest req, HttpServletResponse res, HttpSession ses)
			throws ServletException, IOException {
	...
	try
	{
		...
		msgLN.setH01TIMSYS(getTimeStamp());
		msgLN.setH01SCRCOD("01");
		msgLN.setH01OPECOD("0071");
		// Get Parameters here		

		try	{ 	
		msgLN.setE01CNOMID(req.getParameter("E01CNOMID"));
		}
		catch (Exception e)	{
			msgLN.setE01CNOMID(" ");
		} 	
	...
	try {
		...
		if (newmessage.getFormatName().equals("EDL111201")) {
			...
			if (IsNotError) { // There are no errors
				try {
					flexLog("About to call Page: " + LangPath + "EDL1112_ln_print_sch_confirm.jsp");
					callPage(LangPath + "EDL1112_ln_print_sch_confirm.jsp", req, res);
				} catch (Exception e) {
					flexLog("Exception calling page " + e);
				}
			} else { // There are errors
 ...
 * This method was created in VisualAge.
 */
protected void procReqSchPrintLN(MessageContext mc, ESS0030DSMessage user, HttpServletRequest req, HttpServletResponse res, HttpSession ses)
			throws ServletException, IOException {
...
protected void procReqPassword(
	...
	try {
		...
		userPO = (datapro.eibs.beans.UserPos) ses.getAttribute("userPO");
		userPO.setRedirect(
			"/servlet/datapro.eibs.products.JSEDL1112?SCREEN="
				+ A_ENTER_LIST_LN_APP
				+ "&appCode="
		...
		try {
			...
			switch (screen) {
				...
				case A_ENTER_SCHEME_LN : 
					...
					break;
				case A_ENTER_LIST_LN_APP : 
					procReqListLNListApp(mc, msgUser, req, res, session);
					break;
				...
				case R_PASSWORD :
					...
					break;
				case R_ENTER_PRINT_LN : 
					procReqEnterPrintLN(msgUser, req, res, session);
					break;
				case A_ENTER_LIST_LN : 
					procReqEnterListLN(mc, msgUser, req, res, session);
					break;
				case A_ENTER_SCH_LN_PRINT : 
					procReqSchPrintLN(mc, msgUser, req, res, session);
					break;
