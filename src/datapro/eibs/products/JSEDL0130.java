...
import com.datapro.security.AeSimpleSHA1;


public class JSEDL0130 extends datapro.eibs.master.SuperServlet {
		...
		try {
			...
			if (newmessage.getFormatName().equals("ESD000004")) {
				...
				if (IsNotError) { // There are no errors
					...
					try {
						flexLog("About to call Page: " + LangPath + "EDL0130_cd_bene.jsp");
						callPage(LangPath + "EDL0130_cd_bene.jsp", req, res);
					} catch (Exception e) {
						flexLog("Exception calling page " + e);
					}
				}
				...
				if (IsNotError) { // There are no errors
					try {
						if (opeCode.equals("0005")) {
							flexLog("About to call Page: " + LangPath + "EDL0130_cd_cancel_confirm.jsp");
							callPage(LangPath + "EDL0130_cd_cancel_confirm.jsp", req, res);
						} else {
							flexLog("About to call Page: " + LangPath + "EDL0130_cd_cancel.jsp");
							callPage(LangPath + "EDL0130_cd_cancel.jsp", req, res);
						}
					} catch (Exception e) {
						flexLog("Exception calling page " + e);
					}
		...
		try {
			...
			if (newmessage.getFormatName().equals("EFT000010")) {
				...
				if (IsNotError) { // There are no errors
					...
					try {
						flexLog("About to call Page: " + LangPath + "EDL0130_cd_enter_print.jsp");
		...
		try {
			...
			if (newmessage.getFormatName().equals("EDL013003")) {
				...
				if (IsNotError) { // There are no errors
					...
					try {
						flexLog("About to call Page: " + LangPath + "EDL0130_cd_enter_transac.jsp");
						callPage(LangPath + "EDL0130_cd_enter_transac.jsp", req, res);
					} catch (Exception e) {
						flexLog("Exception calling page " + e);
					}
				}
	 ...
	 * This method was created in VisualAge.
	 */
	protected void procActionEnterExchangeRate(
		MessageContext mc,
		ESS0030DSMessage user,
		HttpServletRequest req,
		HttpServletResponse res,
		...
		try {
			...
			userPO.setIdentifier(req.getParameter("E06DEAACC"));
			//userPO.setProdCode(req.getParameter("E06DEAPRO"));
    ...
    protected void procActionEnterAuthorization(MessageContext mc, ESS0030DSMessage user, HttpServletRequest req, HttpServletResponse res, HttpSession ses) throws ServletException, IOException {
        UserPos userPO = null;
        try {
            userPO = (UserPos)ses.getAttribute("userPO");
            userPO.setAccNum(req.getParameter("E06DEAACC"));
            ...
            if(IsNotError)
                try {
                    flexLog("About to call Page: " + LangPath + "MISC_message_viewer.jsp");
                    res.sendRedirect(SuperServlet.srctx + LangPath + "MISC_message_viewer.jsp?MESSAGE=CLAVE CREADA EXITOSAMENTE");
                }
                catch(Exception e) {
                    flexLog("Exception calling page " + e);
                }
                ...
                try {
                    flexLog("About to call Page: " + LangPath + "EDL0130_cd_enter_authorization.jsp");
                    callPage(LangPath + "EDL0130_cd_enter_authorization.jsp", req, res);
                }
                catch(Exception e) {
                    flexLog("Exception calling page " + e);
                }
		...
		try {
			...
			if (newmessage.getFormatName().equals("ESD000005")) {
				...
				if (IsNotError) { // There are no errors
					...
					try {
						flexLog("About to call Page: " + LangPath + "EDL0130_cd_special_inst.jsp");
						callPage(LangPath + "EDL0130_cd_special_inst.jsp", req, res);
					} catch (Exception e) {
						flexLog("Exception calling page " + e);
					}
				}
		...
		try {
			...
			if (newmessage.getFormatName().equals("EDL013006")) {
				...
				if (IsNotError) { // There are no errors
					...
					try {
						flexLog("About to call Page: " + LangPath + "EDL0130_cd_xchg_rate.jsp");
						callPage(LangPath + "EDL0130_cd_xchg_rate.jsp", req, res);
					} catch (Exception e) {
						flexLog("Exception calling page " + e);
					}
				}
						...
						if (msgCD.getE10DEAICT().equals("P")
							...
							if (userPO.getPurpose().equals("MAINTENANCE")) {
								...
								if (userPO.getPurpose().equals("PRINT")) {
									...
									flexLog("About to call Page: " + LangPath + "EDL0130_cd_enter_new.jsp");
		...
		try {
			...
			if (newmessage.getFormatName().equals("EDL013009")) {
				...
				if (IsNotError) { // There are no errors
					try {
						{
							procActionEnterMaint(mc, user, req, res, ses);
						}
		...
		try {
			...
			if (newmessage.getFormatName().equals("EFT000010")) {
				...
				if (newmessage.getFormatName().equals("EDL013001")) {
					...
					if ((msgCD.getE01SHAINP().trim().length()) > 0.00)
					{
						/*
						SHA1 sha1 = new SHA1();
						sha1.clear();
						sha1.update(msgCD.getE01SHAINP().trim());
						sha1.finalize();
						*/
						msgCD.setE01SHAOUT(AeSimpleSHA1.SHA1(msgCD.getE01SHAINP().trim()));
					}
					...
					if (IsNotError) { // There are no errors
						try {
							flexLog("About to call Page1: " + LangPath + "EDL0130_cd_enter_maint.jsp");
							callPage(LangPath + "EDL0130_cd_enter_maint.jsp", req, res);
						} catch (Exception e) {
							flexLog("Exception calling page " + e);
						}
...
/*						SHA1 sha1 = new SHA1();
						...
						sha1.update(msgCD.getE01SHAINP().trim());
						sha1.finalize();
						msgCD.setE01SHAOUT(sha1.toString());
*/
						msgCD.setE01SHAOUT(AeSimpleSHA1.SHA1(msgCD.getE01SHAINP().trim()));						
					}
					...
					try {
						flexLog("About to call Page2: " + LangPath + "EDL0130_cd_opening.jsp");
	...
	protected void procActionPrintNew(
		...
		try {
			...
			try {
				msgCD.setE01DEAACC(req.getParameter("E10DEAACC"));
			} catch (Exception e) {
				msgCD.setE01DEAACC(userPO.getIdentifier());
			}
	...
	protected void procActionRenovations(
		...
		try {
			...
			if (newmessage.getFormatName().equals("EDL013008")) {
				...
				if (IsNotError) { // There are no errors 
					try {
						flexLog("About to call Page1: " + LangPath + "EDL0130_cd_maint.jsp");
						callPage(LangPath + "EDL0130_cd_maint.jsp", req, res);
					} catch (Exception e) {
						flexLog("Exception calling page " + e);
					}
					...
					try {
						flexLog("About to call Page2: " + LangPath + "EDL0130_cd_renov_options.jsp");
						callPage(LangPath + "EDL0130_cd_renov_options.jsp", req, res);
					} catch (Exception e) {
						flexLog("Exception calling page " + e);
					}
				}
	...
	protected void procActionRenovationsTreasury(
		MessageContext mc,
		ESS0030DSMessage user,
		HttpServletRequest req,
		HttpServletResponse res,
		...
		try {
			...
			if (newmessage.getFormatName().equals("EDL013008")) {
				...
				if (IsNotError) { // There are no errors 
					try {
						res.sendRedirect(super.srctx + "/servlet/datapro.eibs.forex.JSEWD0334Ren?SCREEN=2&SWDACC=" + userPO.getAccNum() + "&SWDCUN=" + userPO.getCusNum() + "&SWDCCY=" + userPO.getCurrency() + "&RWDDAY=" + userPO.getHeader1());
					} catch (Exception e) {
						flexLog("Exception calling page " + e);
					}
				} else { // There are errors
					try {
						flexLog("About to call Page2: " + LangPath + "EWD0334_cancel_renov_options.jsp");
						callPage(LangPath + "EWD0334_cancel_renov_options.jsp", req, res);
					} catch (Exception e) {
						flexLog("Exception calling page " + e);
					}
				}
		...
		try {
			...
			if (newmessage.getFormatName().equals("EDL013008")) {
				...
				if (IsNotError) { // There are no errors
					...
					try {
						flexLog("About to call Page2: " + LangPath + "EDL0130_cd_renov_options_op.jsp");
						callPage(LangPath + "EDL0130_cd_renov_options_op.jsp", req, res);
					} catch (Exception e) {
						flexLog("Exception calling page " + e);
					}
				}
		...
		try {
			...
			if (newmessage.getFormatName().equals("ESD000002")) {
				...
				if (IsNotError) { // There are no errors 
					...
					try {
						flexLog("About to call Page: " + LangPath + "EDL0130_cd_codes.jsp");
						callPage(LangPath + "EDL0130_cd_codes.jsp", req, res);
					} catch (Exception e) {
						flexLog("Exception calling page " + e);
					}
				}
		...
		try {
			...
			if (newmessage.getFormatName().equals("ESD000006")) {
				...
				if (IsNotError) { // There are no errors 
					...
					try {
						flexLog("About to call Page: " + LangPath + "EDL0130_cd_tit.jsp");
						callPage(LangPath + "EDL0130_cd_tit.jsp", req, res);
					} catch (Exception e) {
						flexLog("Exception calling page " + e);
					}
				}
			...
			if (newmessage.getFormatName().equals("EDL013003")) {
				...
				if (IsNotError) { // There are no errors
					try {
						{
							flexLog(
								"About to call Page: " + LangPath + "EDL0130_cd_transaction_confirm.jsp");
							callPage(LangPath + "EDL0130_cd_transaction_confirm.jsp", req, res);
						}
					} catch (Exception e) {
						flexLog("Exception calling page " + e);
					}
					...
					try {
						flexLog("About to call Page: " + LangPath + "EDL0130_cd_transac.jsp");
						callPage(LangPath + "EDL0130_cd_transac.jsp", req, res);
					} catch (Exception e) {
						flexLog("Exception calling page " + e);
					}
				}
		...
		try {
			...
			if (newmessage.getFormatName().equals("EFT000010")) {
				...
				if (IsNotError) { // There are no errors
					...
					try {
						flexLog("About to call Page4: " + LangPath + "EDL0130_cd_finish.jsp");
						callPage(LangPath + "EDL0130_cd_finish.jsp", req, res);
					} catch (Exception e) {
						flexLog("Exception calling page " + e);
					}
	...
	protected void procReqEnterCancelAcc(
		ESS0030DSMessage user,
		HttpServletRequest req,
		HttpServletResponse res,
		HttpSession ses)
		...
		try {
			flexLog("About to call Page: " + LangPath + "EDL0130_cd_enter_cancel_acc.jsp");
			callPage(LangPath + "EDL0130_cd_enter_cancel_acc.jsp", req, res);
		} catch (Exception e) {
			flexLog("Exception calling page " + e);
		}
	 ...
	 * This method was created in VisualAge.
	 */
	protected void procReqEnterMaintAcc(
		ESS0030DSMessage user,
		HttpServletRequest req,
		HttpServletResponse res,
		HttpSession ses)
		...
		try {
			flexLog("About to call Page: " + LangPath + "EDL0130_cd_enter_maint_acc.jsp");
			callPage(LangPath + "EDL0130_cd_enter_maint_acc.jsp", req, res);
		} catch (Exception e) {
			flexLog("Exception calling page " + e);
		}
	...
	protected void procReqEnterExchangeRate(
		ESS0030DSMessage user,
		HttpServletRequest req,
		HttpServletResponse res,
		HttpSession ses)
		...
		ELEERRMessage msgError = null;
		EDL013006Message cdRate = null;
		UserPos	userPO = null;	

		try {

			msgError = new datapro.eibs.beans.ELEERRMessage();
			cdRate = new EDL013006Message();
			userPO = new datapro.eibs.beans.UserPos();
			userPO.setPurpose("MAINTENANCE");
			ses.setAttribute("error", msgError);
			ses.setAttribute("cdRate", cdRate);
			ses.setAttribute("userPO", userPO);
		...
		try {
			flexLog("About to call Page: " + LangPath + "EDL0130_cd_enter_xchg_rate.jsp");
			callPage(LangPath + "EDL0130_cd_enter_xchg_rate.jsp", req, res);	
		}
		catch (Exception e) {
			flexLog("Exception calling page " + e);
		}
	...
	protected void procReqEnterAuthorization(ESS0030DSMessage user, HttpServletRequest req, HttpServletResponse res, HttpSession ses) throws ServletException, IOException {
        ELEERRMessage msgError = null;
        EDL013006Message cdRate = null;
        UserPos userPO = null;
        try {
	...
	protected void procReqEspInstInq(
		...
		try {
			...
			if (newmessage.getFormatName().equals("ESD000005")) {
				...
				if (IsNotError) { // There are no errors 
					try {
						flexLog("About to call Page: " + LangPath + "EDL0130_cd_inq_special_inst.jsp");
						callPage(LangPath + "EDL0130_cd_inq_special_inst.jsp", req, res);
					} catch (Exception e) {
						flexLog("Exception calling page " + e);
					}
				} else { // There are errors
	...
	protected void procReqFinish(
		...
		try {
			...
			if (newmessage.getFormatName().equals("EFT000010")) {
				...
				if (IsNotError) { // There are no errors
					try {
						flexLog("About to call Page3: " + LangPath + "EDL0130_cd_finish.jsp");
						callPage(LangPath + "EDL0130_cd_finish.jsp", req, res);
					} catch (Exception e) {
						flexLog("Exception calling page " + e);
					}
					...
					try {
						flexLog("About to call Page4: " + LangPath + "EDL0130_cd_opening.jsp");
						callPage(LangPath + "EDL0130_cd_opening.jsp", req, res);
					} catch (Exception e) {
						flexLog("Exception calling page " + e);
					}
	...
	protected void procReqInqBasic(
		...
		try {
			...
			if (newmessage.getFormatName().equals("EDL016002")) {
				...
				if (IsNotError) { // There are no errors
					try {
						flexLog("About to call Page3: " + LangPath + "EDL0130_cd_inq_basic.jsp");
					...
					try {
						flexLog("About to call Page4: " + LangPath + "EDL0130_cd_enter_maint.jsp");
						callPage(LangPath + "EDL0130_cd_enter_maint.jsp", req, res);
					} catch (Exception e) {
						flexLog("Exception calling page " + e);
					}
	...
	protected void procReqInqBene(
		...
		try {
			...
			if (newmessage.getFormatName().equals("ESD000004")) {
				...
				if (IsNotError) { // There are no errors 
					try {
						flexLog("About to call Page: " + LangPath + "EDL0130_cd_inq_bene.jsp");
	...
	protected void procReqMaintenance(
		...
		try {
			...
			if (newmessage.getFormatName().equals("EDL013001")) {
				...
				if (IsNotError) { // There are no errors
					try {
						flexLog("About to call Page3: " + LangPath + "EDL0130_cd_maint.jsp");
						callPage(LangPath + "EDL0130_cd_maint.jsp", req, res);
					} catch (Exception e) {
						flexLog("Exception calling page " + e);
					}
	...
	protected void procReqNew(
		...
		try {
			...
			if (newmessage.getFormatName().equals("EDL013001")) {
				...
				//Add current client id and name if fields are empty
				
				if (ses.getAttribute("currClient")!= null ){
				...
				if (IsNotError) { // There are no errors 
					try {
						flexLog("About to call Page3: " + LangPath + "EDL0130_cd_opening.jsp");
						callPage(LangPath + "EDL0130_cd_opening.jsp", req, res);
					} catch (Exception e) {
						flexLog("Exception calling page " + e);
					}
					...
					try {
						flexLog("About to call Page4: " + LangPath + "EDL0130_cd_enter_new.jsp");
						//callPage(LangPath + "EDL0130_cd_enter_new.jsp", req, res);	
						String firstLink =
							super.webAppPath
								+ LangPath
	...
	protected void procReqProductCD(
		...
		try {
			...
			if (newmessage.getFormatName().equals("ESD071111")) {
				...
				if (IsNotError) { // There are no errors
					try {
						flexLog("About to call Page: " + LangPath + "EDL0130_cd_inq_products.jsp");
						callPage(LangPath + "EDL0130_cd_inq_products.jsp", req, res);
					} catch (Exception e) {
						flexLog("Exception calling page " + e);
					}
				} else { // There are errors
	...
	protected void procReqRenovations(
		...
		try {
			...
			if (newmessage.getFormatName().equals("EDL013008")) {
				...
				if (IsNotError) { // There are no errors
					try {
						flexLog("About to call Page3: " + LangPath + "EDL0130_cd_renov_options.jsp");
						callPage(LangPath + "EDL0130_cd_renov_options.jsp", req, res);
					} catch (Exception e) {
						flexLog("Exception calling page " + e);
					}
					...
					try {
						flexLog("About to call Page4: " + LangPath + "EDL0130_cd_maint.jsp");
						callPage(LangPath + "EDL0130_cd_maint.jsp", req, res);
					} catch (Exception e) {
						flexLog("Exception calling page " + e);
					}
	...
	protected void procReqRenovationsTreasury(
		MessageContext mc,
		ESS0030DSMessage user,
		HttpServletRequest req,
		HttpServletResponse res,
		...
		try {
			...
			if (newmessage.getFormatName().equals("EDL013008")) {
				...
				if (IsNotError) { // There are no errors
					try {
						flexLog("About to call Page3: " + LangPath + "EWD0334_cancel_renov_options.jsp");
						callPage(LangPath + "EWD0334_cancel_renov_options.jsp", req, res);
					} catch (Exception e) {
						flexLog("Exception calling page " + e);
					}
	...
	protected void procReqSpecialCodesInq(
		...
		try {
			...
			if (newmessage.getFormatName().equals("ESD000002")) {
				...
				if (IsNotError) { // There are no errors
					try {
						flexLog("About to call Page: " + LangPath + "EDL0130_cd_inq_codes.jsp");
	...
	protected void procReqTit(
		...
		try {
			...
			if (newmessage.getFormatName().equals("ESD000006")) {
				...
				if (IsNotError) { // There are no errors
					try {
						flexLog("About to call Page3: " + LangPath + "EDL0130_cd_tit.jsp");
						callPage(LangPath + "EDL0130_cd_tit.jsp", req, res);
					} catch (Exception e) {
						flexLog("Exception calling page " + e);
					}
	...
	protected void procReqTitInq(
		...
		try {
			...
			if (newmessage.getFormatName().equals("ESD000006")) {
				...
				if (IsNotError) { // There are no errors
					try {
						flexLog("About to call Page3: " + LangPath + "EDL0130_cd_inq_tit.jsp");
			...
			try {
				...
				switch (screen) {
					...
					case R_RENOV_TREASURY :
						procReqRenovationsTreasury(mc, msgUser, req, res, session);
						break;
					...
					case A_RENOV_TREASURY :
						procActionRenovationsTreasury(mc, msgUser, req, res, session);
						break;
					case A_FINISH :
					...
					case R_ENTER_MAINT_ACC :
						procReqEnterMaintAcc(msgUser, req, res, session);
						break;
					case R_ENTER_AUTHORIZATION: 
                        procReqEnterAuthorization(msgUser, req, res, session);
                        break;
	
					case R_ENTER_CANCEL_ACC :
						procReqEnterCancelAcc(msgUser, req, res, session);
						break;
					case R_ENTER_EXCHANGE :
						procReqEnterExchangeRate(msgUser, req, res, session);
						break;
					...
					case A_ENTER_AUTHORIZATION: 
                        procActionEnterAuthorization(mc, msgUser, req, res, session);
                        break;	
					case A_ENTER_EXCHANGE :
						procActionEnterExchangeRate(mc, msgUser, req, res, session);
						break;
		...
		try {
			...
			if (newmessage.getFormatName().equals("ELD000001")) {
				...
				if (IsNotError) { // There are no errors
					...
					try {
						flexLog("About to call Page: " + LangPath + "EDL0130_cd_money.jsp");
						callPage(LangPath + "EDL0130_cd_money.jsp", req, res);
					} catch (Exception e) {
						flexLog("Exception calling page " + e);
					}
		...
		try {
			...
			if (newmessage.getFormatName().equals("ESD000008")) {
				...
				if (IsNotError) { // There are no errors
					...
					try {
						flexLog("About to call Page: " + LangPath + "EDL0130_cd_disb_inst.jsp");
						callPage(LangPath + "EDL0130_cd_disb_inst.jsp", req, res);
					} catch (Exception e) {
						flexLog("Exception calling page " + e);
					}
				}
	...
	protected void procReqCDMoney(
		...
		try {
			...
			if (newmessage.getFormatName().equals("ELD000001")) {
				...
				if (IsNotError) { // There are no errors
					try {
						flexLog("About to call Page3: " + LangPath + "EDL0130_cd_money.jsp");
						callPage(LangPath + "EDL0130_cd_money.jsp", req, res);
					} catch (Exception e) {
						flexLog("Exception calling page " + e);
					}
	...
	protected void procReqDisbursement(
		...
		try {
			...
			if (newmessage.getFormatName().equals("ESD000008")) {
				...
				if (IsNotError) { // There are no errors
					try {
						flexLog("About to call Page3: " + LangPath + "EDL0130_cd_disb_inst.jsp");
						callPage(LangPath + "EDL0130_cd_disb_inst.jsp", req, res);
					} catch (Exception e) {
						flexLog("Exception calling page " + e);
					}
		...
		try {
			...
			if (newmessage.getFormatName().equals("ESD000004")) {
				...
				if (IsNotError) { // There are no errors
					...
					try {
						flexLog("About to call Page: " + LangPath + "EDL0130_cd_firm.jsp");
						callPage(LangPath + "EDL0130_cd_firm.jsp", req, res);
					} catch (Exception e) {
						flexLog("Exception calling page " + e);
					}
				}
						...
						try {
							...
							if (newmessage.getFormatName().equals("EDL013004")) {
								...
								if (IsNotError) { // There are no errors
									...
									try {
										flexLog("About to call Page: " + LangPath + "EDL0130_cd_pay_pln_det.jsp");
										callPage(LangPath + "EDL0130_cd_pay_pln_det.jsp", req, res);
									} catch (Exception e) {
										flexLog("Exception calling page " + e);
									}
								}
			...
			case 3 :
				{
					...
					try {
						flexLog(
							"About to call Page: " + LangPath + "EDL0130_cd_pay_pln_det.jsp?ROW=" + row);
						res.sendRedirect(super.srctx + LangPath + "EDL0130_cd_pay_pln_det.jsp?ROW=" + row);
					} catch (Exception e) {
						flexLog("Exception calling page " + e);
					}
					break;
	...
	protected void procReqAccountTitle(MessageContext mc, ESS0030DSMessage user, HttpServletRequest req, HttpServletResponse res, HttpSession ses)
		...
		try
		{
			...
			if (newmessage.getFormatName().equals("ESD000004")) {
				...
				if (IsNotError) {  // There are no errors
					try {
						flexLog("About to call Page: " + LangPath + "EDL0130_cd_account_title.jsp");
						callPage(LangPath + "EDL0130_cd_account_title.jsp", req, res);
					}
					catch (Exception e) {
						flexLog("Exception calling page " + e);
					}
