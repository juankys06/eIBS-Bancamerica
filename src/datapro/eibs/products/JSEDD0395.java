		...
		if (newmessage.getFormatName().equals("ELEERR")) {
			...
			while (true) {
				...
				if (marker.equals("*")) {
					...
					myRow.append("<TD NOWRAP ALIGN=CENTER>" + Util.formatDate(msgList.getE01UNCRD1(), msgList.getE01UNCRD2(), msgList.getE01UNCRD3()) + "</TD>");
					myRow.append("<TD NOWRAP ALIGN=CENTER>" + Util.formatDate(msgList.getE01UNCMD1(), msgList.getE01UNCMD2(), msgList.getE01UNCMD3()) + "</TD>");
